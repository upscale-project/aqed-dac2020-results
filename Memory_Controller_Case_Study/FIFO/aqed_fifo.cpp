...
ac_int<1, false> empty_d1=0;
ac_int<1, false> bmc_v_d1=0;
ac_int<1, false> acc_out_rdy_d1=0; 
...
out1 aqed_in (ac_int<16,false> *bmc_in, ac_int<1,false> bmc_v, ac_int<1,false> original, ac_int<1,false> duplicate, ac_int<1,false> full) { 
   ...
   if(bmc_v && !full){
      ...
      if (issue_dup){
       ...
       out1 o1;
       o1.aqed_out = *bmc_in; o1.aqed_out_v = bmc_v; o1.full = full; 
...
out2 aqed_out (ac_int<16,false> *acc_out, ac_int<1,false> acc_out_v, ac_int<1,false> bmc_v, ac_int<1,false> acc_out_rdy, ac_int<1,false> empty) { 

   if(acc_out_v && acc_out_rdy_d1 && (!empty||(empty_d1 && bmc_v_d1 && acc_out_rdy_d1))){ 
...
#pragma design top
out3 aqed_top (ac_int<16,false> bmc_in, ac_int<1,false> bmc_v, ac_int<1,false> original, ac_int<1,false> duplicate, ac_int<1,false> full, ac_int<1,false> empty, ac_int<16,false> acc_out, ac_int<1,false> acc_out_v, ac_int<1,false> acc_out_rdy) {
...
o2 = aqed_out(&acc_out, acc_out_v, o1.aqed_out_v, acc_out_rdy, empty);
