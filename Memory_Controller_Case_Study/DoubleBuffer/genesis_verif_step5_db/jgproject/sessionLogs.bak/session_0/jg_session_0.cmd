...
#----------------------------------------
# started Fri Apr 03 20:09:48 PDT 2020
# hostname  : rsg20.stanford.edu
# pid       : 5956
# arguments : '-label' 'session_0' '-console' 'rsg20.stanford.edu:32971' '-style' 'windows' '-use_native_tcl' '-proj' '/rsgs/pool0/Saranyu/aqed/memory_core_clean3/genesis_verif_step5/jgproject/sessionLogs/session_0' '-init' '-hidden' '/rsgs/pool0/Saranyu/aqed/memory_core_clean3/genesis_verif_step5/jgproject/.tmp/.initCmds.tcl' 'jasper.tcl'
...
visualize -violation -property <embedded>::mem_core_top.assert_response_bound -new_window
visualize -check_props -update_gui -window {visualize:0}
visualize -violation -property <embedded>::mem_core_top.assert_response_bound -new_window
visualize -violation -property <embedded>::mem_core_top.assert_response_bound -new_window
