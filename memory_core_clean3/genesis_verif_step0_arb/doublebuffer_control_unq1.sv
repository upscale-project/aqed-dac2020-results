...
assign doublebuffer_cen_mem[0] = wen | flush | switch | autoswitch | (read_mux);
assign doublebuffer_cen_mem[1] = wen | flush | switch | autoswitch | (read_mux);
