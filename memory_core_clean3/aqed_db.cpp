...
out1 aqed_in (ac_int<16,false> *bmc_in, ac_int<1,false> bmc_v, ac_int<1,false> original, ac_int<1,false> duplicate) { 
...
out2 aqed_out (ac_int<16,false> *acc_out, ac_int<1,false> acc_out_v, ac_int<1,false> acc_out_rdy) { 

   if(acc_out_v && acc_out_rdy){ 
  ...
  // If original and duplicate have been issued and the output count is greater than the duplicate input count, qed is done
   ...
   out2 o2;
   o2.qed_done = state.qed_done; o2.qed_check =state.qed_check; 
...
#pragma design top
out3 aqed_top (ac_int<16,false> bmc_in, ac_int<1,false> bmc_v, ac_int<1,false> original, ac_int<1,false> duplicate, ac_int<16,false> acc_out, ac_int<1,false> acc_out_v, ac_int<1,false> acc_out_rdy) {

out1 o1;
out2 o2;
out3 o3;

o1 = aqed_in(&bmc_in, bmc_v, original, duplicate);

o2 = aqed_out(&acc_out, acc_out_v, acc_out_rdy);
