...
#ifndef __optical_flow_mul_yd2__HH__
#define __optical_flow_mul_yd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(optical_flow_mul_yd2) {
    ...
    SC_CTOR(optical_flow_mul_yd2):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
