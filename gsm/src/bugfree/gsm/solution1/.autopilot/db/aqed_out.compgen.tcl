...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { acc_out_offset { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { state_orig_issued { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { state_orig_in { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 28 \
    name state_orig_done \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_state_orig_done \
    op interface \
    ports { state_orig_done { O 1 vector } state_orig_done_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { state_dup_in { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { state_dup_issued { I 1 vector } } \
} "
}
