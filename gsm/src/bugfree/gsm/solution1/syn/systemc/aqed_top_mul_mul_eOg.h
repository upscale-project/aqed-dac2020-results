...
#ifndef __aqed_top_mul_mul_eOg__HH__
#define __aqed_top_mul_mul_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(aqed_top_mul_mul_eOg) {
    ...
    SC_CTOR(aqed_top_mul_mul_eOg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
