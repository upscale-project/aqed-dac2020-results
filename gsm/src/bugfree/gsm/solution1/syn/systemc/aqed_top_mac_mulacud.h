...
#ifndef __aqed_top_mac_mulacud__HH__
#define __aqed_top_mac_mulacud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(aqed_top_mac_mulacud) {
    ...
    SC_CTOR(aqed_top_mac_mulacud):  simcore_mac_0_U ("simcore_mac_0_U") {
