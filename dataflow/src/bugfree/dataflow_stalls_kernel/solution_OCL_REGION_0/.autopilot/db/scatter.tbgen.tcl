...
set C_modelArgList {
	{ to0_V int 64 regular {fifo 1 volatile }  }
	{ to1_V int 64 regular {fifo 1 volatile }  }
	{ from_V int 64 regular {fifo 0 volatile }  }
	{ data_count int 32 regular {fifo 0}  }
	{ data_count_out int 32 regular {fifo 1}  }
	{ data_count_out1 int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "to0_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "to1_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "data_count_out1", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ to0_V_din sc_out sc_lv 64 signal 0 } 
	{ to0_V_full_n sc_in sc_logic 1 signal 0 } 
	{ to0_V_write sc_out sc_logic 1 signal 0 } 
	{ to1_V_din sc_out sc_lv 64 signal 1 } 
	{ to1_V_full_n sc_in sc_logic 1 signal 1 } 
	{ to1_V_write sc_out sc_logic 1 signal 1 } 
	...
	{ data_count_out1_din sc_out sc_lv 32 signal 5 } 
	{ data_count_out1_full_n sc_in sc_logic 1 signal 5 } 
	{ data_count_out1_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "to0_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "to0_V", "role": "din" }} , 
 	{ "name": "to0_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "to0_V", "role": "full_n" }} , 
 	{ "name": "to0_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "to0_V", "role": "write" }} , 
 	{ "name": "to1_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "to1_V", "role": "din" }} , 
 	{ "name": "to1_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "to1_V", "role": "full_n" }} , 
 	{ "name": "to1_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "to1_V", "role": "write" }} , 
 	...
 	{ "name": "data_count_out1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "data_count_out1", "role": "din" }} , 
 	{ "name": "data_count_out1_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "data_count_out1", "role": "full_n" }} , 
 	{ "name": "data_count_out1_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "data_count_out1", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"VariableLatency" : "1",
		"Port" : [
			{"Name" : "to0_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "to0_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "to1_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
			...
			{"Name" : "data_count_out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	to0_V { ap_fifo {  { to0_V_din fifo_data 1 64 }  { to0_V_full_n fifo_status 0 1 }  { to0_V_write fifo_update 1 1 } } }
	to1_V { ap_fifo {  { to1_V_din fifo_data 1 64 }  { to1_V_full_n fifo_status 0 1 }  { to1_V_write fifo_update 1 1 } } }
	...
	data_count_out1 { ap_fifo {  { data_count_out1_din fifo_data 1 32 }  { data_count_out1_full_n fifo_status 0 1 }  { data_count_out1_write fifo_update 1 1 } } }
}
