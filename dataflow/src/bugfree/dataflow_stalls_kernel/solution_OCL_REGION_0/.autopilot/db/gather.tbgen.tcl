...
set C_modelName {gather}
set C_modelType { void 0 }
set C_modelArgList {
	{ to_V int 64 regular {fifo 1 volatile }  }
	{ from0_V int 64 regular {fifo 0 volatile }  }
	{ from1_V int 64 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "to_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "from0_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "from1_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ from0_V_dout sc_in sc_lv 64 signal 1 } 
	{ from0_V_empty_n sc_in sc_logic 1 signal 1 } 
	{ from0_V_read sc_out sc_logic 1 signal 1 } 
	{ from1_V_dout sc_in sc_lv 64 signal 2 } 
	{ from1_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ from1_V_read sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "from0_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "from0_V", "role": "dout" }} , 
 	{ "name": "from0_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "from0_V", "role": "empty_n" }} , 
 	{ "name": "from0_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "from0_V", "role": "read" }} , 
 	{ "name": "from1_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "from1_V", "role": "dout" }} , 
 	{ "name": "from1_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "from1_V", "role": "empty_n" }} , 
 	{ "name": "from1_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "from1_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "from0_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "from0_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "from1_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	gather {
		...
		from0_V {Type I LastRead 1 FirstWrite -1}
		from1_V {Type I LastRead 1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	from0_V { ap_fifo {  { from0_V_dout fifo_data 0 64 }  { from0_V_empty_n fifo_status 0 1 }  { from0_V_read fifo_update 1 1 } } }
	from1_V { ap_fifo {  { from1_V_dout fifo_data 0 64 }  { from1_V_empty_n fifo_status 0 1 }  { from1_V_read fifo_update 1 1 } } }
