...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataflow_stalls_kernel_mul_64s_64s_64_6_U18", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	compute2 {
		to_V {Type O LastRead -1 FirstWrite 8}
