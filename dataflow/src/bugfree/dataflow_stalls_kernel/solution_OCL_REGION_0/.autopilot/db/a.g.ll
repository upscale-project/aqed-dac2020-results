; ModuleID = '/rsgs/pool0/esingh/aqed4saranyu/results/dataflow/dataflow-stalls_ab/tmp/set_fifo_depths/2017.1/adm-pcie-7v3/_xocc_compile_dataflow_stalls_kernel_dataflow_stalls-hw.dir/impl/kernels/dataflow_stalls_kernel/dataflow_stalls_kernel/solution_OCL_REGION_0/.autopilot/db/a.g.bc'
...
@_ZL12kNoTestEmpty = internal constant i1 false, align 1 ; [#uses=1 type=i1*]
...
define void @_Z7scatterPN3hls6streamImEES2_S2_j(%"class.std::locale::id"* %to0, %"class.std::locale::id"* %to1, %"class.std::locale::id"* %from, i32 %data_count) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !2837), !dbg !2838 ; [debug line = 29:33] [debug variable = to0]
  store %"class.std::locale::id"* %to1, %"class.std::locale::id"** %2, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %2}, metadata !2839), !dbg !2840 ; [debug line = 29:57] [debug variable = to1]
  store %"class.std::locale::id"* %from, %"class.std::locale::id"** %3, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %3}, metadata !2841), !dbg !2842 ; [debug line = 30:33] [debug variable = from]
  store i32 %data_count, i32* %4, align 4
  call void @llvm.dbg.declare(metadata !{i32* %4}, metadata !2843), !dbg !2844 ; [debug line = 30:48] [debug variable = data_count]
  br label %5, !dbg !2845                         ; [debug line = 30:60]

; <label>:5                                       ; preds = %0
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !2847), !dbg !2849 ; [debug line = 32:17] [debug variable = i]
  store i32 0, i32* %i, align 4, !dbg !2850       ; [debug line = 32:22]
  br label %6, !dbg !2850                         ; [debug line = 32:22]

; <label>:6                                       ; preds = %15, %5
  %7 = load i32* %i, align 4, !dbg !2850          ; [#uses=1 type=i32] [debug line = 32:22]
  %8 = load i32* %4, align 4, !dbg !2850          ; [#uses=1 type=i32] [debug line = 32:22]
  %9 = icmp ult i32 %7, %8, !dbg !2850            ; [#uses=1 type=i1] [debug line = 32:22]
  br i1 %9, label %10, label %18, !dbg !2850      ; [debug line = 32:22]

; <label>:10                                      ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !2851 ; [debug line = 32:46]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !2851 ; [debug line = 32:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2853 ; [debug line = 33:1]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2854), !dbg !2855 ; [debug line = 34:7] [debug variable = tmp]
  %11 = load %"class.std::locale::id"** %3, align 8, !dbg !2856 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 34:13]
  %12 = call i64 @_ZN3hls6streamImE4readEv(%"class.std::locale::id"* %11), !dbg !2856 ; [#uses=1 type=i64] [debug line = 34:13]
  store i64 %12, i64* %tmp, align 8, !dbg !2856   ; [debug line = 34:13]
  %13 = load %"class.std::locale::id"** %1, align 8, !dbg !2857 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 35:5]
  call void @_ZN3hls6streamImE5writeERKm(%"class.std::locale::id"* %13, i64* %tmp), !dbg !2857 ; [debug line = 35:5]
  %14 = load %"class.std::locale::id"** %2, align 8, !dbg !2858 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 36:5]
  call void @_ZN3hls6streamImE5writeERKm(%"class.std::locale::id"* %14, i64* %tmp), !dbg !2858 ; [debug line = 36:5]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !2859 ; [debug line = 37:3]
  br label %15, !dbg !2859                        ; [debug line = 37:3]

; <label>:15                                      ; preds = %10
  %16 = load i32* %i, align 4, !dbg !2860         ; [#uses=1 type=i32] [debug line = 32:40]
  %17 = add i32 %16, 1, !dbg !2860                ; [#uses=1 type=i32] [debug line = 32:40]
  store i32 %17, i32* %i, align 4, !dbg !2860     ; [debug line = 32:40]
  br label %6, !dbg !2860                         ; [debug line = 32:40]

; <label>:18                                      ; preds = %6
  ret void, !dbg !2861                            ; [debug line = 38:1]
}
...
define linkonce_odr i64 @_ZN3hls6streamImE4readEv(%"class.std::locale::id"* %this) nounwind uwtable inlinehint alwaysinline align 2 {
  ...
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !2862), !dbg !2863 ; [debug line = 129:56] [debug variable = this]
  %2 = load %"class.std::locale::id"** %1         ; [#uses=1 type=%"class.std::locale::id"*]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2864), !dbg !2866 ; [debug line = 130:22] [debug variable = tmp]
  %3 = getelementptr inbounds %"class.std::locale::id"* %2, i32 0, i32 0, !dbg !2867 ; [#uses=1 type=i64*] [debug line = 131:9]
  call void (...)* @_ssdm_StreamRead(i64* %3, i64* %tmp) nounwind, !dbg !2867 ; [debug line = 131:9]
  %4 = load i64* %tmp, align 8, !dbg !2868        ; [#uses=1 type=i64] [debug line = 132:9]
  ret i64 %4, !dbg !2868                          ; [debug line = 132:9]
}
...
define linkonce_odr void @_ZN3hls6streamImE5writeERKm(%"class.std::locale::id"* %this, i64* %din) nounwind uwtable inlinehint alwaysinline align 2 {
  ...
  %tmp = alloca i64, align 8                      ; [#uses=2 type=i64*]
  store %"class.std::locale::id"* %this, %"class.std::locale::id"** %1, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !2869), !dbg !2870 ; [debug line = 144:48] [debug variable = this]
  store i64* %din, i64** %2, align 8
  call void @llvm.dbg.declare(metadata !{i64** %2}, metadata !2871), !dbg !2872 ; [debug line = 144:74] [debug variable = din]
  %3 = load %"class.std::locale::id"** %1         ; [#uses=1 type=%"class.std::locale::id"*]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2873), !dbg !2875 ; [debug line = 145:22] [debug variable = tmp]
  %4 = load i64** %2, align 8, !dbg !2876         ; [#uses=1 type=i64*] [debug line = 145:31]
  %5 = load i64* %4, align 8, !dbg !2876          ; [#uses=1 type=i64] [debug line = 145:31]
  store i64 %5, i64* %tmp, align 8, !dbg !2876    ; [debug line = 145:31]
  %6 = getelementptr inbounds %"class.std::locale::id"* %3, i32 0, i32 0, !dbg !2877 ; [#uses=1 type=i64*] [debug line = 146:9]
  call void (...)* @_ssdm_StreamWrite(i64* %6, i64* %tmp) nounwind, !dbg !2877 ; [debug line = 146:9]
  ret void, !dbg !2878                            ; [debug line = 147:5]
}
...
define void @_Z4loadPN3hls6streamImEEPmj(%"class.std::locale::id"* %to, i64* %from, i32 %data_count) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !2879), !dbg !2880 ; [debug line = 40:30] [debug variable = to]
  store i64* %from, i64** %2, align 8
  call void @llvm.dbg.declare(metadata !{i64** %2}, metadata !2881), !dbg !2882 ; [debug line = 40:40] [debug variable = from]
  store i32 %data_count, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !2883), !dbg !2884 ; [debug line = 40:55] [debug variable = data_count]
  br label %4, !dbg !2885                         ; [debug line = 40:67]

; <label>:4                                       ; preds = %0
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !2887), !dbg !2889 ; [debug line = 42:17] [debug variable = i]
  store i32 0, i32* %i, align 4, !dbg !2890       ; [debug line = 42:22]
  br label %5, !dbg !2890                         ; [debug line = 42:22]

; <label>:5                                       ; preds = %15, %4
  %6 = load i32* %i, align 4, !dbg !2890          ; [#uses=1 type=i32] [debug line = 42:22]
  %7 = load i32* %3, align 4, !dbg !2890          ; [#uses=1 type=i32] [debug line = 42:22]
  %8 = icmp ult i32 %6, %7, !dbg !2890            ; [#uses=1 type=i1] [debug line = 42:22]
  br i1 %8, label %9, label %18, !dbg !2890       ; [debug line = 42:22]

; <label>:9                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([11 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !2891 ; [debug line = 42:46]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([11 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !2891 ; [debug line = 42:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2893 ; [debug line = 43:1]
  %10 = load %"class.std::locale::id"** %1, align 8, !dbg !2894 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 44:2]
  %11 = load i32* %i, align 4, !dbg !2894         ; [#uses=1 type=i32] [debug line = 44:2]
  %12 = zext i32 %11 to i64, !dbg !2894           ; [#uses=1 type=i64] [debug line = 44:2]
  %13 = load i64** %2, align 8, !dbg !2894        ; [#uses=1 type=i64*] [debug line = 44:2]
  %14 = getelementptr inbounds i64* %13, i64 %12, !dbg !2894 ; [#uses=1 type=i64*] [debug line = 44:2]
  call void @_ZN3hls6streamImE5writeERKm(%"class.std::locale::id"* %10, i64* %14), !dbg !2894 ; [debug line = 44:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([11 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !2895 ; [debug line = 45:3]
  br label %15, !dbg !2895                        ; [debug line = 45:3]

; <label>:15                                      ; preds = %9
  %16 = load i32* %i, align 4, !dbg !2896         ; [#uses=1 type=i32] [debug line = 42:40]
  %17 = add i32 %16, 1, !dbg !2896                ; [#uses=1 type=i32] [debug line = 42:40]
  store i32 %17, i32* %i, align 4, !dbg !2896     ; [debug line = 42:40]
  br label %5, !dbg !2896                         ; [debug line = 42:40]

; <label>:18                                      ; preds = %5
  ret void, !dbg !2897                            ; [debug line = 46:1]
}
...
define void @_Z5storePmPN3hls6streamImEEj(i64* %to, %"class.std::locale::id"* %from, i32 %data_count) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{i64** %1}, metadata !2898), !dbg !2899 ; [debug line = 48:18] [debug variable = to]
  store %"class.std::locale::id"* %from, %"class.std::locale::id"** %2, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %2}, metadata !2900), !dbg !2901 ; [debug line = 48:41] [debug variable = from]
  store i32 %data_count, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !2902), !dbg !2903 ; [debug line = 48:56] [debug variable = data_count]
  br label %4, !dbg !2904                         ; [debug line = 48:68]

; <label>:4                                       ; preds = %0
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !2906), !dbg !2908 ; [debug line = 50:17] [debug variable = i]
  store i32 0, i32* %i, align 4, !dbg !2909       ; [debug line = 50:22]
  br label %5, !dbg !2909                         ; [debug line = 50:22]

; <label>:5                                       ; preds = %16, %4
  %6 = load i32* %i, align 4, !dbg !2909          ; [#uses=1 type=i32] [debug line = 50:22]
  %7 = load i32* %3, align 4, !dbg !2909          ; [#uses=1 type=i32] [debug line = 50:22]
  %8 = icmp ult i32 %6, %7, !dbg !2909            ; [#uses=1 type=i1] [debug line = 50:22]
  br i1 %8, label %9, label %19, !dbg !2909       ; [debug line = 50:22]

; <label>:9                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !2910 ; [debug line = 50:46]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !2910 ; [debug line = 50:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2912 ; [debug line = 51:1]
  %10 = load %"class.std::locale::id"** %2, align 8, !dbg !2913 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 52:10]
  %11 = call i64 @_ZN3hls6streamImE4readEv(%"class.std::locale::id"* %10), !dbg !2913 ; [#uses=1 type=i64] [debug line = 52:10]
  %12 = load i32* %i, align 4, !dbg !2913         ; [#uses=1 type=i32] [debug line = 52:10]
  %13 = zext i32 %12 to i64, !dbg !2913           ; [#uses=1 type=i64] [debug line = 52:10]
  %14 = load i64** %1, align 8, !dbg !2913        ; [#uses=1 type=i64*] [debug line = 52:10]
  %15 = getelementptr inbounds i64* %14, i64 %13, !dbg !2913 ; [#uses=1 type=i64*] [debug line = 52:10]
  store i64 %11, i64* %15, align 8, !dbg !2913    ; [debug line = 52:10]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !2914 ; [debug line = 53:3]
  br label %16, !dbg !2914                        ; [debug line = 53:3]

; <label>:16                                      ; preds = %9
  %17 = load i32* %i, align 4, !dbg !2915         ; [#uses=1 type=i32] [debug line = 50:40]
  %18 = add i32 %17, 1, !dbg !2915                ; [#uses=1 type=i32] [debug line = 50:40]
  store i32 %18, i32* %i, align 4, !dbg !2915     ; [debug line = 50:40]
  br label %5, !dbg !2915                         ; [debug line = 50:40]

; <label>:19                                      ; preds = %5
  ret void, !dbg !2916                            ; [debug line = 54:1]
}
...
define void @_Z8compute1PN3hls6streamImEES2_j(%"class.std::locale::id"* %to, %"class.std::locale::id"* %from, i32 %data_count) nounwind uwtable {
  %1 = alloca %"class.std::locale::id"*, align 8  ; [#uses=2 type=%"class.std::locale::id"**]
  %2 = alloca %"class.std::locale::id"*, align 8  ; [#uses=3 type=%"class.std::locale::id"**]
  %3 = alloca i32, align 4                        ; [#uses=2 type=i32*]
  %i = alloca i32, align 4                        ; [#uses=4 type=i32*]
  %tmp = alloca i64, align 8                      ; [#uses=3 type=i64*]
  %4 = alloca i64, align 8                        ; [#uses=2 type=i64*]
  store %"class.std::locale::id"* %to, %"class.std::locale::id"** %1, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !2917), !dbg !2918 ; [debug line = 56:34] [debug variable = to]
  store %"class.std::locale::id"* %from, %"class.std::locale::id"** %2, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %2}, metadata !2919), !dbg !2920 ; [debug line = 56:57] [debug variable = from]
  store i32 %data_count, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !2921), !dbg !2922 ; [debug line = 57:24] [debug variable = data_count]
  br label %5, !dbg !2923                         ; [debug line = 57:36]

; <label>:5                                       ; preds = %0
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !2925), !dbg !2927 ; [debug line = 59:17] [debug variable = i]
  store i32 0, i32* %i, align 4, !dbg !2928       ; [debug line = 59:22]
  br label %6, !dbg !2928                         ; [debug line = 59:22]

; <label>:6                                       ; preds = %22, %5
  %7 = load i32* %i, align 4, !dbg !2928          ; [#uses=1 type=i32] [debug line = 59:22]
  %8 = load i32* %3, align 4, !dbg !2928          ; [#uses=1 type=i32] [debug line = 59:22]
  %9 = icmp ult i32 %7, %8, !dbg !2928            ; [#uses=1 type=i1] [debug line = 59:22]
  br i1 %9, label %10, label %23, !dbg !2928      ; [debug line = 59:22]

; <label>:10                                      ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !2929 ; [debug line = 59:42]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !2929 ; [debug line = 59:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2931 ; [debug line = 60:1]
  %11 = load %"class.std::locale::id"** %2, align 8, !dbg !2932 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 61:26]
  %12 = call zeroext i1 @_ZNK3hls6streamImE5emptyEv(%"class.std::locale::id"* %11), !dbg !2932 ; [#uses=1 type=i1] [debug line = 61:26]
  br i1 %12, label %22, label %13, !dbg !2932     ; [debug line = 61:26]

; <label>:13                                      ; preds = %10
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2933), !dbg !2935 ; [debug line = 62:12] [debug variable = tmp]
  %14 = load %"class.std::locale::id"** %2, align 8, !dbg !2936 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 62:18]
  %15 = call i64 @_ZN3hls6streamImE4readEv(%"class.std::locale::id"* %14), !dbg !2936 ; [#uses=1 type=i64] [debug line = 62:18]
  store i64 %15, i64* %tmp, align 8, !dbg !2936   ; [debug line = 62:18]
  %16 = load %"class.std::locale::id"** %1, align 8, !dbg !2937 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 63:7]
  %17 = load i64* %tmp, align 8, !dbg !2937       ; [#uses=1 type=i64] [debug line = 63:7]
  %18 = load i64* %tmp, align 8, !dbg !2937       ; [#uses=1 type=i64] [debug line = 63:7]
  %19 = add i64 %17, %18, !dbg !2937              ; [#uses=1 type=i64] [debug line = 63:7]
  store i64 %19, i64* %4, align 8, !dbg !2937     ; [debug line = 63:7]
  call void @_ZN3hls6streamImE5writeERKm(%"class.std::locale::id"* %16, i64* %4), !dbg !2937 ; [debug line = 63:7]
  %20 = load i32* %i, align 4, !dbg !2938         ; [#uses=1 type=i32] [debug line = 64:7]
  %21 = add i32 %20, 1, !dbg !2938                ; [#uses=1 type=i32] [debug line = 64:7]
  store i32 %21, i32* %i, align 4, !dbg !2938     ; [debug line = 64:7]
  br label %22, !dbg !2939                        ; [debug line = 65:5]

; <label>:22                                      ; preds = %13, %10
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !2940 ; [debug line = 66:3]
  br label %6, !dbg !2940                         ; [debug line = 66:3]

; <label>:23                                      ; preds = %6
  ret void, !dbg !2941                            ; [debug line = 67:1]
}

; [#uses=4]
define linkonce_odr zeroext i1 @_ZNK3hls6streamImE5emptyEv(%"class.std::locale::id"* %this) nounwind uwtable inlinehint alwaysinline align 2 {
  %1 = alloca %"class.std::locale::id"*, align 8  ; [#uses=2 type=%"class.std::locale::id"**]
  %tmp = alloca i1, align 1                       ; [#uses=2 type=i1*]
  store %"class.std::locale::id"* %this, %"class.std::locale::id"** %1, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !2942), !dbg !2944 ; [debug line = 112:48] [debug variable = this]
  %2 = load %"class.std::locale::id"** %1         ; [#uses=1 type=%"class.std::locale::id"*]
  call void @llvm.dbg.declare(metadata !{i1* %tmp}, metadata !2945), !dbg !2947 ; [debug line = 113:14] [debug variable = tmp]
  %3 = getelementptr inbounds %"class.std::locale::id"* %2, i32 0, i32 0, !dbg !2948 ; [#uses=1 type=i64*] [debug line = 113:20]
  %4 = call zeroext i1 (...)* @_ssdm_StreamCanRead(i64* %3) nounwind, !dbg !2948 ; [#uses=1 type=i1] [debug line = 113:20]
  store i1 %4, i1* %tmp, align 1, !dbg !2948      ; [debug line = 113:20]
  %5 = load i1* %tmp, align 1, !dbg !2949         ; [#uses=1 type=i1] [debug line = 114:9]
  %6 = xor i1 %5, true, !dbg !2949                ; [#uses=1 type=i1] [debug line = 114:9]
  ret i1 %6, !dbg !2949                           ; [debug line = 114:9]
}
...
define void @_Z8compute2PN3hls6streamImEES2_j(%"class.std::locale::id"* %to, %"class.std::locale::id"* %from, i32 %data_count) nounwind uwtable {
  ...
  %4 = alloca i64, align 8                        ; [#uses=2 type=i64*]
  store %"class.std::locale::id"* %to, %"class.std::locale::id"** %1, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !2950), !dbg !2951 ; [debug line = 69:34] [debug variable = to]
  store %"class.std::locale::id"* %from, %"class.std::locale::id"** %2, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %2}, metadata !2952), !dbg !2953 ; [debug line = 69:57] [debug variable = from]
  store i32 %data_count, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !2954), !dbg !2955 ; [debug line = 70:24] [debug variable = data_count]
  br label %5, !dbg !2956                         ; [debug line = 70:36]

; <label>:5                                       ; preds = %0
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !2958), !dbg !2960 ; [debug line = 72:17] [debug variable = i]
  store i32 0, i32* %i, align 4, !dbg !2961       ; [debug line = 72:22]
  br label %6, !dbg !2961                         ; [debug line = 72:22]

; <label>:6                                       ; preds = %22, %5
  %7 = load i32* %i, align 4, !dbg !2961          ; [#uses=1 type=i32] [debug line = 72:22]
  %8 = load i32* %3, align 4, !dbg !2961          ; [#uses=1 type=i32] [debug line = 72:22]
  %9 = icmp ult i32 %7, %8, !dbg !2961            ; [#uses=1 type=i1] [debug line = 72:22]
  br i1 %9, label %10, label %23, !dbg !2961      ; [debug line = 72:22]

; <label>:10                                      ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !2962 ; [debug line = 72:42]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !2962 ; [debug line = 72:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2964 ; [debug line = 73:1]
  %11 = load %"class.std::locale::id"** %2, align 8, !dbg !2965 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 74:26]
  %12 = call zeroext i1 @_ZNK3hls6streamImE5emptyEv(%"class.std::locale::id"* %11), !dbg !2965 ; [#uses=1 type=i1] [debug line = 74:26]
  br i1 %12, label %22, label %13, !dbg !2965     ; [debug line = 74:26]

; <label>:13                                      ; preds = %10
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2966), !dbg !2968 ; [debug line = 75:12] [debug variable = tmp]
  %14 = load %"class.std::locale::id"** %2, align 8, !dbg !2969 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 75:18]
  %15 = call i64 @_ZN3hls6streamImE4readEv(%"class.std::locale::id"* %14), !dbg !2969 ; [#uses=1 type=i64] [debug line = 75:18]
  store i64 %15, i64* %tmp, align 8, !dbg !2969   ; [debug line = 75:18]
  %16 = load %"class.std::locale::id"** %1, align 8, !dbg !2970 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 76:7]
  %17 = load i64* %tmp, align 8, !dbg !2970       ; [#uses=1 type=i64] [debug line = 76:7]
  %18 = load i64* %tmp, align 8, !dbg !2970       ; [#uses=1 type=i64] [debug line = 76:7]
  %19 = mul i64 %17, %18, !dbg !2970              ; [#uses=1 type=i64] [debug line = 76:7]
  store i64 %19, i64* %4, align 8, !dbg !2970     ; [debug line = 76:7]
  call void @_ZN3hls6streamImE5writeERKm(%"class.std::locale::id"* %16, i64* %4), !dbg !2970 ; [debug line = 76:7]
  %20 = load i32* %i, align 4, !dbg !2971         ; [#uses=1 type=i32] [debug line = 77:7]
  %21 = add i32 %20, 1, !dbg !2971                ; [#uses=1 type=i32] [debug line = 77:7]
  store i32 %21, i32* %i, align 4, !dbg !2971     ; [debug line = 77:7]
  br label %22, !dbg !2972                        ; [debug line = 78:5]

; <label>:22                                      ; preds = %13, %10
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !2973 ; [debug line = 79:3]
  br label %6, !dbg !2973                         ; [debug line = 79:3]

; <label>:23                                      ; preds = %6
  ret void, !dbg !2974                            ; [debug line = 80:1]
}
...
define void @_Z6gatherPN3hls6streamImEES2_S2_j(%"class.std::locale::id"* %to, %"class.std::locale::id"* %from0, %"class.std::locale::id"* %from1, i32 %data_count) nounwind uwtable {
  %1 = alloca %"class.std::locale::id"*, align 8  ; [#uses=2 type=%"class.std::locale::id"**]
  %2 = alloca %"class.std::locale::id"*, align 8  ; [#uses=3 type=%"class.std::locale::id"**]
  %3 = alloca %"class.std::locale::id"*, align 8  ; [#uses=3 type=%"class.std::locale::id"**]
  %4 = alloca i32, align 4                        ; [#uses=2 type=i32*]
  %i = alloca i32, align 4                        ; [#uses=4 type=i32*]
  %5 = alloca i64, align 8                        ; [#uses=2 type=i64*]
  store %"class.std::locale::id"* %to, %"class.std::locale::id"** %1, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !2975), !dbg !2976 ; [debug line = 82:32] [debug variable = to]
  store %"class.std::locale::id"* %from0, %"class.std::locale::id"** %2, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %2}, metadata !2977), !dbg !2978 ; [debug line = 82:55] [debug variable = from0]
  store %"class.std::locale::id"* %from1, %"class.std::locale::id"** %3, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %3}, metadata !2979), !dbg !2980 ; [debug line = 83:32] [debug variable = from1]
  store i32 %data_count, i32* %4, align 4
  call void @llvm.dbg.declare(metadata !{i32* %4}, metadata !2981), !dbg !2982 ; [debug line = 83:48] [debug variable = data_count]
  br label %6, !dbg !2983                         ; [debug line = 83:60]

; <label>:6                                       ; preds = %0
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !2985), !dbg !2987 ; [debug line = 85:17] [debug variable = i]
  store i32 0, i32* %i, align 4, !dbg !2988       ; [debug line = 85:22]
  br label %7, !dbg !2988                         ; [debug line = 85:22]

; <label>:7                                       ; preds = %26, %6
  %8 = load i32* %i, align 4, !dbg !2988          ; [#uses=1 type=i32] [debug line = 85:22]
  %9 = load i32* %4, align 4, !dbg !2988          ; [#uses=1 type=i32] [debug line = 85:22]
  %10 = icmp ult i32 %8, %9, !dbg !2988           ; [#uses=1 type=i1] [debug line = 85:22]
  br i1 %10, label %11, label %27, !dbg !2988     ; [debug line = 85:22]

; <label>:11                                      ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !2989 ; [debug line = 85:42]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !2989 ; [debug line = 85:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !2991 ; [debug line = 86:1]
  %12 = load %"class.std::locale::id"** %2, align 8, !dbg !2992 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 87:27]
  %13 = call zeroext i1 @_ZNK3hls6streamImE5emptyEv(%"class.std::locale::id"* %12), !dbg !2992 ; [#uses=1 type=i1] [debug line = 87:27]
  br i1 %13, label %26, label %14, !dbg !2992     ; [debug line = 87:27]

; <label>:14                                      ; preds = %11
  %15 = load %"class.std::locale::id"** %3, align 8, !dbg !2993 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 87:45]
  %16 = call zeroext i1 @_ZNK3hls6streamImE5emptyEv(%"class.std::locale::id"* %15), !dbg !2993 ; [#uses=1 type=i1] [debug line = 87:45]
  br i1 %16, label %26, label %17, !dbg !2993     ; [debug line = 87:45]

; <label>:17                                      ; preds = %14
  %18 = load %"class.std::locale::id"** %1, align 8, !dbg !2994 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 88:7]
  %19 = load %"class.std::locale::id"** %2, align 8, !dbg !2996 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 88:17]
  %20 = call i64 @_ZN3hls6streamImE4readEv(%"class.std::locale::id"* %19), !dbg !2996 ; [#uses=1 type=i64] [debug line = 88:17]
  %21 = load %"class.std::locale::id"** %3, align 8, !dbg !2997 ; [#uses=1 type=%"class.std::locale::id"*] [debug line = 88:33]
  %22 = call i64 @_ZN3hls6streamImE4readEv(%"class.std::locale::id"* %21), !dbg !2997 ; [#uses=1 type=i64] [debug line = 88:33]
  %23 = sub i64 %20, %22, !dbg !2997              ; [#uses=1 type=i64] [debug line = 88:33]
  store i64 %23, i64* %5, align 8, !dbg !2997     ; [debug line = 88:33]
  call void @_ZN3hls6streamImE5writeERKm(%"class.std::locale::id"* %18, i64* %5), !dbg !2997 ; [debug line = 88:33]
  %24 = load i32* %i, align 4, !dbg !2998         ; [#uses=1 type=i32] [debug line = 89:7]
  %25 = add i32 %24, 1, !dbg !2998                ; [#uses=1 type=i32] [debug line = 89:7]
  store i32 %25, i32* %i, align 4, !dbg !2998     ; [debug line = 89:7]
  br label %26, !dbg !2999                        ; [debug line = 90:5]

; <label>:26                                      ; preds = %17, %14, %11
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !3000 ; [debug line = 91:3]
  br label %7, !dbg !3000                         ; [debug line = 91:3]

; <label>:27                                      ; preds = %7
  ret void, !dbg !3001                            ; [debug line = 92:1]
}
...
define void @dataflow_stalls_kernel(i64* %output_ddr0, i64* %input_ddr0, i32 %data_count) nounwind uwtable {
  ...
  %data_stage3 = alloca %"class.std::locale::id", align 8 ; [#uses=4 type=%"class.std::locale::id"*]
  ...
  call void @llvm.dbg.declare(metadata !{i64** %1}, metadata !3002), !dbg !3003 ; [debug line = 96:35] [debug variable = output_ddr0]
  store i64* %input_ddr0, i64** %2, align 8
  call void @llvm.dbg.declare(metadata !{i64** %2}, metadata !3004), !dbg !3005 ; [debug line = 96:54] [debug variable = input_ddr0]
  store i32 %data_count, i32* %3, align 4
  call void @llvm.dbg.declare(metadata !{i32* %3}, metadata !3006), !dbg !3007 ; [debug line = 97:38] [debug variable = data_count]
  %4 = load i64** %1, align 8, !dbg !3008         ; [#uses=1 type=i64*] [debug line = 98:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %4, i8* getelementptr inbounds ([6 x i8]* @.str7, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 65536, i8* getelementptr inbounds ([6 x i8]* @.str8, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3008 ; [debug line = 98:1]
  %5 = load i64** %2, align 8, !dbg !3010         ; [#uses=1 type=i64*] [debug line = 99:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %5, i8* getelementptr inbounds ([6 x i8]* @.str7, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 65536, i8* getelementptr inbounds ([6 x i8]* @.str10, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3010 ; [debug line = 99:1]
  %6 = load i64** %1, align 8, !dbg !3011         ; [#uses=1 type=i64*] [debug line = 101:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %6, i8* getelementptr inbounds ([10 x i8]* @.str11, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3011 ; [debug line = 101:1]
  %7 = load i64** %2, align 8, !dbg !3012         ; [#uses=1 type=i64*] [debug line = 102:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %7, i8* getelementptr inbounds ([10 x i8]* @.str11, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3012 ; [debug line = 102:1]
  %8 = load i32* %3, align 4, !dbg !3013          ; [#uses=1 type=i32] [debug line = 103:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %8, i8* getelementptr inbounds ([10 x i8]* @.str11, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3013 ; [debug line = 103:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str11, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3014 ; [debug line = 104:1]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"* %data_stage0}, metadata !3015), !dbg !3016 ; [debug line = 106:20] [debug variable = data_stage0]
  call void @_ZN3hls6streamImEC1EPKc(%"class.std::locale::id"* %data_stage0, i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0)), !dbg !3017 ; [debug line = 106:46]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"* %data_stage1}, metadata !3018), !dbg !3019 ; [debug line = 107:21] [debug variable = data_stage1]
  call void @_ZN3hls6streamImEC1EPKc(%"class.std::locale::id"* %data_stage1, i8* getelementptr inbounds ([12 x i8]* @.str14, i32 0, i32 0)), !dbg !3020 ; [debug line = 107:47]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"* %data_stage2}, metadata !3021), !dbg !3022 ; [debug line = 108:21] [debug variable = data_stage2]
  call void @_ZN3hls6streamImEC1EPKc(%"class.std::locale::id"* %data_stage2, i8* getelementptr inbounds ([12 x i8]* @.str15, i32 0, i32 0)), !dbg !3023 ; [debug line = 108:47]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"* %data_stage3}, metadata !3024), !dbg !3025 ; [debug line = 109:21] [debug variable = data_stage3]
  call void @_ZN3hls6streamImEC1EPKc(%"class.std::locale::id"* %data_stage3, i8* getelementptr inbounds ([12 x i8]* @.str16, i32 0, i32 0)), !dbg !3026 ; [debug line = 109:47]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"* %data_stage4}, metadata !3027), !dbg !3028 ; [debug line = 110:21] [debug variable = data_stage4]
  call void @_ZN3hls6streamImEC1EPKc(%"class.std::locale::id"* %data_stage4, i8* getelementptr inbounds ([12 x i8]* @.str17, i32 0, i32 0)), !dbg !3029 ; [debug line = 110:47]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"* %data_stage5}, metadata !3030), !dbg !3031 ; [debug line = 111:21] [debug variable = data_stage5]
  call void @_ZN3hls6streamImEC1EPKc(%"class.std::locale::id"* %data_stage5, i8* getelementptr inbounds ([12 x i8]* @.str18, i32 0, i32 0)), !dbg !3032 ; [debug line = 111:47]
  call void (...)* @_ssdm_SpecStream(%"class.std::locale::id"* %data_stage0, i32 0, i32 10, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3033 ; [debug line = 113:1]
  call void (...)* @_ssdm_SpecStream(%"class.std::locale::id"* %data_stage5, i32 0, i32 10, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3034 ; [debug line = 114:1]
  call void (...)* @_ssdm_SpecStream(%"class.std::locale::id"* %data_stage3, i32 0, i32 5, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3035 ; [debug line = 117:1]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !3036 ; [debug line = 120:1]
  %9 = load i64** %2, align 8, !dbg !3037         ; [#uses=1 type=i64*] [debug line = 121:2]
  %10 = load i32* %3, align 4, !dbg !3037         ; [#uses=1 type=i32] [debug line = 121:2]
  call void @_Z4loadPN3hls6streamImEEPmj(%"class.std::locale::id"* %data_stage0, i64* %9, i32 %10), !dbg !3037 ; [debug line = 121:2]
  %11 = load i32* %3, align 4, !dbg !3038         ; [#uses=1 type=i32] [debug line = 122:3]
  call void @_Z7scatterPN3hls6streamImEES2_S2_j(%"class.std::locale::id"* %data_stage1, %"class.std::locale::id"* %data_stage2, %"class.std::locale::id"* %data_stage0, i32 %11), !dbg !3038 ; [debug line = 122:3]
  %12 = load i32* %3, align 4, !dbg !3039         ; [#uses=1 type=i32] [debug line = 123:3]
  call void @_Z8compute1PN3hls6streamImEES2_j(%"class.std::locale::id"* %data_stage3, %"class.std::locale::id"* %data_stage1, i32 %12), !dbg !3039 ; [debug line = 123:3]
  %13 = load i32* %3, align 4, !dbg !3040         ; [#uses=1 type=i32] [debug line = 124:3]
  call void @_Z8compute2PN3hls6streamImEES2_j(%"class.std::locale::id"* %data_stage4, %"class.std::locale::id"* %data_stage2, i32 %13), !dbg !3040 ; [debug line = 124:3]
  %14 = load i32* %3, align 4, !dbg !3041         ; [#uses=1 type=i32] [debug line = 125:3]
  call void @_Z6gatherPN3hls6streamImEES2_S2_j(%"class.std::locale::id"* %data_stage5, %"class.std::locale::id"* %data_stage3, %"class.std::locale::id"* %data_stage4, i32 %14), !dbg !3041 ; [debug line = 125:3]
  %15 = load i64** %1, align 8, !dbg !3042        ; [#uses=1 type=i64*] [debug line = 126:3]
  %16 = load i32* %3, align 4, !dbg !3042         ; [#uses=1 type=i32] [debug line = 126:3]
  call void @_Z5storePmPN3hls6streamImEEj(i64* %15, %"class.std::locale::id"* %data_stage5, i32 %16), !dbg !3042 ; [debug line = 126:3]
  ret void, !dbg !3043                            ; [debug line = 127:1]
}
...
define linkonce_odr void @_ZN3hls6streamImEC1EPKc(%"class.std::locale::id"* %this, i8* %name) unnamed_addr nounwind uwtable inlinehint alwaysinline align 2 {
  ...
  store %"class.std::locale::id"* %this, %"class.std::locale::id"** %1, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !3044), !dbg !3045 ; [debug line = 86:43] [debug variable = this]
  store i8* %name, i8** %2, align 8
  call void @llvm.dbg.declare(metadata !{i8** %2}, metadata !3046), !dbg !3047 ; [debug line = 86:62] [debug variable = name]
  %3 = load %"class.std::locale::id"** %1         ; [#uses=1 type=%"class.std::locale::id"*]
  %4 = load i8** %2, align 8, !dbg !3048          ; [#uses=1 type=i8*] [debug line = 87:5]
  call void @_ZN3hls6streamImEC2EPKc(%"class.std::locale::id"* %3, i8* %4), !dbg !3048 ; [debug line = 87:5]
  ret void, !dbg !3048                            ; [debug line = 87:5]
}
...
define linkonce_odr void @_ZN55ssdm_global_array_dataflow_stalls_kernelpp0cppaplinecppC1Ev(%"struct.std::piecewise_construct_t"* %this) unnamed_addr nounwind uwtable inlinehint alwaysinline align 2 {
  ...
  call void @llvm.dbg.declare(metadata !{%"struct.std::piecewise_construct_t"** %1}, metadata !3049), !dbg !3051 ; [debug line = 133:42] [debug variable = this]
  %2 = load %"struct.std::piecewise_construct_t"** %1 ; [#uses=1 type=%"struct.std::piecewise_construct_t"*]
  call void @_ZN55ssdm_global_array_dataflow_stalls_kernelpp0cppaplinecppC2Ev(%"struct.std::piecewise_construct_t"* %2), !dbg !3052 ; [debug line = 135:3]
  ret void, !dbg !3052                            ; [debug line = 135:3]
}
...
define linkonce_odr void @_ZN3hls6streamImEC2EPKc(%"class.std::locale::id"* %this, i8* %name) unnamed_addr nounwind uwtable inlinehint alwaysinline align 2 {
  ...
  store %"class.std::locale::id"* %this, %"class.std::locale::id"** %1, align 8
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id"** %1}, metadata !3053), !dbg !3054 ; [debug line = 86:43] [debug variable = this]
  store i8* %name, i8** %2, align 8
  call void @llvm.dbg.declare(metadata !{i8** %2}, metadata !3055), !dbg !3056 ; [debug line = 86:62] [debug variable = name]
  %3 = load %"class.std::locale::id"** %1         ; [#uses=0 type=%"class.std::locale::id"*]
  ret void, !dbg !3057                            ; [debug line = 87:5]
}
...
define linkonce_odr void @_ZN55ssdm_global_array_dataflow_stalls_kernelpp0cppaplinecppC2Ev(%"struct.std::piecewise_construct_t"* %this) unnamed_addr nounwind uwtable inlinehint alwaysinline align 2 {
  %1 = alloca %"struct.std::piecewise_construct_t"*, align 8 ; [#uses=2 type=%"struct.std::piecewise_construct_t"**]
  store %"struct.std::piecewise_construct_t"* %this, %"struct.std::piecewise_construct_t"** %1, align 8
  call void @llvm.dbg.declare(metadata !{%"struct.std::piecewise_construct_t"** %1}, metadata !3059), !dbg !3060 ; [debug line = 133:42] [debug variable = this]
  %2 = load %"struct.std::piecewise_construct_t"** %1 ; [#uses=0 type=%"struct.std::piecewise_construct_t"*]
  call void (...)* @_ssdm_SpecConstant(i1* @_ZL12kNoTestEmpty) nounwind, !dbg !3061 ; [debug line = 134:4]
  ret void, !dbg !3063                            ; [debug line = 135:3]
}
...
!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!2793, !2800, !2806, !2808, !2810, !2811, !2813, !2816, !2822, !2823, !2829, !2834, !2835, !2836}
!hls.encrypted.func = !{}
...
!1034 = metadata !{i32 786478, i32 0, metadata !963, metadata !"empty", metadata !"empty", metadata !"_ZNK3hls6streamImE5emptyEv", metadata !964, i32 112, metadata !993, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i1 (%"class.std::locale::id"*)* @_ZNK3hls6streamImE5emptyEv, null, metadata !992, metadata !89, i32 112} ; [ DW_TAG_subprogram ]
...
!1047 = metadata !{i32 786484, i32 0, metadata !1048, metadata !"piecewise_construct", metadata !"piecewise_construct", metadata !"_ZStL19piecewise_construct", metadata !1049, i32 75, metadata !1050, i32 1, i32 1, %"struct.std::piecewise_construct_t"* @_ZStL19piecewise_construct} ; [ DW_TAG_variable ]
...
!1061 = metadata !{i32 786484, i32 0, metadata !1062, metadata !"allocator_arg", metadata !"allocator_arg", metadata !"_ZStL13allocator_arg", metadata !317, i32 212, metadata !1063, i32 1, i32 1, %"struct.std::piecewise_construct_t"* @_ZStL13allocator_arg} ; [ DW_TAG_variable ]
...
!1122 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !1124, i32 74, metadata !1125, i32 1, i32 1, %"struct.std::piecewise_construct_t"* @_ZStL8__ioinit} ; [ DW_TAG_variable ]
...
!1133 = metadata !{i32 786484, i32 0, null, metadata !"kNoTestEmpty", metadata !"kNoTestEmpty", metadata !"_ZL12kNoTestEmpty", metadata !958, i32 14, metadata !1134, i32 1, i32 1, i1* @_ZL12kNoTestEmpty} ; [ DW_TAG_variable ]
!1134 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !238} ; [ DW_TAG_const_type ]
!1135 = metadata !{i32 786484, i32 0, null, metadata !"ssdm_global_array_ins", metadata !"ssdm_global_array_ins", metadata !"_ZL21ssdm_global_array_ins", metadata !958, i32 137, metadata !1041, i32 1, i32 1, %"struct.std::piecewise_construct_t"* @_ZL21ssdm_global_array_ins} ; [ DW_TAG_variable ]
!1136 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !1137, i32 149, metadata !56, i32 0, i32 1, i32* @signgam} ; [ DW_TAG_variable ]
...
!1138 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdin_", metadata !"_IO_2_1_stdin_", metadata !"", metadata !1139, i32 321, metadata !1140, i32 0, i32 1, %"struct.std::piecewise_construct_t"* @_IO_2_1_stdin_} ; [ DW_TAG_variable ]
...
!1141 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdout_", metadata !"_IO_2_1_stdout_", metadata !"", metadata !1139, i32 322, metadata !1140, i32 0, i32 1, %"struct.std::piecewise_construct_t"* @_IO_2_1_stdout_} ; [ DW_TAG_variable ]
!1142 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stderr_", metadata !"_IO_2_1_stderr_", metadata !"", metadata !1139, i32 323, metadata !1140, i32 0, i32 1, %"struct.std::piecewise_construct_t"* @_IO_2_1_stderr_} ; [ DW_TAG_variable ]
!1143 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !1144, i32 26, metadata !56, i32 0, i32 1, i32* @sys_nerr} ; [ DW_TAG_variable ]
...
!1145 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !1144, i32 30, metadata !56, i32 0, i32 1, i32* @_sys_nerr} ; [ DW_TAG_variable ]
!1146 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !1147, i32 73, metadata !1134, i32 0, i32 1, i1* @_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE} ; [ DW_TAG_variable ]
...
!1148 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !1147, i32 76, metadata !168, i32 0, i32 1, i32* @_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE} ; [ DW_TAG_variable ]
!1149 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !1147, i32 111, metadata !168, i32 0, i32 1, i32* @_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E} ; [ DW_TAG_variable ]
!1150 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !1147, i32 114, metadata !1134, i32 0, i32 1, i1* @_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE} ; [ DW_TAG_variable ]
!1151 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !1147, i32 117, metadata !168, i32 0, i32 1, i32* @_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E} ; [ DW_TAG_variable ]
!1152 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !1147, i32 120, metadata !168, i32 0, i32 1, i32* @_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E} ; [ DW_TAG_variable ]
!1153 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !1154, i32 283, metadata !56, i32 0, i32 1, i32* @__daylight} ; [ DW_TAG_variable ]
...
!1155 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !1154, i32 297, metadata !56, i32 0, i32 1, i32* @daylight} ; [ DW_TAG_variable ]
!1156 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !1154, i32 403, metadata !56, i32 0, i32 1, i32* @getdate_err} ; [ DW_TAG_variable ]
!1157 = metadata !{i32 786484, i32 0, null, metadata !"optarg", metadata !"optarg", metadata !"", metadata !1158, i32 58, metadata !213, i32 0, i32 1, i8** @optarg} ; [ DW_TAG_variable ]
...
!1159 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !1158, i32 72, metadata !56, i32 0, i32 1, i32* @optind} ; [ DW_TAG_variable ]
!1160 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !1158, i32 77, metadata !56, i32 0, i32 1, i32* @opterr} ; [ DW_TAG_variable ]
!1161 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !1158, i32 81, metadata !56, i32 0, i32 1, i32* @optopt} ; [ DW_TAG_variable ]
!1162 = metadata !{i32 786484, i32 0, metadata !1163, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !1164, i32 70, metadata !1165, i32 0, i32 1, %"struct.std::piecewise_construct_t"* @_ZSt7nothrow} ; [ DW_TAG_variable ]
...
!1167 = metadata !{i32 786484, i32 0, null, metadata !"program_invocation_name", metadata !"program_invocation_name", metadata !"", metadata !1168, i32 54, metadata !213, i32 0, i32 1, i8** @program_invocation_name} ; [ DW_TAG_variable ]
...
!1169 = metadata !{i32 786484, i32 0, null, metadata !"program_invocation_short_name", metadata !"program_invocation_short_name", metadata !"", metadata !1168, i32 54, metadata !213, i32 0, i32 1, i8** @program_invocation_short_name} ; [ DW_TAG_variable ]
!1170 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !117, i32 307, metadata !1171, i32 0, i32 1, i32* @_ZNSt6locale7_S_onceE} ; [ DW_TAG_variable ]
...
!1173 = metadata !{i32 786484, i32 0, metadata !128, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !117, i32 353, metadata !1171, i32 0, i32 1, i32* @_ZNSt6locale5facet7_S_onceE} ; [ DW_TAG_variable ]
!1174 = metadata !{i32 786484, i32 0, metadata !251, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !117, i32 456, metadata !84, i32 0, i32 1, i32* @_ZNSt6locale2id11_S_refcountE} ; [ DW_TAG_variable ]
!1175 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !117, i32 634, metadata !251, i32 0, i32 1, %"class.std::locale::id"* @_ZNSt7collate2idE} ; [ DW_TAG_variable ]
!1176 = metadata !{i32 786484, i32 0, metadata !1125, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 542, metadata !84, i32 0, i32 1, i32* @_ZNSt8ios_base4Init11_S_refcountE} ; [ DW_TAG_variable ]
!1177 = metadata !{i32 786484, i32 0, metadata !1125, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !5, i32 543, metadata !238, i32 0, i32 1, i1* @_ZNSt8ios_base4Init20_S_synced_with_stdioE} ; [ DW_TAG_variable ]
!1178 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !1179, i32 613, metadata !251, i32 0, i32 1, %"class.std::locale::id"* @_ZNSt5ctype2idE} ; [ DW_TAG_variable ]
...
!1282 = metadata !{i32 786484, i32 0, metadata !1197, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !1179, i32 696, metadata !251, i32 0, i32 1, %"class.std::locale::id"* @_ZNSt5ctypeIcE2idE} ; [ DW_TAG_variable ]
!1283 = metadata !{i32 786484, i32 0, metadata !1284, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !1179, i32 1198, metadata !251, i32 0, i32 1, %"class.std::locale::id"* @_ZNSt5ctypeIwE2idE} ; [ DW_TAG_variable ]
...
!1416 = metadata !{i32 786484, i32 0, metadata !1417, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !1179, i32 1543, metadata !172, i32 0, i32 1, i8** @_ZNSt10__num_base12_S_atoms_outE} ; [ DW_TAG_variable ]
...
!1423 = metadata !{i32 786484, i32 0, metadata !1417, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !1179, i32 1547, metadata !172, i32 0, i32 1, i8** @_ZNSt10__num_base11_S_atoms_inE} ; [ DW_TAG_variable ]
!1424 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !1179, i32 1657, metadata !251, i32 0, i32 1, %"class.std::locale::id"* @_ZNSt8numpunct2idE} ; [ DW_TAG_variable ]
!1425 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !1179, i32 1926, metadata !251, i32 0, i32 1, %"class.std::locale::id"* @_ZNSt7num_get2idE} ; [ DW_TAG_variable ]
!1426 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !1179, i32 2264, metadata !251, i32 0, i32 1, %"class.std::locale::id"* @_ZNSt7num_put2idE} ; [ DW_TAG_variable ]
!1427 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !1124, i32 60, metadata !1428, i32 0, i32 1, %"class.std::basic_istream"* @_ZSt3cin} ; [ DW_TAG_variable ]
...
!2112 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !1124, i32 61, metadata !2113, i32 0, i32 1, %"class.std::basic_ostream"* @_ZSt4cout} ; [ DW_TAG_variable ]
...
!2114 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !1124, i32 62, metadata !2113, i32 0, i32 1, %"class.std::basic_ostream"* @_ZSt4cerr} ; [ DW_TAG_variable ]
!2115 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !1124, i32 63, metadata !2113, i32 0, i32 1, %"class.std::basic_ostream"* @_ZSt4clog} ; [ DW_TAG_variable ]
!2116 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !1124, i32 66, metadata !2117, i32 0, i32 1, %"class.std::basic_istream.0"* @_ZSt4wcin} ; [ DW_TAG_variable ]
...
!2789 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !1124, i32 67, metadata !2790, i32 0, i32 1, %"class.std::basic_ostream.3"* @_ZSt5wcout} ; [ DW_TAG_variable ]
...
!2791 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !1124, i32 68, metadata !2790, i32 0, i32 1, %"class.std::basic_ostream.3"* @_ZSt5wcerr} ; [ DW_TAG_variable ]
!2792 = metadata !{i32 786484, i32 0, metadata !1123, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !1124, i32 69, metadata !2790, i32 0, i32 1, %"class.std::basic_ostream.3"* @_ZSt5wclog} ; [ DW_TAG_variable ]
!2793 = metadata !{void (%"class.std::locale::id"*, %"class.std::locale::id"*, %"class.std::locale::id"*, i32)* @_Z7scatterPN3hls6streamImEES2_S2_j, metadata !2794, metadata !2795, metadata !2796, metadata !2797, metadata !2798, metadata !2799}
...
!2800 = metadata !{void (%"class.std::locale::id"*, i64*, i32)* @_Z4loadPN3hls6streamImEEPmj, metadata !2801, metadata !2802, metadata !2803, metadata !2804, metadata !2805, metadata !2799}
...
!2806 = metadata !{void (i64*, %"class.std::locale::id"*, i32)* @_Z5storePmPN3hls6streamImEEj, metadata !2801, metadata !2802, metadata !2807, metadata !2804, metadata !2805, metadata !2799}
!2807 = metadata !{metadata !"kernel_arg_type", metadata !"Data*", metadata !"hls::stream<Data>*", metadata !"uint32_t"}
!2808 = metadata !{void (%"class.std::locale::id"*, %"class.std::locale::id"*, i32)* @_Z8compute1PN3hls6streamImEES2_j, metadata !2801, metadata !2802, metadata !2809, metadata !2804, metadata !2805, metadata !2799}
!2809 = metadata !{metadata !"kernel_arg_type", metadata !"hls::stream<Data>*", metadata !"hls::stream<Data>*", metadata !"uint32_t"}
!2810 = metadata !{void (%"class.std::locale::id"*, %"class.std::locale::id"*, i32)* @_Z8compute2PN3hls6streamImEES2_j, metadata !2801, metadata !2802, metadata !2809, metadata !2804, metadata !2805, metadata !2799}
!2811 = metadata !{void (%"class.std::locale::id"*, %"class.std::locale::id"*, %"class.std::locale::id"*, i32)* @_Z6gatherPN3hls6streamImEES2_S2_j, metadata !2794, metadata !2795, metadata !2796, metadata !2797, metadata !2812, metadata !2799}
...
!2816 = metadata !{void (%"class.std::locale::id"*, i8*)* @_ZN3hls6streamImEC1EPKc, metadata !2817, metadata !2818, metadata !2819, metadata !2820, metadata !2821, metadata !2799}
...
!2822 = metadata !{void (%"class.std::locale::id"*, i8*)* @_ZN3hls6streamImEC2EPKc, metadata !2817, metadata !2818, metadata !2819, metadata !2820, metadata !2821, metadata !2799}
!2823 = metadata !{i1 (%"class.std::locale::id"*)* @_ZNK3hls6streamImE5emptyEv, metadata !2824, metadata !2825, metadata !2826, metadata !2827, metadata !2828, metadata !2799}
!2824 = metadata !{metadata !"kernel_arg_addr_space"}
!2825 = metadata !{metadata !"kernel_arg_access_qual"}
!2826 = metadata !{metadata !"kernel_arg_type"}
!2827 = metadata !{metadata !"kernel_arg_type_qual"}
!2828 = metadata !{metadata !"kernel_arg_name"}
!2829 = metadata !{void (%"class.std::locale::id"*, i64*)* @_ZN3hls6streamImE5writeERKm, metadata !2830, metadata !2818, metadata !2831, metadata !2832, metadata !2833, metadata !2799}
!2830 = metadata !{metadata !"kernel_arg_addr_space", i32 0}
!2831 = metadata !{metadata !"kernel_arg_type", metadata !"const ulong &"}
!2832 = metadata !{metadata !"kernel_arg_type_qual", metadata !""}
!2833 = metadata !{metadata !"kernel_arg_name", metadata !"din"}
!2834 = metadata !{i64 (%"class.std::locale::id"*)* @_ZN3hls6streamImE4readEv, metadata !2824, metadata !2825, metadata !2826, metadata !2827, metadata !2828, metadata !2799}
!2835 = metadata !{void (%"struct.std::piecewise_construct_t"*)* @_ZN55ssdm_global_array_dataflow_stalls_kernelpp0cppaplinecppC1Ev, metadata !2824, metadata !2825, metadata !2826, metadata !2827, metadata !2828, metadata !2799}
!2836 = metadata !{void (%"struct.std::piecewise_construct_t"*)* @_ZN55ssdm_global_array_dataflow_stalls_kernelpp0cppaplinecppC2Ev, metadata !2824, metadata !2825, metadata !2826, metadata !2827, metadata !2828, metadata !2799}
!2837 = metadata !{i32 786689, metadata !957, metadata !"to0", metadata !958, i32 16777245, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2838 = metadata !{i32 29, i32 33, metadata !957, null}
!2839 = metadata !{i32 786689, metadata !957, metadata !"to1", metadata !958, i32 33554461, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2840 = metadata !{i32 29, i32 57, metadata !957, null}
!2841 = metadata !{i32 786689, metadata !957, metadata !"from", metadata !958, i32 50331678, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2842 = metadata !{i32 30, i32 33, metadata !957, null}
!2843 = metadata !{i32 786689, metadata !957, metadata !"data_count", metadata !958, i32 67108894, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2844 = metadata !{i32 30, i32 48, metadata !957, null}
!2845 = metadata !{i32 30, i32 60, metadata !2846, null}
!2846 = metadata !{i32 786443, metadata !957, i32 30, i32 60, metadata !958, i32 0} ; [ DW_TAG_lexical_block ]
!2847 = metadata !{i32 786688, metadata !2848, metadata !"i", metadata !958, i32 32, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2848 = metadata !{i32 786443, metadata !2846, i32 32, i32 3, metadata !958, i32 1} ; [ DW_TAG_lexical_block ]
!2849 = metadata !{i32 32, i32 17, metadata !2848, null}
!2850 = metadata !{i32 32, i32 22, metadata !2848, null}
!2851 = metadata !{i32 32, i32 46, metadata !2852, null}
!2852 = metadata !{i32 786443, metadata !2848, i32 32, i32 45, metadata !958, i32 2} ; [ DW_TAG_lexical_block ]
!2853 = metadata !{i32 33, i32 1, metadata !2852, null}
!2854 = metadata !{i32 786688, metadata !2852, metadata !"tmp", metadata !958, i32 34, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2855 = metadata !{i32 34, i32 7, metadata !2852, null}
!2856 = metadata !{i32 34, i32 13, metadata !2852, null}
!2857 = metadata !{i32 35, i32 5, metadata !2852, null}
!2858 = metadata !{i32 36, i32 5, metadata !2852, null}
!2859 = metadata !{i32 37, i32 3, metadata !2852, null}
!2860 = metadata !{i32 32, i32 40, metadata !2848, null}
!2861 = metadata !{i32 38, i32 1, metadata !2846, null}
!2862 = metadata !{i32 786689, metadata !1036, metadata !"this", metadata !964, i32 16777345, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2863 = metadata !{i32 129, i32 56, metadata !1036, null}
!2864 = metadata !{i32 786688, metadata !2865, metadata !"tmp", metadata !964, i32 130, metadata !140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2865 = metadata !{i32 786443, metadata !1036, i32 129, i32 63, metadata !964, i32 25} ; [ DW_TAG_lexical_block ]
!2866 = metadata !{i32 130, i32 22, metadata !2865, null}
!2867 = metadata !{i32 131, i32 9, metadata !2865, null}
!2868 = metadata !{i32 132, i32 9, metadata !2865, null}
!2869 = metadata !{i32 786689, metadata !1035, metadata !"this", metadata !964, i32 16777360, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2870 = metadata !{i32 144, i32 48, metadata !1035, null}
!2871 = metadata !{i32 786689, metadata !1035, metadata !"din", metadata !964, i32 33554576, metadata !990, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2872 = metadata !{i32 144, i32 74, metadata !1035, null}
!2873 = metadata !{i32 786688, metadata !2874, metadata !"tmp", metadata !964, i32 145, metadata !140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2874 = metadata !{i32 786443, metadata !1035, i32 144, i32 79, metadata !964, i32 24} ; [ DW_TAG_lexical_block ]
!2875 = metadata !{i32 145, i32 22, metadata !2874, null}
!2876 = metadata !{i32 145, i32 31, metadata !2874, null}
!2877 = metadata !{i32 146, i32 9, metadata !2874, null}
!2878 = metadata !{i32 147, i32 5, metadata !2874, null}
!2879 = metadata !{i32 786689, metadata !1015, metadata !"to", metadata !958, i32 16777256, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2880 = metadata !{i32 40, i32 30, metadata !1015, null}
!2881 = metadata !{i32 786689, metadata !1015, metadata !"from", metadata !958, i32 33554472, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2882 = metadata !{i32 40, i32 40, metadata !1015, null}
!2883 = metadata !{i32 786689, metadata !1015, metadata !"data_count", metadata !958, i32 50331688, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2884 = metadata !{i32 40, i32 55, metadata !1015, null}
!2885 = metadata !{i32 40, i32 67, metadata !2886, null}
!2886 = metadata !{i32 786443, metadata !1015, i32 40, i32 67, metadata !958, i32 3} ; [ DW_TAG_lexical_block ]
!2887 = metadata !{i32 786688, metadata !2888, metadata !"i", metadata !958, i32 42, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2888 = metadata !{i32 786443, metadata !2886, i32 42, i32 3, metadata !958, i32 4} ; [ DW_TAG_lexical_block ]
!2889 = metadata !{i32 42, i32 17, metadata !2888, null}
!2890 = metadata !{i32 42, i32 22, metadata !2888, null}
!2891 = metadata !{i32 42, i32 46, metadata !2892, null}
!2892 = metadata !{i32 786443, metadata !2888, i32 42, i32 45, metadata !958, i32 5} ; [ DW_TAG_lexical_block ]
!2893 = metadata !{i32 43, i32 1, metadata !2892, null}
!2894 = metadata !{i32 44, i32 2, metadata !2892, null}
!2895 = metadata !{i32 45, i32 3, metadata !2892, null}
!2896 = metadata !{i32 42, i32 40, metadata !2888, null}
!2897 = metadata !{i32 46, i32 1, metadata !2886, null}
!2898 = metadata !{i32 786689, metadata !1021, metadata !"to", metadata !958, i32 16777264, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2899 = metadata !{i32 48, i32 18, metadata !1021, null}
!2900 = metadata !{i32 786689, metadata !1021, metadata !"from", metadata !958, i32 33554480, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2901 = metadata !{i32 48, i32 41, metadata !1021, null}
!2902 = metadata !{i32 786689, metadata !1021, metadata !"data_count", metadata !958, i32 50331696, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2903 = metadata !{i32 48, i32 56, metadata !1021, null}
!2904 = metadata !{i32 48, i32 68, metadata !2905, null}
!2905 = metadata !{i32 786443, metadata !1021, i32 48, i32 68, metadata !958, i32 6} ; [ DW_TAG_lexical_block ]
!2906 = metadata !{i32 786688, metadata !2907, metadata !"i", metadata !958, i32 50, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2907 = metadata !{i32 786443, metadata !2905, i32 50, i32 3, metadata !958, i32 7} ; [ DW_TAG_lexical_block ]
!2908 = metadata !{i32 50, i32 17, metadata !2907, null}
!2909 = metadata !{i32 50, i32 22, metadata !2907, null}
!2910 = metadata !{i32 50, i32 46, metadata !2911, null}
!2911 = metadata !{i32 786443, metadata !2907, i32 50, i32 45, metadata !958, i32 8} ; [ DW_TAG_lexical_block ]
!2912 = metadata !{i32 51, i32 1, metadata !2911, null}
!2913 = metadata !{i32 52, i32 10, metadata !2911, null}
!2914 = metadata !{i32 53, i32 3, metadata !2911, null}
!2915 = metadata !{i32 50, i32 40, metadata !2907, null}
!2916 = metadata !{i32 54, i32 1, metadata !2905, null}
!2917 = metadata !{i32 786689, metadata !1024, metadata !"to", metadata !958, i32 16777272, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2918 = metadata !{i32 56, i32 34, metadata !1024, null}
!2919 = metadata !{i32 786689, metadata !1024, metadata !"from", metadata !958, i32 33554488, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2920 = metadata !{i32 56, i32 57, metadata !1024, null}
!2921 = metadata !{i32 786689, metadata !1024, metadata !"data_count", metadata !958, i32 50331705, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2922 = metadata !{i32 57, i32 24, metadata !1024, null}
!2923 = metadata !{i32 57, i32 36, metadata !2924, null}
!2924 = metadata !{i32 786443, metadata !1024, i32 57, i32 36, metadata !958, i32 9} ; [ DW_TAG_lexical_block ]
!2925 = metadata !{i32 786688, metadata !2926, metadata !"i", metadata !958, i32 59, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2926 = metadata !{i32 786443, metadata !2924, i32 59, i32 3, metadata !958, i32 10} ; [ DW_TAG_lexical_block ]
!2927 = metadata !{i32 59, i32 17, metadata !2926, null}
!2928 = metadata !{i32 59, i32 22, metadata !2926, null}
!2929 = metadata !{i32 59, i32 42, metadata !2930, null}
!2930 = metadata !{i32 786443, metadata !2926, i32 59, i32 41, metadata !958, i32 11} ; [ DW_TAG_lexical_block ]
!2931 = metadata !{i32 60, i32 1, metadata !2930, null}
!2932 = metadata !{i32 61, i32 26, metadata !2930, null}
!2933 = metadata !{i32 786688, metadata !2934, metadata !"tmp", metadata !958, i32 62, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2934 = metadata !{i32 786443, metadata !2930, i32 61, i32 41, metadata !958, i32 12} ; [ DW_TAG_lexical_block ]
!2935 = metadata !{i32 62, i32 12, metadata !2934, null}
!2936 = metadata !{i32 62, i32 18, metadata !2934, null}
!2937 = metadata !{i32 63, i32 7, metadata !2934, null}
!2938 = metadata !{i32 64, i32 7, metadata !2934, null}
!2939 = metadata !{i32 65, i32 5, metadata !2934, null}
!2940 = metadata !{i32 66, i32 3, metadata !2930, null}
!2941 = metadata !{i32 67, i32 1, metadata !2924, null}
!2942 = metadata !{i32 786689, metadata !1034, metadata !"this", metadata !964, i32 16777328, metadata !2943, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2943 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !978} ; [ DW_TAG_pointer_type ]
!2944 = metadata !{i32 112, i32 48, metadata !1034, null}
!2945 = metadata !{i32 786688, metadata !2946, metadata !"tmp", metadata !964, i32 113, metadata !238, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2946 = metadata !{i32 786443, metadata !1034, i32 112, i32 62, metadata !964, i32 23} ; [ DW_TAG_lexical_block ]
!2947 = metadata !{i32 113, i32 14, metadata !2946, null}
!2948 = metadata !{i32 113, i32 20, metadata !2946, null}
!2949 = metadata !{i32 114, i32 9, metadata !2946, null}
!2950 = metadata !{i32 786689, metadata !1027, metadata !"to", metadata !958, i32 16777285, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2951 = metadata !{i32 69, i32 34, metadata !1027, null}
!2952 = metadata !{i32 786689, metadata !1027, metadata !"from", metadata !958, i32 33554501, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2953 = metadata !{i32 69, i32 57, metadata !1027, null}
!2954 = metadata !{i32 786689, metadata !1027, metadata !"data_count", metadata !958, i32 50331718, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2955 = metadata !{i32 70, i32 24, metadata !1027, null}
!2956 = metadata !{i32 70, i32 36, metadata !2957, null}
!2957 = metadata !{i32 786443, metadata !1027, i32 70, i32 36, metadata !958, i32 13} ; [ DW_TAG_lexical_block ]
!2958 = metadata !{i32 786688, metadata !2959, metadata !"i", metadata !958, i32 72, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2959 = metadata !{i32 786443, metadata !2957, i32 72, i32 3, metadata !958, i32 14} ; [ DW_TAG_lexical_block ]
!2960 = metadata !{i32 72, i32 17, metadata !2959, null}
!2961 = metadata !{i32 72, i32 22, metadata !2959, null}
!2962 = metadata !{i32 72, i32 42, metadata !2963, null}
!2963 = metadata !{i32 786443, metadata !2959, i32 72, i32 41, metadata !958, i32 15} ; [ DW_TAG_lexical_block ]
!2964 = metadata !{i32 73, i32 1, metadata !2963, null}
!2965 = metadata !{i32 74, i32 26, metadata !2963, null}
!2966 = metadata !{i32 786688, metadata !2967, metadata !"tmp", metadata !958, i32 75, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2967 = metadata !{i32 786443, metadata !2963, i32 74, i32 41, metadata !958, i32 16} ; [ DW_TAG_lexical_block ]
!2968 = metadata !{i32 75, i32 12, metadata !2967, null}
!2969 = metadata !{i32 75, i32 18, metadata !2967, null}
!2970 = metadata !{i32 76, i32 7, metadata !2967, null}
!2971 = metadata !{i32 77, i32 7, metadata !2967, null}
!2972 = metadata !{i32 78, i32 5, metadata !2967, null}
!2973 = metadata !{i32 79, i32 3, metadata !2963, null}
!2974 = metadata !{i32 80, i32 1, metadata !2957, null}
!2975 = metadata !{i32 786689, metadata !1028, metadata !"to", metadata !958, i32 16777298, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2976 = metadata !{i32 82, i32 32, metadata !1028, null}
!2977 = metadata !{i32 786689, metadata !1028, metadata !"from0", metadata !958, i32 33554514, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2978 = metadata !{i32 82, i32 55, metadata !1028, null}
!2979 = metadata !{i32 786689, metadata !1028, metadata !"from1", metadata !958, i32 50331731, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2980 = metadata !{i32 83, i32 32, metadata !1028, null}
!2981 = metadata !{i32 786689, metadata !1028, metadata !"data_count", metadata !958, i32 67108947, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2982 = metadata !{i32 83, i32 48, metadata !1028, null}
!2983 = metadata !{i32 83, i32 60, metadata !2984, null}
!2984 = metadata !{i32 786443, metadata !1028, i32 83, i32 60, metadata !958, i32 17} ; [ DW_TAG_lexical_block ]
!2985 = metadata !{i32 786688, metadata !2986, metadata !"i", metadata !958, i32 85, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2986 = metadata !{i32 786443, metadata !2984, i32 85, i32 3, metadata !958, i32 18} ; [ DW_TAG_lexical_block ]
!2987 = metadata !{i32 85, i32 17, metadata !2986, null}
!2988 = metadata !{i32 85, i32 22, metadata !2986, null}
!2989 = metadata !{i32 85, i32 42, metadata !2990, null}
!2990 = metadata !{i32 786443, metadata !2986, i32 85, i32 41, metadata !958, i32 19} ; [ DW_TAG_lexical_block ]
!2991 = metadata !{i32 86, i32 1, metadata !2990, null}
!2992 = metadata !{i32 87, i32 27, metadata !2990, null}
!2993 = metadata !{i32 87, i32 45, metadata !2990, null}
!2994 = metadata !{i32 88, i32 7, metadata !2995, null}
!2995 = metadata !{i32 786443, metadata !2990, i32 87, i32 62, metadata !958, i32 20} ; [ DW_TAG_lexical_block ]
!2996 = metadata !{i32 88, i32 17, metadata !2995, null}
!2997 = metadata !{i32 88, i32 33, metadata !2995, null}
!2998 = metadata !{i32 89, i32 7, metadata !2995, null}
!2999 = metadata !{i32 90, i32 5, metadata !2995, null}
!3000 = metadata !{i32 91, i32 3, metadata !2990, null}
!3001 = metadata !{i32 92, i32 1, metadata !2984, null}
!3002 = metadata !{i32 786689, metadata !1029, metadata !"output_ddr0", metadata !958, i32 16777312, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3003 = metadata !{i32 96, i32 35, metadata !1029, null}
!3004 = metadata !{i32 786689, metadata !1029, metadata !"input_ddr0", metadata !958, i32 33554528, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3005 = metadata !{i32 96, i32 54, metadata !1029, null}
!3006 = metadata !{i32 786689, metadata !1029, metadata !"data_count", metadata !958, i32 50331745, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3007 = metadata !{i32 97, i32 38, metadata !1029, null}
!3008 = metadata !{i32 98, i32 1, metadata !3009, null}
!3009 = metadata !{i32 786443, metadata !1029, i32 97, i32 50, metadata !958, i32 21} ; [ DW_TAG_lexical_block ]
!3010 = metadata !{i32 99, i32 1, metadata !3009, null}
!3011 = metadata !{i32 101, i32 1, metadata !3009, null}
!3012 = metadata !{i32 102, i32 1, metadata !3009, null}
!3013 = metadata !{i32 103, i32 1, metadata !3009, null}
!3014 = metadata !{i32 104, i32 1, metadata !3009, null}
!3015 = metadata !{i32 786688, metadata !3009, metadata !"data_stage0", metadata !958, i32 106, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3016 = metadata !{i32 106, i32 20, metadata !3009, null}
!3017 = metadata !{i32 106, i32 46, metadata !3009, null}
!3018 = metadata !{i32 786688, metadata !3009, metadata !"data_stage1", metadata !958, i32 107, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3019 = metadata !{i32 107, i32 21, metadata !3009, null}
!3020 = metadata !{i32 107, i32 47, metadata !3009, null}
!3021 = metadata !{i32 786688, metadata !3009, metadata !"data_stage2", metadata !958, i32 108, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3022 = metadata !{i32 108, i32 21, metadata !3009, null}
!3023 = metadata !{i32 108, i32 47, metadata !3009, null}
!3024 = metadata !{i32 786688, metadata !3009, metadata !"data_stage3", metadata !958, i32 109, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3025 = metadata !{i32 109, i32 21, metadata !3009, null}
!3026 = metadata !{i32 109, i32 47, metadata !3009, null}
!3027 = metadata !{i32 786688, metadata !3009, metadata !"data_stage4", metadata !958, i32 110, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3028 = metadata !{i32 110, i32 21, metadata !3009, null}
!3029 = metadata !{i32 110, i32 47, metadata !3009, null}
!3030 = metadata !{i32 786688, metadata !3009, metadata !"data_stage5", metadata !958, i32 111, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3031 = metadata !{i32 111, i32 21, metadata !3009, null}
!3032 = metadata !{i32 111, i32 47, metadata !3009, null}
!3033 = metadata !{i32 113, i32 1, metadata !3009, null}
!3034 = metadata !{i32 114, i32 1, metadata !3009, null}
!3035 = metadata !{i32 117, i32 1, metadata !3009, null}
!3036 = metadata !{i32 120, i32 1, metadata !3009, null}
!3037 = metadata !{i32 121, i32 2, metadata !3009, null}
!3038 = metadata !{i32 122, i32 3, metadata !3009, null}
!3039 = metadata !{i32 123, i32 3, metadata !3009, null}
!3040 = metadata !{i32 124, i32 3, metadata !3009, null}
!3041 = metadata !{i32 125, i32 3, metadata !3009, null}
!3042 = metadata !{i32 126, i32 3, metadata !3009, null}
!3043 = metadata !{i32 127, i32 1, metadata !3009, null}
!3044 = metadata !{i32 786689, metadata !1032, metadata !"this", metadata !964, i32 16777302, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3045 = metadata !{i32 86, i32 43, metadata !1032, null}
!3046 = metadata !{i32 786689, metadata !1032, metadata !"name", metadata !964, i32 33554518, metadata !172, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3047 = metadata !{i32 86, i32 62, metadata !1032, null}
!3048 = metadata !{i32 87, i32 5, metadata !1032, null}
!3049 = metadata !{i32 786689, metadata !1037, metadata !"this", metadata !958, i32 16777349, metadata !3050, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3050 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1041} ; [ DW_TAG_pointer_type ]
!3051 = metadata !{i32 133, i32 42, metadata !1037, null}
!3052 = metadata !{i32 135, i32 3, metadata !1037, null}
!3053 = metadata !{i32 786689, metadata !1033, metadata !"this", metadata !964, i32 16777302, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3054 = metadata !{i32 86, i32 43, metadata !1033, null}
!3055 = metadata !{i32 786689, metadata !1033, metadata !"name", metadata !964, i32 33554518, metadata !172, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3056 = metadata !{i32 86, i32 62, metadata !1033, null}
!3057 = metadata !{i32 87, i32 5, metadata !3058, null}
!3058 = metadata !{i32 786443, metadata !1033, i32 86, i32 68, metadata !964, i32 22} ; [ DW_TAG_lexical_block ]
!3059 = metadata !{i32 786689, metadata !1044, metadata !"this", metadata !958, i32 16777349, metadata !3050, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3060 = metadata !{i32 133, i32 42, metadata !1044, null}
!3061 = metadata !{i32 134, i32 4, metadata !3062, null}
!3062 = metadata !{i32 786443, metadata !1044, i32 133, i32 100, metadata !958, i32 26} ; [ DW_TAG_lexical_block ]
!3063 = metadata !{i32 135, i32 3, metadata !3062, null}
