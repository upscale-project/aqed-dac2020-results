; ModuleID = '/rsgs/pool0/esingh/aqed4saranyu/results/dataflow/dataflow-stalls_ab/tmp/set_fifo_depths/2017.1/adm-pcie-7v3/_xocc_compile_dataflow_stalls_kernel_dataflow_stalls-hw.dir/impl/kernels/dataflow_stalls_kernel/dataflow_stalls_kernel/solution_OCL_REGION_0/.autopilot/db/a.o.2.bc'
...
entry:
  ...
  call void (...)* @_ssdm_op_SpecInterface(i64* %to, [6 x i8]* @.str7, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 65536, [6 x i8]* @.str8, [6 x i8]* @.str9, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind
  call void @llvm.dbg.value(metadata !{i64* %to}, i64 0, metadata !2839), !dbg !2840 ; [debug line = 48:18] [debug variable = to]
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !2841), !dbg !2846 ; [debug line = 48:41] [debug variable = from.V]
  call void @llvm.dbg.value(metadata !{i32 %data_count.assign}, i64 0, metadata !2847), !dbg !2848 ; [debug line = 48:56] [debug variable = data_count]
  %tmp.1 = zext i32 0 to i64, !dbg !2849          ; [#uses=1 type=i64] [debug line = 52:10]
  br label %0, !dbg !2853                         ; [debug line = 50:22]

; <label>:0                                       ; preds = %1, %entry
  %i.i = phi i32 [ 0, %entry ], [ %i, %1 ]        ; [#uses=3 type=i32]
  %exitcond.i = icmp eq i32 %i.i, %data_count.assign, !dbg !2853 ; [#uses=1 type=i1] [debug line = 50:22]
  br i1 %exitcond.i, label %.exit, label %1, !dbg !2853 ; [debug line = 50:22]

; <label>:1                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str3) nounwind, !dbg !2854 ; [debug line = 50:46]
  %tmp.2.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str3), !dbg !2854 ; [#uses=1 type=i32] [debug line = 50:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2855 ; [debug line = 51:1]
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !2856), !dbg !2858 ; [debug line = 129:56@52:10] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2859) nounwind, !dbg !2861 ; [debug line = 130:22@52:10] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from.V, i64* %tmp) nounwind, !dbg !2862 ; [debug line = 131:9@52:10]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2859), !dbg !2863 ; [debug line = 132:9@52:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2859), !dbg !2863 ; [debug line = 132:9@52:10] [debug variable = tmp]
  %2 = load i64* %tmp, align 8, !dbg !2863        ; [#uses=1 type=i64] [debug line = 132:9@52:10]
  %tmp.1.i = zext i32 %i.i to i64, !dbg !2849     ; [#uses=1 type=i64] [debug line = 52:10]
  %to.addr = getelementptr inbounds i64* %to, i64 %tmp.1.i, !dbg !2849 ; [#uses=1 type=i64*] [debug line = 52:10]
  %to.addr.1 = getelementptr inbounds i64* %to, i64 %tmp.1, !dbg !2849 ; [#uses=1 type=i64*] [debug line = 52:10]
  %3 = call i32 (...)* @_ssdm_op_SpecBurst(i64* %to.addr.1, i32 0, i32 %data_count.assign, i32 1) ; [#uses=0 type=i32]
  store i64 %2, i64* %to.addr, align 8, !dbg !2849 ; [debug line = 52:10]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str3, i32 %tmp.2.i), !dbg !2864 ; [#uses=0 type=i32] [debug line = 53:3]
  %i = add i32 %i.i, 1, !dbg !2865                ; [#uses=1 type=i32] [debug line = 50:40]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2866), !dbg !2865 ; [debug line = 50:40] [debug variable = i]
  br label %0, !dbg !2865                         ; [debug line = 50:40]
...
entry:
  ...
  call void @llvm.dbg.value(metadata !{i64* %to0.V}, i64 0, metadata !2867), !dbg !2869 ; [debug line = 29:33] [debug variable = to0.V]
  call void @llvm.dbg.value(metadata !{i64* %to1.V}, i64 0, metadata !2870), !dbg !2872 ; [debug line = 29:57] [debug variable = to1.V]
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !2873), !dbg !2875 ; [debug line = 30:33] [debug variable = from.V]
  call void @llvm.dbg.value(metadata !{i32 %data_count.assign}, i64 0, metadata !2876), !dbg !2877 ; [debug line = 30:48] [debug variable = data_count]
  br label %0, !dbg !2878                         ; [debug line = 32:22]

; <label>:0                                       ; preds = %1, %entry
  %i.i = phi i32 [ 0, %entry ], [ %i, %1 ]        ; [#uses=2 type=i32]
  %exitcond.i = icmp eq i32 %i.i, %data_count.assign, !dbg !2878 ; [#uses=1 type=i1] [debug line = 32:22]
  br i1 %exitcond.i, label %.exit, label %1, !dbg !2878 ; [debug line = 32:22]

; <label>:1                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([14 x i8]* @.str) nounwind, !dbg !2881 ; [debug line = 32:46]
  %tmp.4.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([14 x i8]* @.str), !dbg !2881 ; [#uses=1 type=i32] [debug line = 32:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2883 ; [debug line = 33:1]
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !2856), !dbg !2884 ; [debug line = 129:56@34:13] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2859) nounwind, !dbg !2886 ; [debug line = 130:22@34:13] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from.V, i64* %tmp) nounwind, !dbg !2887 ; [debug line = 131:9@34:13]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2859), !dbg !2888 ; [debug line = 132:9@34:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2859), !dbg !2888 ; [debug line = 132:9@34:13] [debug variable = tmp]
  %tmp.1 = load i64* %tmp, align 8, !dbg !2888    ; [#uses=2 type=i64] [debug line = 132:9@34:13]
  call void @llvm.dbg.value(metadata !{i64 %tmp.1}, i64 0, metadata !2889), !dbg !2885 ; [debug line = 34:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %to0.V}, i64 0, metadata !2890), !dbg !2892 ; [debug line = 144:48@35:5] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.2}, metadata !2894) nounwind, !dbg !2896 ; [debug line = 145:22@35:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.1}, i64 0, metadata !2894), !dbg !2897 ; [debug line = 145:31@35:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.1}, i64 0, metadata !2894), !dbg !2897 ; [debug line = 145:31@35:5] [debug variable = tmp]
  store i64 %tmp.1, i64* %tmp.2, align 8, !dbg !2897 ; [debug line = 145:31@35:5]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to0.V, i64* %tmp.2) nounwind, !dbg !2898 ; [debug line = 146:9@35:5]
  call void @llvm.dbg.value(metadata !{i64* %to1.V}, i64 0, metadata !2890), !dbg !2899 ; [debug line = 144:48@36:5] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.3}, metadata !2894) nounwind, !dbg !2901 ; [debug line = 145:22@36:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.1}, i64 0, metadata !2894), !dbg !2902 ; [debug line = 145:31@36:5] [debug variable = tmp]
  store i64 %tmp.1, i64* %tmp.3, align 8, !dbg !2902 ; [debug line = 145:31@36:5]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to1.V, i64* %tmp.3) nounwind, !dbg !2903 ; [debug line = 146:9@36:5]
  %2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([14 x i8]* @.str, i32 %tmp.4.i), !dbg !2904 ; [#uses=0 type=i32] [debug line = 37:3]
  %i = add i32 %i.i, 1, !dbg !2905                ; [#uses=1 type=i32] [debug line = 32:40]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2906), !dbg !2905 ; [debug line = 32:40] [debug variable = i]
  br label %0, !dbg !2905                         ; [debug line = 32:40]
...
entry:
  ...
  call void (...)* @_ssdm_op_SpecInterface(i64* %from, [6 x i8]* @.str7, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 65536, [6 x i8]* @.str10, [6 x i8]* @.str9, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind
  call void @llvm.dbg.value(metadata !{i64* %to.V}, i64 0, metadata !2907), !dbg !2909 ; [debug line = 40:30] [debug variable = to.V]
  call void @llvm.dbg.value(metadata !{i64* %from}, i64 0, metadata !2910), !dbg !2911 ; [debug line = 40:40] [debug variable = from]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !2912), !dbg !2913 ; [debug line = 40:55] [debug variable = data_count]
  %tmp.5 = zext i32 0 to i64, !dbg !2914          ; [#uses=1 type=i64] [debug line = 44:2]
  br label %0, !dbg !2918                         ; [debug line = 42:22]

; <label>:0                                       ; preds = %1, %entry
  %i.i = phi i32 [ 0, %entry ], [ %i, %1 ]        ; [#uses=3 type=i32]
  %exitcond.i = icmp eq i32 %i.i, %data_count, !dbg !2918 ; [#uses=1 type=i1] [debug line = 42:22]
  br i1 %exitcond.i, label %.exit, label %1, !dbg !2918 ; [debug line = 42:22]

; <label>:1                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @.str2) nounwind, !dbg !2919 ; [debug line = 42:46]
  %tmp.6.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([11 x i8]* @.str2), !dbg !2919 ; [#uses=1 type=i32] [debug line = 42:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2920 ; [debug line = 43:1]
  %tmp.i = zext i32 %i.i to i64, !dbg !2914       ; [#uses=1 type=i64] [debug line = 44:2]
  %din.assign = getelementptr inbounds i64* %from, i64 %tmp.i, !dbg !2914 ; [#uses=1 type=i64*] [debug line = 44:2]
  call void @llvm.dbg.value(metadata !{i64* %to.V}, i64 0, metadata !2890), !dbg !2921 ; [debug line = 144:48@44:2] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.value(metadata !{i64* %din.assign}, i64 0, metadata !2922), !dbg !2923 ; [debug line = 144:74@44:2] [debug variable = din]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2894) nounwind, !dbg !2924 ; [debug line = 145:22@44:2] [debug variable = tmp]
  %from.addr = getelementptr inbounds i64* %from, i64 %tmp.5, !dbg !2914 ; [#uses=1 type=i64*] [debug line = 44:2]
  %2 = call i32 (...)* @_ssdm_op_SpecBurst(i64* %from.addr, i32 1, i32 %data_count, i32 1) ; [#uses=0 type=i32]
  %tmp.6 = load i64* %din.assign, align 8, !dbg !2925 ; [#uses=1 type=i64] [debug line = 145:31@44:2]
  call void @llvm.dbg.value(metadata !{i64 %tmp.6}, i64 0, metadata !2894), !dbg !2925 ; [debug line = 145:31@44:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.6}, i64 0, metadata !2894), !dbg !2925 ; [debug line = 145:31@44:2] [debug variable = tmp]
  store i64 %tmp.6, i64* %tmp, align 8, !dbg !2925 ; [debug line = 145:31@44:2]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to.V, i64* %tmp) nounwind, !dbg !2926 ; [debug line = 146:9@44:2]
  %3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([11 x i8]* @.str2, i32 %tmp.6.i), !dbg !2927 ; [#uses=0 type=i32] [debug line = 45:3]
  %i = add i32 %i.i, 1, !dbg !2928                ; [#uses=1 type=i32] [debug line = 42:40]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2929), !dbg !2928 ; [debug line = 42:40] [debug variable = i]
  br label %0, !dbg !2928                         ; [debug line = 42:40]
...
entry:
  ...
  %tmp.8 = alloca i64, align 8                    ; [#uses=2 type=i64*]
  ...
  store i32 %data_count.assign, i32* %data_count_out, align 4
  call void @llvm.dbg.value(metadata !{i64* %to.V}, i64 0, metadata !2930), !dbg !2932 ; [debug line = 82:32] [debug variable = to.V]
  call void @llvm.dbg.value(metadata !{i64* %from0.V}, i64 0, metadata !2933), !dbg !2935 ; [debug line = 82:55] [debug variable = from0.V]
  call void @llvm.dbg.value(metadata !{i64* %from1.V}, i64 0, metadata !2936), !dbg !2938 ; [debug line = 83:32] [debug variable = from1.V]
  call void @llvm.dbg.value(metadata !{i32 %data_count.assign}, i64 0, metadata !2939), !dbg !2940 ; [debug line = 83:48] [debug variable = data_count]
  br label %0, !dbg !2941                         ; [debug line = 85:22]

; <label>:0                                       ; preds = %._crit_edge.i, %entry
  %i.i = phi i32 [ 0, %entry ], [ %i.1.i, %._crit_edge.i ] ; [#uses=4 type=i32]
  %tmp.i = icmp ult i32 %i.i, %data_count.assign, !dbg !2941 ; [#uses=1 type=i1] [debug line = 85:22]
  br i1 %tmp.i, label %1, label %.exit, !dbg !2941 ; [debug line = 85:22]

; <label>:1                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str6) nounwind, !dbg !2944 ; [debug line = 85:42]
  %tmp.12.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @.str6), !dbg !2944 ; [#uses=1 type=i32] [debug line = 85:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2946 ; [debug line = 86:1]
  call void @llvm.dbg.value(metadata !{i64* %from0.V}, i64 0, metadata !2947), !dbg !2950 ; [debug line = 112:48@87:27] [debug variable = stream<unsigned long>.V]
  %tmp = call i1 @_ssdm_op_IfCanRead.Stream.i64P(i64* %from0.V) nounwind, !dbg !2952 ; [#uses=1 type=i1] [debug line = 113:20@87:27]
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !2954), !dbg !2952 ; [debug line = 113:20@87:27] [debug variable = tmp]
  br i1 %tmp, label %2, label %._crit_edge.i, !dbg !2951 ; [debug line = 87:27]

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i64* %from1.V}, i64 0, metadata !2947), !dbg !2955 ; [debug line = 112:48@87:45] [debug variable = stream<unsigned long>.V]
  %tmp.5 = call i1 @_ssdm_op_IfCanRead.Stream.i64P(i64* %from1.V) nounwind, !dbg !2957 ; [#uses=1 type=i1] [debug line = 113:20@87:45]
  call void @llvm.dbg.value(metadata !{i1 %tmp.5}, i64 0, metadata !2954), !dbg !2957 ; [debug line = 113:20@87:45] [debug variable = tmp]
  br i1 %tmp.5, label %3, label %._crit_edge.i, !dbg !2956 ; [debug line = 87:45]

; <label>:3                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{i64* %from0.V}, i64 0, metadata !2856), !dbg !2958 ; [debug line = 129:56@88:17] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.6}, metadata !2859) nounwind, !dbg !2961 ; [debug line = 130:22@88:17] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from0.V, i64* %tmp.6) nounwind, !dbg !2962 ; [debug line = 131:9@88:17]
  call void @llvm.dbg.value(metadata !{i64* %tmp.6}, i64 0, metadata !2859), !dbg !2963 ; [debug line = 132:9@88:17] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.6}, i64 0, metadata !2859), !dbg !2963 ; [debug line = 132:9@88:17] [debug variable = tmp]
  %tmp.6.load = load i64* %tmp.6, align 8, !dbg !2963 ; [#uses=1 type=i64] [debug line = 132:9@88:17]
  call void @llvm.dbg.value(metadata !{i64* %from1.V}, i64 0, metadata !2856), !dbg !2964 ; [debug line = 129:56@88:33] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.7}, metadata !2859) nounwind, !dbg !2966 ; [debug line = 130:22@88:33] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from1.V, i64* %tmp.7) nounwind, !dbg !2967 ; [debug line = 131:9@88:33]
  call void @llvm.dbg.value(metadata !{i64* %tmp.7}, i64 0, metadata !2859), !dbg !2968 ; [debug line = 132:9@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.7}, i64 0, metadata !2859), !dbg !2968 ; [debug line = 132:9@88:33] [debug variable = tmp]
  %tmp.7.load = load i64* %tmp.7, align 8, !dbg !2968 ; [#uses=1 type=i64] [debug line = 132:9@88:33]
  %tmp.9 = sub i64 %tmp.6.load, %tmp.7.load, !dbg !2965 ; [#uses=1 type=i64] [debug line = 88:33]
  call void @llvm.dbg.value(metadata !{i64* %to.V}, i64 0, metadata !2890), !dbg !2969 ; [debug line = 144:48@88:33] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.8}, metadata !2894) nounwind, !dbg !2970 ; [debug line = 145:22@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.9}, i64 0, metadata !2894), !dbg !2971 ; [debug line = 145:31@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.9}, i64 0, metadata !2894), !dbg !2971 ; [debug line = 145:31@88:33] [debug variable = tmp]
  store i64 %tmp.9, i64* %tmp.8, align 8, !dbg !2971 ; [debug line = 145:31@88:33]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to.V, i64* %tmp.8) nounwind, !dbg !2972 ; [debug line = 146:9@88:33]
  %i = add i32 %i.i, 1, !dbg !2973                ; [#uses=1 type=i32] [debug line = 89:7]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2974), !dbg !2973 ; [debug line = 89:7] [debug variable = i]
  br label %._crit_edge.i, !dbg !2975             ; [debug line = 90:5]

._crit_edge.i:                                    ; preds = %3, %2, %1
  %i.1.i = phi i32 [ %i, %3 ], [ %i.i, %1 ], [ %i.i, %2 ] ; [#uses=1 type=i32]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @.str6, i32 %tmp.12.i), !dbg !2976 ; [#uses=0 type=i32] [debug line = 91:3]
  br label %0, !dbg !2976                         ; [debug line = 91:3]
...
define void @dataflow_stalls_kernel(i64* %output_ddr0, i64* %input_ddr0, i32 %data_count) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, [1 x i8]* @.str1) nounwind, !dbg !2977 ; [debug line = 120:1]
  call void (...)* @_ssdm_op_SpecBitsMap(i64* %output_ddr0) nounwind, !map !2979
  call void (...)* @_ssdm_op_SpecBitsMap(i64* %input_ddr0) nounwind, !map !2985
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %data_count) nounwind, !map !2989
  ...
  %4 = call i32 (...)* @_ssdm_op_SpecChannel([14 x i8]* @data_stage3_OC_V.str, i32 1, [1 x i8]* @.str34, [1 x i8]* @.str34, i32 5, i32 5, i64* %data_stage3.V, i64* %data_stage3.V) nounwind ; [#uses=0 type=i32]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i64* %output_ddr0, [6 x i8]* @.str7, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 65536, [6 x i8]* @.str8, [6 x i8]* @.str9, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !2995 ; [debug line = 98:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %input_ddr0, [6 x i8]* @.str7, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 65536, [6 x i8]* @.str10, [6 x i8]* @.str9, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !2996 ; [debug line = 99:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %output_ddr0, [10 x i8]* @.str11, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [8 x i8]* @.str12, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !2997 ; [debug line = 101:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %input_ddr0, [10 x i8]* @.str11, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [8 x i8]* @.str12, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !2998 ; [debug line = 102:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %data_count, [10 x i8]* @.str11, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [8 x i8]* @.str12, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !2999 ; [debug line = 103:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @.str11, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [8 x i8]* @.str12, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !3000 ; [debug line = 104:1]
  call void @llvm.dbg.value(metadata !{i64* %output_ddr0}, i64 0, metadata !3001), !dbg !3002 ; [debug line = 96:35] [debug variable = output_ddr0]
  call void @llvm.dbg.value(metadata !{i64* %input_ddr0}, i64 0, metadata !3003), !dbg !3004 ; [debug line = 96:54] [debug variable = input_ddr0]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !3005), !dbg !3006 ; [debug line = 97:38] [debug variable = data_count]
  call void @llvm.dbg.declare(metadata !{i64* %data_stage0.V}, metadata !3007), !dbg !3009 ; [debug line = 106:20] [debug variable = data_stage0.V]
  call void @llvm.dbg.declare(metadata !{i64* %data_stage1.V}, metadata !3010), !dbg !3012 ; [debug line = 107:21] [debug variable = data_stage1.V]
  call void @llvm.dbg.declare(metadata !{i64* %data_stage2.V}, metadata !3013), !dbg !3015 ; [debug line = 108:21] [debug variable = data_stage2.V]
  call void @llvm.dbg.declare(metadata !{i64* %data_stage3.V}, metadata !3016), !dbg !3018 ; [debug line = 109:21] [debug variable = data_stage3.V]
  call void @llvm.dbg.declare(metadata !{i64* %data_stage4.V}, metadata !3019), !dbg !3021 ; [debug line = 110:21] [debug variable = data_stage4.V]
  call void @llvm.dbg.declare(metadata !{i64* %data_stage5.V}, metadata !3022), !dbg !3024 ; [debug line = 111:21] [debug variable = data_stage5.V]
  ...
  call fastcc void @load(i64* %data_stage0.V, i64* %input_ddr0, i32 %data_count, i32* %data_count_c) nounwind, !dbg !3025 ; [debug line = 121:2]
  ...
  call fastcc void @scatter(i64* %data_stage1.V, i64* %data_stage2.V, i64* %data_stage0.V, i32* nocapture %data_count_c, i32* %data_count_c7, i32* %data_count_c8) nounwind, !dbg !3026 ; [debug line = 122:3]
  ...
  call fastcc void @compute1(i64* %data_stage3.V, i64* %data_stage1.V, i32* nocapture %data_count_c7, i32* %data_count_c9) nounwind, !dbg !3027 ; [debug line = 123:3]
  call fastcc void @compute2(i64* %data_stage4.V, i64* %data_stage2.V, i32* nocapture %data_count_c8) nounwind, !dbg !3028 ; [debug line = 124:3]
  ...
  call fastcc void @gather(i64* %data_stage5.V, i64* %data_stage3.V, i64* %data_stage4.V, i32* nocapture %data_count_c9, i32* %data_count_c10) nounwind, !dbg !3029 ; [debug line = 125:3]
  call fastcc void @store(i64* %output_ddr0, i64* %data_stage5.V, i32* nocapture %data_count_c10) nounwind, !dbg !3030 ; [debug line = 126:3]
  ret void, !dbg !3031                            ; [debug line = 127:1]
}
...
entry:
  ...
  %tmp.10 = alloca i64, align 8                   ; [#uses=2 type=i64*]
  ...
  call void @llvm.dbg.value(metadata !{i64* %to.V}, i64 0, metadata !3032), !dbg !3034 ; [debug line = 69:34] [debug variable = to.V]
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !3035), !dbg !3037 ; [debug line = 69:57] [debug variable = from.V]
  call void @llvm.dbg.value(metadata !{i32 %data_count.assign}, i64 0, metadata !3038), !dbg !3039 ; [debug line = 70:24] [debug variable = data_count]
  br label %0, !dbg !3040                         ; [debug line = 72:22]

; <label>:0                                       ; preds = %._crit_edge.i, %entry
  %i.i = phi i32 [ 0, %entry ], [ %i.1.i, %._crit_edge.i ] ; [#uses=3 type=i32]
  %tmp.i = icmp ult i32 %i.i, %data_count.assign, !dbg !3040 ; [#uses=1 type=i1] [debug line = 72:22]
  br i1 %tmp.i, label %1, label %.exit, !dbg !3040 ; [debug line = 72:22]

; <label>:1                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str5) nounwind, !dbg !3043 ; [debug line = 72:42]
  %tmp.17.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str5), !dbg !3043 ; [#uses=1 type=i32] [debug line = 72:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3045 ; [debug line = 73:1]
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !2947), !dbg !3046 ; [debug line = 112:48@74:26] [debug variable = stream<unsigned long>.V]
  %tmp = call i1 @_ssdm_op_IfCanRead.Stream.i64P(i64* %from.V) nounwind, !dbg !3048 ; [#uses=1 type=i1] [debug line = 113:20@74:26]
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !2954), !dbg !3048 ; [debug line = 113:20@74:26] [debug variable = tmp]
  br i1 %tmp, label %2, label %._crit_edge.i, !dbg !3047 ; [debug line = 74:26]

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !2856), !dbg !3049 ; [debug line = 129:56@75:18] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.10}, metadata !2859) nounwind, !dbg !3052 ; [debug line = 130:22@75:18] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from.V, i64* %tmp.10) nounwind, !dbg !3053 ; [debug line = 131:9@75:18]
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2859), !dbg !3054 ; [debug line = 132:9@75:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2859), !dbg !3054 ; [debug line = 132:9@75:18] [debug variable = tmp]
  %tmp.11 = load i64* %tmp.10, align 8, !dbg !3054 ; [#uses=2 type=i64] [debug line = 132:9@75:18]
  call void @llvm.dbg.value(metadata !{i64 %tmp.11}, i64 0, metadata !3055), !dbg !3050 ; [debug line = 75:18] [debug variable = tmp]
  %tmp.13 = mul i64 %tmp.11, %tmp.11, !dbg !3056  ; [#uses=1 type=i64] [debug line = 76:7]
  call void @llvm.dbg.value(metadata !{i64* %to.V}, i64 0, metadata !2890), !dbg !3057 ; [debug line = 144:48@76:7] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.12}, metadata !2894) nounwind, !dbg !3058 ; [debug line = 145:22@76:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.13}, i64 0, metadata !2894), !dbg !3059 ; [debug line = 145:31@76:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.13}, i64 0, metadata !2894), !dbg !3059 ; [debug line = 145:31@76:7] [debug variable = tmp]
  store i64 %tmp.13, i64* %tmp.12, align 8, !dbg !3059 ; [debug line = 145:31@76:7]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to.V, i64* %tmp.12) nounwind, !dbg !3060 ; [debug line = 146:9@76:7]
  %i = add i32 %i.i, 1, !dbg !3061                ; [#uses=1 type=i32] [debug line = 77:7]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !3062), !dbg !3061 ; [debug line = 77:7] [debug variable = i]
  br label %._crit_edge.i, !dbg !3063             ; [debug line = 78:5]

._crit_edge.i:                                    ; preds = %2, %1
  %i.1.i = phi i32 [ %i, %2 ], [ %i.i, %1 ]       ; [#uses=1 type=i32]
  %3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str5, i32 %tmp.17.i), !dbg !3064 ; [#uses=0 type=i32] [debug line = 79:3]
  br label %0, !dbg !3064                         ; [debug line = 79:3]
...
entry:
  ...
  %tmp.16 = alloca i64, align 8                   ; [#uses=2 type=i64*]
  ...
  store i32 %data_count.assign, i32* %data_count_out, align 4
  call void @llvm.dbg.value(metadata !{i64* %to.V}, i64 0, metadata !3065), !dbg !3067 ; [debug line = 56:34] [debug variable = to.V]
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !3068), !dbg !3070 ; [debug line = 56:57] [debug variable = from.V]
  call void @llvm.dbg.value(metadata !{i32 %data_count.assign}, i64 0, metadata !3071), !dbg !3072 ; [debug line = 57:24] [debug variable = data_count]
  br label %0, !dbg !3073                         ; [debug line = 59:22]

; <label>:0                                       ; preds = %._crit_edge.i, %entry
  %i.i = phi i32 [ 0, %entry ], [ %i.1.i, %._crit_edge.i ] ; [#uses=3 type=i32]
  %tmp.i = icmp ult i32 %i.i, %data_count.assign, !dbg !3073 ; [#uses=1 type=i1] [debug line = 59:22]
  br i1 %tmp.i, label %1, label %.exit, !dbg !3073 ; [debug line = 59:22]

; <label>:1                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str4) nounwind, !dbg !3076 ; [debug line = 59:42]
  %tmp.22.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str4), !dbg !3076 ; [#uses=1 type=i32] [debug line = 59:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3078 ; [debug line = 60:1]
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !2947), !dbg !3079 ; [debug line = 112:48@61:26] [debug variable = stream<unsigned long>.V]
  %tmp = call i1 @_ssdm_op_IfCanRead.Stream.i64P(i64* %from.V) nounwind, !dbg !3081 ; [#uses=1 type=i1] [debug line = 113:20@61:26]
  call void @llvm.dbg.value(metadata !{i1 %tmp}, i64 0, metadata !2954), !dbg !3081 ; [debug line = 113:20@61:26] [debug variable = tmp]
  br i1 %tmp, label %2, label %._crit_edge.i, !dbg !3080 ; [debug line = 61:26]

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i64* %from.V}, i64 0, metadata !2856), !dbg !3082 ; [debug line = 129:56@62:18] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.14}, metadata !2859) nounwind, !dbg !3085 ; [debug line = 130:22@62:18] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from.V, i64* %tmp.14) nounwind, !dbg !3086 ; [debug line = 131:9@62:18]
  call void @llvm.dbg.value(metadata !{i64* %tmp.14}, i64 0, metadata !2859), !dbg !3087 ; [debug line = 132:9@62:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.14}, i64 0, metadata !2859), !dbg !3087 ; [debug line = 132:9@62:18] [debug variable = tmp]
  %tmp.15 = load i64* %tmp.14, align 8, !dbg !3087 ; [#uses=1 type=i64] [debug line = 132:9@62:18]
  call void @llvm.dbg.value(metadata !{i64 %tmp.15}, i64 0, metadata !3088), !dbg !3083 ; [debug line = 62:18] [debug variable = tmp]
  %tmp.17 = shl i64 %tmp.15, 1, !dbg !3089        ; [#uses=1 type=i64] [debug line = 63:7]
  call void @llvm.dbg.value(metadata !{i64* %to.V}, i64 0, metadata !2890), !dbg !3090 ; [debug line = 144:48@63:7] [debug variable = stream<unsigned long>.V]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.16}, metadata !2894) nounwind, !dbg !3091 ; [debug line = 145:22@63:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.17}, i64 0, metadata !2894), !dbg !3092 ; [debug line = 145:31@63:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.17}, i64 0, metadata !2894), !dbg !3092 ; [debug line = 145:31@63:7] [debug variable = tmp]
  store i64 %tmp.17, i64* %tmp.16, align 8, !dbg !3092 ; [debug line = 145:31@63:7]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to.V, i64* %tmp.16) nounwind, !dbg !3093 ; [debug line = 146:9@63:7]
  %i = add i32 %i.i, 1, !dbg !3094                ; [#uses=1 type=i32] [debug line = 64:7]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !3095), !dbg !3094 ; [debug line = 64:7] [debug variable = i]
  br label %._crit_edge.i, !dbg !3096             ; [debug line = 65:5]

._crit_edge.i:                                    ; preds = %2, %1
  %i.1.i = phi i32 [ %i, %2 ], [ %i.i, %1 ]       ; [#uses=1 type=i32]
  %3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str4, i32 %tmp.22.i), !dbg !3097 ; [#uses=0 type=i32] [debug line = 66:3]
  br label %0, !dbg !3097                         ; [debug line = 66:3]
...
!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!2793, !2800, !2806, !2808, !2808, !2810, !2812, !2815, !2815, !2821, !2827, !2821, !2821, !2821}
!hls.encrypted.func = !{}
!llvm.map.gv = !{!2832}
...
!2793 = metadata !{null, metadata !2794, metadata !2795, metadata !2796, metadata !2797, metadata !2798, metadata !2799}
...
!2800 = metadata !{null, metadata !2801, metadata !2802, metadata !2803, metadata !2804, metadata !2805, metadata !2799}
...
!2806 = metadata !{null, metadata !2801, metadata !2802, metadata !2807, metadata !2804, metadata !2805, metadata !2799}
!2807 = metadata !{metadata !"kernel_arg_type", metadata !"Data*", metadata !"hls::stream<Data>*", metadata !"uint32_t"}
!2808 = metadata !{null, metadata !2801, metadata !2802, metadata !2809, metadata !2804, metadata !2805, metadata !2799}
!2809 = metadata !{metadata !"kernel_arg_type", metadata !"hls::stream<Data>*", metadata !"hls::stream<Data>*", metadata !"uint32_t"}
!2810 = metadata !{null, metadata !2794, metadata !2795, metadata !2796, metadata !2797, metadata !2811, metadata !2799}
!2811 = metadata !{metadata !"kernel_arg_name", metadata !"to", metadata !"from0", metadata !"from1", metadata !"data_count"}
!2812 = metadata !{void (i64*, i64*, i32)* @dataflow_stalls_kernel, metadata !2801, metadata !2802, metadata !2813, metadata !2804, metadata !2814, metadata !2799}
...
!2815 = metadata !{null, metadata !2816, metadata !2817, metadata !2818, metadata !2819, metadata !2820, metadata !2799}
...
!2821 = metadata !{null, metadata !2822, metadata !2823, metadata !2824, metadata !2825, metadata !2826, metadata !2799}
!2822 = metadata !{metadata !"kernel_arg_addr_space"}
!2823 = metadata !{metadata !"kernel_arg_access_qual"}
!2824 = metadata !{metadata !"kernel_arg_type"}
!2825 = metadata !{metadata !"kernel_arg_type_qual"}
!2826 = metadata !{metadata !"kernel_arg_name"}
!2827 = metadata !{null, metadata !2828, metadata !2817, metadata !2829, metadata !2830, metadata !2831, metadata !2799}
!2828 = metadata !{metadata !"kernel_arg_addr_space", i32 0}
!2829 = metadata !{metadata !"kernel_arg_type", metadata !"const ulong &"}
!2830 = metadata !{metadata !"kernel_arg_type_qual", metadata !""}
!2831 = metadata !{metadata !"kernel_arg_name", metadata !"din"}
!2832 = metadata !{metadata !2833, [1 x i32]* @llvm.global_ctors.0}
!2833 = metadata !{metadata !2834}
!2834 = metadata !{i32 0, i32 31, metadata !2835}
!2835 = metadata !{metadata !2836}
!2836 = metadata !{metadata !"llvm.global_ctors.0", metadata !2837, metadata !"", i32 0, i32 31}
!2837 = metadata !{metadata !2838}
!2838 = metadata !{i32 0, i32 0, i32 1}
!2839 = metadata !{i32 786689, metadata !1021, metadata !"to", metadata !958, i32 16777264, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2840 = metadata !{i32 48, i32 18, metadata !1021, null}
!2841 = metadata !{i32 790531, metadata !2842, metadata !"from.V", null, i32 48, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2842 = metadata !{i32 786689, metadata !1021, metadata !"from", metadata !958, i32 33554480, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2843 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2844} ; [ DW_TAG_pointer_type ]
!2844 = metadata !{i32 786438, metadata !963, metadata !"stream<unsigned long>", metadata !964, i32 79, i64 64, i64 64, i32 0, i32 0, null, metadata !2845, i32 0, null, metadata !1012} ; [ DW_TAG_class_field_type ]
!2845 = metadata !{metadata !966}
!2846 = metadata !{i32 48, i32 41, metadata !1021, null}
!2847 = metadata !{i32 786689, metadata !1021, metadata !"data_count", metadata !958, i32 50331696, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2848 = metadata !{i32 48, i32 56, metadata !1021, null}
!2849 = metadata !{i32 52, i32 10, metadata !2850, null}
!2850 = metadata !{i32 786443, metadata !2851, i32 50, i32 45, metadata !958, i32 8} ; [ DW_TAG_lexical_block ]
!2851 = metadata !{i32 786443, metadata !2852, i32 50, i32 3, metadata !958, i32 7} ; [ DW_TAG_lexical_block ]
!2852 = metadata !{i32 786443, metadata !1021, i32 48, i32 68, metadata !958, i32 6} ; [ DW_TAG_lexical_block ]
!2853 = metadata !{i32 50, i32 22, metadata !2851, null}
!2854 = metadata !{i32 50, i32 46, metadata !2850, null}
!2855 = metadata !{i32 51, i32 1, metadata !2850, null}
!2856 = metadata !{i32 790531, metadata !2857, metadata !"stream<unsigned long>.V", null, i32 129, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2857 = metadata !{i32 786689, metadata !1036, metadata !"this", metadata !964, i32 16777345, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2858 = metadata !{i32 129, i32 56, metadata !1036, metadata !2849}
!2859 = metadata !{i32 786688, metadata !2860, metadata !"tmp", metadata !964, i32 130, metadata !140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2860 = metadata !{i32 786443, metadata !1036, i32 129, i32 63, metadata !964, i32 25} ; [ DW_TAG_lexical_block ]
!2861 = metadata !{i32 130, i32 22, metadata !2860, metadata !2849}
!2862 = metadata !{i32 131, i32 9, metadata !2860, metadata !2849}
!2863 = metadata !{i32 132, i32 9, metadata !2860, metadata !2849}
!2864 = metadata !{i32 53, i32 3, metadata !2850, null}
!2865 = metadata !{i32 50, i32 40, metadata !2851, null}
!2866 = metadata !{i32 786688, metadata !2851, metadata !"i", metadata !958, i32 50, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2867 = metadata !{i32 790531, metadata !2868, metadata !"to0.V", null, i32 29, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2868 = metadata !{i32 786689, metadata !957, metadata !"to0", metadata !958, i32 16777245, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2869 = metadata !{i32 29, i32 33, metadata !957, null}
!2870 = metadata !{i32 790531, metadata !2871, metadata !"to1.V", null, i32 29, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2871 = metadata !{i32 786689, metadata !957, metadata !"to1", metadata !958, i32 33554461, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2872 = metadata !{i32 29, i32 57, metadata !957, null}
!2873 = metadata !{i32 790531, metadata !2874, metadata !"from.V", null, i32 30, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2874 = metadata !{i32 786689, metadata !957, metadata !"from", metadata !958, i32 50331678, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2875 = metadata !{i32 30, i32 33, metadata !957, null}
!2876 = metadata !{i32 786689, metadata !957, metadata !"data_count", metadata !958, i32 67108894, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2877 = metadata !{i32 30, i32 48, metadata !957, null}
!2878 = metadata !{i32 32, i32 22, metadata !2879, null}
!2879 = metadata !{i32 786443, metadata !2880, i32 32, i32 3, metadata !958, i32 1} ; [ DW_TAG_lexical_block ]
!2880 = metadata !{i32 786443, metadata !957, i32 30, i32 60, metadata !958, i32 0} ; [ DW_TAG_lexical_block ]
!2881 = metadata !{i32 32, i32 46, metadata !2882, null}
!2882 = metadata !{i32 786443, metadata !2879, i32 32, i32 45, metadata !958, i32 2} ; [ DW_TAG_lexical_block ]
!2883 = metadata !{i32 33, i32 1, metadata !2882, null}
!2884 = metadata !{i32 129, i32 56, metadata !1036, metadata !2885}
!2885 = metadata !{i32 34, i32 13, metadata !2882, null}
!2886 = metadata !{i32 130, i32 22, metadata !2860, metadata !2885}
!2887 = metadata !{i32 131, i32 9, metadata !2860, metadata !2885}
!2888 = metadata !{i32 132, i32 9, metadata !2860, metadata !2885}
!2889 = metadata !{i32 786688, metadata !2882, metadata !"tmp", metadata !958, i32 34, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2890 = metadata !{i32 790531, metadata !2891, metadata !"stream<unsigned long>.V", null, i32 144, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2891 = metadata !{i32 786689, metadata !1035, metadata !"this", metadata !964, i32 16777360, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2892 = metadata !{i32 144, i32 48, metadata !1035, metadata !2893}
!2893 = metadata !{i32 35, i32 5, metadata !2882, null}
!2894 = metadata !{i32 786688, metadata !2895, metadata !"tmp", metadata !964, i32 145, metadata !140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2895 = metadata !{i32 786443, metadata !1035, i32 144, i32 79, metadata !964, i32 24} ; [ DW_TAG_lexical_block ]
!2896 = metadata !{i32 145, i32 22, metadata !2895, metadata !2893}
!2897 = metadata !{i32 145, i32 31, metadata !2895, metadata !2893}
!2898 = metadata !{i32 146, i32 9, metadata !2895, metadata !2893}
!2899 = metadata !{i32 144, i32 48, metadata !1035, metadata !2900}
!2900 = metadata !{i32 36, i32 5, metadata !2882, null}
!2901 = metadata !{i32 145, i32 22, metadata !2895, metadata !2900}
!2902 = metadata !{i32 145, i32 31, metadata !2895, metadata !2900}
!2903 = metadata !{i32 146, i32 9, metadata !2895, metadata !2900}
!2904 = metadata !{i32 37, i32 3, metadata !2882, null}
!2905 = metadata !{i32 32, i32 40, metadata !2879, null}
!2906 = metadata !{i32 786688, metadata !2879, metadata !"i", metadata !958, i32 32, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2907 = metadata !{i32 790531, metadata !2908, metadata !"to.V", null, i32 40, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2908 = metadata !{i32 786689, metadata !1015, metadata !"to", metadata !958, i32 16777256, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2909 = metadata !{i32 40, i32 30, metadata !1015, null}
!2910 = metadata !{i32 786689, metadata !1015, metadata !"from", metadata !958, i32 33554472, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2911 = metadata !{i32 40, i32 40, metadata !1015, null}
!2912 = metadata !{i32 786689, metadata !1015, metadata !"data_count", metadata !958, i32 50331688, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2913 = metadata !{i32 40, i32 55, metadata !1015, null}
!2914 = metadata !{i32 44, i32 2, metadata !2915, null}
!2915 = metadata !{i32 786443, metadata !2916, i32 42, i32 45, metadata !958, i32 5} ; [ DW_TAG_lexical_block ]
!2916 = metadata !{i32 786443, metadata !2917, i32 42, i32 3, metadata !958, i32 4} ; [ DW_TAG_lexical_block ]
!2917 = metadata !{i32 786443, metadata !1015, i32 40, i32 67, metadata !958, i32 3} ; [ DW_TAG_lexical_block ]
!2918 = metadata !{i32 42, i32 22, metadata !2916, null}
!2919 = metadata !{i32 42, i32 46, metadata !2915, null}
!2920 = metadata !{i32 43, i32 1, metadata !2915, null}
!2921 = metadata !{i32 144, i32 48, metadata !1035, metadata !2914}
!2922 = metadata !{i32 786689, metadata !1035, metadata !"din", metadata !964, i32 33554576, metadata !990, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2923 = metadata !{i32 144, i32 74, metadata !1035, metadata !2914}
!2924 = metadata !{i32 145, i32 22, metadata !2895, metadata !2914}
!2925 = metadata !{i32 145, i32 31, metadata !2895, metadata !2914}
!2926 = metadata !{i32 146, i32 9, metadata !2895, metadata !2914}
!2927 = metadata !{i32 45, i32 3, metadata !2915, null}
!2928 = metadata !{i32 42, i32 40, metadata !2916, null}
!2929 = metadata !{i32 786688, metadata !2916, metadata !"i", metadata !958, i32 42, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2930 = metadata !{i32 790531, metadata !2931, metadata !"to.V", null, i32 82, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2931 = metadata !{i32 786689, metadata !1028, metadata !"to", metadata !958, i32 16777298, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2932 = metadata !{i32 82, i32 32, metadata !1028, null}
!2933 = metadata !{i32 790531, metadata !2934, metadata !"from0.V", null, i32 82, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2934 = metadata !{i32 786689, metadata !1028, metadata !"from0", metadata !958, i32 33554514, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2935 = metadata !{i32 82, i32 55, metadata !1028, null}
!2936 = metadata !{i32 790531, metadata !2937, metadata !"from1.V", null, i32 83, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2937 = metadata !{i32 786689, metadata !1028, metadata !"from1", metadata !958, i32 50331731, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2938 = metadata !{i32 83, i32 32, metadata !1028, null}
!2939 = metadata !{i32 786689, metadata !1028, metadata !"data_count", metadata !958, i32 67108947, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2940 = metadata !{i32 83, i32 48, metadata !1028, null}
!2941 = metadata !{i32 85, i32 22, metadata !2942, null}
!2942 = metadata !{i32 786443, metadata !2943, i32 85, i32 3, metadata !958, i32 18} ; [ DW_TAG_lexical_block ]
!2943 = metadata !{i32 786443, metadata !1028, i32 83, i32 60, metadata !958, i32 17} ; [ DW_TAG_lexical_block ]
!2944 = metadata !{i32 85, i32 42, metadata !2945, null}
!2945 = metadata !{i32 786443, metadata !2942, i32 85, i32 41, metadata !958, i32 19} ; [ DW_TAG_lexical_block ]
!2946 = metadata !{i32 86, i32 1, metadata !2945, null}
!2947 = metadata !{i32 790531, metadata !2948, metadata !"stream<unsigned long>.V", null, i32 112, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2948 = metadata !{i32 786689, metadata !1034, metadata !"this", metadata !964, i32 16777328, metadata !2949, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2949 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !978} ; [ DW_TAG_pointer_type ]
!2950 = metadata !{i32 112, i32 48, metadata !1034, metadata !2951}
!2951 = metadata !{i32 87, i32 27, metadata !2945, null}
!2952 = metadata !{i32 113, i32 20, metadata !2953, metadata !2951}
!2953 = metadata !{i32 786443, metadata !1034, i32 112, i32 62, metadata !964, i32 23} ; [ DW_TAG_lexical_block ]
!2954 = metadata !{i32 786688, metadata !2953, metadata !"tmp", metadata !964, i32 113, metadata !238, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2955 = metadata !{i32 112, i32 48, metadata !1034, metadata !2956}
!2956 = metadata !{i32 87, i32 45, metadata !2945, null}
!2957 = metadata !{i32 113, i32 20, metadata !2953, metadata !2956}
!2958 = metadata !{i32 129, i32 56, metadata !1036, metadata !2959}
!2959 = metadata !{i32 88, i32 17, metadata !2960, null}
!2960 = metadata !{i32 786443, metadata !2945, i32 87, i32 62, metadata !958, i32 20} ; [ DW_TAG_lexical_block ]
!2961 = metadata !{i32 130, i32 22, metadata !2860, metadata !2959}
!2962 = metadata !{i32 131, i32 9, metadata !2860, metadata !2959}
!2963 = metadata !{i32 132, i32 9, metadata !2860, metadata !2959}
!2964 = metadata !{i32 129, i32 56, metadata !1036, metadata !2965}
!2965 = metadata !{i32 88, i32 33, metadata !2960, null}
!2966 = metadata !{i32 130, i32 22, metadata !2860, metadata !2965}
!2967 = metadata !{i32 131, i32 9, metadata !2860, metadata !2965}
!2968 = metadata !{i32 132, i32 9, metadata !2860, metadata !2965}
!2969 = metadata !{i32 144, i32 48, metadata !1035, metadata !2965}
!2970 = metadata !{i32 145, i32 22, metadata !2895, metadata !2965}
!2971 = metadata !{i32 145, i32 31, metadata !2895, metadata !2965}
!2972 = metadata !{i32 146, i32 9, metadata !2895, metadata !2965}
!2973 = metadata !{i32 89, i32 7, metadata !2960, null}
!2974 = metadata !{i32 786688, metadata !2942, metadata !"i", metadata !958, i32 85, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2975 = metadata !{i32 90, i32 5, metadata !2960, null}
!2976 = metadata !{i32 91, i32 3, metadata !2945, null}
!2977 = metadata !{i32 120, i32 1, metadata !2978, null}
!2978 = metadata !{i32 786443, metadata !1029, i32 97, i32 50, metadata !958, i32 21} ; [ DW_TAG_lexical_block ]
!2979 = metadata !{metadata !2980}
!2980 = metadata !{i32 0, i32 63, metadata !2981}
!2981 = metadata !{metadata !2982}
!2982 = metadata !{metadata !"output_ddr0", metadata !2983, metadata !"long unsigned int", i32 0, i32 63}
!2983 = metadata !{metadata !2984}
!2984 = metadata !{i32 0, i32 65535, i32 1}
!2985 = metadata !{metadata !2986}
!2986 = metadata !{i32 0, i32 63, metadata !2987}
!2987 = metadata !{metadata !2988}
!2988 = metadata !{metadata !"input_ddr0", metadata !2983, metadata !"long unsigned int", i32 0, i32 63}
!2989 = metadata !{metadata !2990}
!2990 = metadata !{i32 0, i32 31, metadata !2991}
!2991 = metadata !{metadata !2992}
!2992 = metadata !{metadata !"data_count", metadata !2993, metadata !"unsigned int", i32 0, i32 31}
!2993 = metadata !{metadata !2994}
!2994 = metadata !{i32 0, i32 0, i32 0}
!2995 = metadata !{i32 98, i32 1, metadata !2978, null}
!2996 = metadata !{i32 99, i32 1, metadata !2978, null}
!2997 = metadata !{i32 101, i32 1, metadata !2978, null}
!2998 = metadata !{i32 102, i32 1, metadata !2978, null}
!2999 = metadata !{i32 103, i32 1, metadata !2978, null}
!3000 = metadata !{i32 104, i32 1, metadata !2978, null}
!3001 = metadata !{i32 786689, metadata !1029, metadata !"output_ddr0", metadata !958, i32 16777312, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3002 = metadata !{i32 96, i32 35, metadata !1029, null}
!3003 = metadata !{i32 786689, metadata !1029, metadata !"input_ddr0", metadata !958, i32 33554528, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3004 = metadata !{i32 96, i32 54, metadata !1029, null}
!3005 = metadata !{i32 786689, metadata !1029, metadata !"data_count", metadata !958, i32 50331745, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3006 = metadata !{i32 97, i32 38, metadata !1029, null}
!3007 = metadata !{i32 790529, metadata !3008, metadata !"data_stage0.V", null, i32 106, metadata !2844, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3008 = metadata !{i32 786688, metadata !2978, metadata !"data_stage0", metadata !958, i32 106, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3009 = metadata !{i32 106, i32 20, metadata !2978, null}
!3010 = metadata !{i32 790529, metadata !3011, metadata !"data_stage1.V", null, i32 107, metadata !2844, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3011 = metadata !{i32 786688, metadata !2978, metadata !"data_stage1", metadata !958, i32 107, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3012 = metadata !{i32 107, i32 21, metadata !2978, null}
!3013 = metadata !{i32 790529, metadata !3014, metadata !"data_stage2.V", null, i32 108, metadata !2844, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3014 = metadata !{i32 786688, metadata !2978, metadata !"data_stage2", metadata !958, i32 108, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3015 = metadata !{i32 108, i32 21, metadata !2978, null}
!3016 = metadata !{i32 790529, metadata !3017, metadata !"data_stage3.V", null, i32 109, metadata !2844, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3017 = metadata !{i32 786688, metadata !2978, metadata !"data_stage3", metadata !958, i32 109, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3018 = metadata !{i32 109, i32 21, metadata !2978, null}
!3019 = metadata !{i32 790529, metadata !3020, metadata !"data_stage4.V", null, i32 110, metadata !2844, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3020 = metadata !{i32 786688, metadata !2978, metadata !"data_stage4", metadata !958, i32 110, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3021 = metadata !{i32 110, i32 21, metadata !2978, null}
!3022 = metadata !{i32 790529, metadata !3023, metadata !"data_stage5.V", null, i32 111, metadata !2844, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3023 = metadata !{i32 786688, metadata !2978, metadata !"data_stage5", metadata !958, i32 111, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3024 = metadata !{i32 111, i32 21, metadata !2978, null}
!3025 = metadata !{i32 121, i32 2, metadata !2978, null}
!3026 = metadata !{i32 122, i32 3, metadata !2978, null}
!3027 = metadata !{i32 123, i32 3, metadata !2978, null}
!3028 = metadata !{i32 124, i32 3, metadata !2978, null}
!3029 = metadata !{i32 125, i32 3, metadata !2978, null}
!3030 = metadata !{i32 126, i32 3, metadata !2978, null}
!3031 = metadata !{i32 127, i32 1, metadata !2978, null}
!3032 = metadata !{i32 790531, metadata !3033, metadata !"to.V", null, i32 69, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3033 = metadata !{i32 786689, metadata !1027, metadata !"to", metadata !958, i32 16777285, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3034 = metadata !{i32 69, i32 34, metadata !1027, null}
!3035 = metadata !{i32 790531, metadata !3036, metadata !"from.V", null, i32 69, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3036 = metadata !{i32 786689, metadata !1027, metadata !"from", metadata !958, i32 33554501, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3037 = metadata !{i32 69, i32 57, metadata !1027, null}
!3038 = metadata !{i32 786689, metadata !1027, metadata !"data_count", metadata !958, i32 50331718, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3039 = metadata !{i32 70, i32 24, metadata !1027, null}
!3040 = metadata !{i32 72, i32 22, metadata !3041, null}
!3041 = metadata !{i32 786443, metadata !3042, i32 72, i32 3, metadata !958, i32 14} ; [ DW_TAG_lexical_block ]
!3042 = metadata !{i32 786443, metadata !1027, i32 70, i32 36, metadata !958, i32 13} ; [ DW_TAG_lexical_block ]
!3043 = metadata !{i32 72, i32 42, metadata !3044, null}
!3044 = metadata !{i32 786443, metadata !3041, i32 72, i32 41, metadata !958, i32 15} ; [ DW_TAG_lexical_block ]
!3045 = metadata !{i32 73, i32 1, metadata !3044, null}
!3046 = metadata !{i32 112, i32 48, metadata !1034, metadata !3047}
!3047 = metadata !{i32 74, i32 26, metadata !3044, null}
!3048 = metadata !{i32 113, i32 20, metadata !2953, metadata !3047}
!3049 = metadata !{i32 129, i32 56, metadata !1036, metadata !3050}
!3050 = metadata !{i32 75, i32 18, metadata !3051, null}
!3051 = metadata !{i32 786443, metadata !3044, i32 74, i32 41, metadata !958, i32 16} ; [ DW_TAG_lexical_block ]
!3052 = metadata !{i32 130, i32 22, metadata !2860, metadata !3050}
!3053 = metadata !{i32 131, i32 9, metadata !2860, metadata !3050}
!3054 = metadata !{i32 132, i32 9, metadata !2860, metadata !3050}
!3055 = metadata !{i32 786688, metadata !3051, metadata !"tmp", metadata !958, i32 75, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3056 = metadata !{i32 76, i32 7, metadata !3051, null}
!3057 = metadata !{i32 144, i32 48, metadata !1035, metadata !3056}
!3058 = metadata !{i32 145, i32 22, metadata !2895, metadata !3056}
!3059 = metadata !{i32 145, i32 31, metadata !2895, metadata !3056}
!3060 = metadata !{i32 146, i32 9, metadata !2895, metadata !3056}
!3061 = metadata !{i32 77, i32 7, metadata !3051, null}
!3062 = metadata !{i32 786688, metadata !3041, metadata !"i", metadata !958, i32 72, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3063 = metadata !{i32 78, i32 5, metadata !3051, null}
!3064 = metadata !{i32 79, i32 3, metadata !3044, null}
!3065 = metadata !{i32 790531, metadata !3066, metadata !"to.V", null, i32 56, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3066 = metadata !{i32 786689, metadata !1024, metadata !"to", metadata !958, i32 16777272, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3067 = metadata !{i32 56, i32 34, metadata !1024, null}
!3068 = metadata !{i32 790531, metadata !3069, metadata !"from.V", null, i32 56, metadata !2843, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3069 = metadata !{i32 786689, metadata !1024, metadata !"from", metadata !958, i32 33554488, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3070 = metadata !{i32 56, i32 57, metadata !1024, null}
!3071 = metadata !{i32 786689, metadata !1024, metadata !"data_count", metadata !958, i32 50331705, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3072 = metadata !{i32 57, i32 24, metadata !1024, null}
!3073 = metadata !{i32 59, i32 22, metadata !3074, null}
!3074 = metadata !{i32 786443, metadata !3075, i32 59, i32 3, metadata !958, i32 10} ; [ DW_TAG_lexical_block ]
!3075 = metadata !{i32 786443, metadata !1024, i32 57, i32 36, metadata !958, i32 9} ; [ DW_TAG_lexical_block ]
!3076 = metadata !{i32 59, i32 42, metadata !3077, null}
!3077 = metadata !{i32 786443, metadata !3074, i32 59, i32 41, metadata !958, i32 11} ; [ DW_TAG_lexical_block ]
!3078 = metadata !{i32 60, i32 1, metadata !3077, null}
!3079 = metadata !{i32 112, i32 48, metadata !1034, metadata !3080}
!3080 = metadata !{i32 61, i32 26, metadata !3077, null}
!3081 = metadata !{i32 113, i32 20, metadata !2953, metadata !3080}
!3082 = metadata !{i32 129, i32 56, metadata !1036, metadata !3083}
!3083 = metadata !{i32 62, i32 18, metadata !3084, null}
!3084 = metadata !{i32 786443, metadata !3077, i32 61, i32 41, metadata !958, i32 12} ; [ DW_TAG_lexical_block ]
!3085 = metadata !{i32 130, i32 22, metadata !2860, metadata !3083}
!3086 = metadata !{i32 131, i32 9, metadata !2860, metadata !3083}
!3087 = metadata !{i32 132, i32 9, metadata !2860, metadata !3083}
!3088 = metadata !{i32 786688, metadata !3084, metadata !"tmp", metadata !958, i32 62, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3089 = metadata !{i32 63, i32 7, metadata !3084, null}
!3090 = metadata !{i32 144, i32 48, metadata !1035, metadata !3089}
!3091 = metadata !{i32 145, i32 22, metadata !2895, metadata !3089}
!3092 = metadata !{i32 145, i32 31, metadata !2895, metadata !3089}
!3093 = metadata !{i32 146, i32 9, metadata !2895, metadata !3089}
!3094 = metadata !{i32 64, i32 7, metadata !3084, null}
!3095 = metadata !{i32 786688, metadata !3074, metadata !"i", metadata !958, i32 59, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3096 = metadata !{i32 65, i32 5, metadata !3084, null}
!3097 = metadata !{i32 66, i32 3, metadata !3077, null}
