; ModuleID = '/rsgs/pool0/esingh/aqed4saranyu/results/dataflow/dataflow-stalls_ab/tmp/deadlock/2017.1/adm-pcie-7v3/_xocc_compile_dataflow_stalls_kernel_dataflow_stalls-hw.dir/impl/kernels/dataflow_stalls_kernel/dataflow_stalls_kernel/solution_OCL_REGION_0/.autopilot/db/a.g.1.bc'
...
define internal fastcc void @store(i64* %to, %"class.std::locale::id.1"* %from, i32 %data_count) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i64* %to}, i64 0, metadata !2832), !dbg !2833 ; [debug line = 48:18] [debug variable = to]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from}, i64 0, metadata !2834), !dbg !2835 ; [debug line = 48:41] [debug variable = from]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !2836), !dbg !2837 ; [debug line = 48:56] [debug variable = data_count]
  %from.addr = getelementptr inbounds %"class.std::locale::id.1"* %from, i64 0, i32 0, !dbg !2838 ; [#uses=1 type=i64*] [debug line = 131:9@52:10]
  br label %1, !dbg !2844                         ; [debug line = 50:22]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i, %data_count, !dbg !2844 ; [#uses=1 type=i1] [debug line = 50:22]
  br i1 %exitcond, label %4, label %2, !dbg !2844 ; [debug line = 50:22]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !2845 ; [debug line = 50:46]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !2845 ; [#uses=1 type=i32] [debug line = 50:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2846 ; [debug line = 51:1]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from}, i64 0, metadata !2847), !dbg !2848 ; [debug line = 129:56@52:10] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2849) nounwind, !dbg !2850 ; [debug line = 130:22@52:10] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from.addr, i64* %tmp) nounwind, !dbg !2838 ; [debug line = 131:9@52:10]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2851 ; [debug line = 132:9@52:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2851 ; [debug line = 132:9@52:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2851 ; [debug line = 132:9@52:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2851 ; [debug line = 132:9@52:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2851 ; [debug line = 132:9@52:10] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2851 ; [debug line = 132:9@52:10] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2851 ; [debug line = 132:9@52:10] [debug variable = tmp]
  %3 = load i64* %tmp, align 8, !dbg !2851        ; [#uses=1 type=i64] [debug line = 132:9@52:10]
  %tmp.1 = zext i32 %i to i64, !dbg !2840         ; [#uses=1 type=i64] [debug line = 52:10]
  %to.addr = getelementptr inbounds i64* %to, i64 %tmp.1, !dbg !2840 ; [#uses=1 type=i64*] [debug line = 52:10]
  store i64 %3, i64* %to.addr, align 8, !dbg !2840 ; [debug line = 52:10]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2852 ; [#uses=0 type=i32] [debug line = 53:3]
  %i.1 = add i32 %i, 1, !dbg !2853                ; [#uses=1 type=i32] [debug line = 50:40]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !2854), !dbg !2853 ; [debug line = 50:40] [debug variable = i]
  br label %1, !dbg !2853                         ; [debug line = 50:40]

; <label>:4                                       ; preds = %1
  ret void, !dbg !2855                            ; [debug line = 54:1]
}
...
define internal fastcc void @scatter(%"class.std::locale::id.1"* %to0, %"class.std::locale::id.1"* %to1, %"class.std::locale::id.1"* %from, i32 %data_count) nounwind uwtable {
  ...
  %tmp = alloca i64, align 8                      ; [#uses=2 type=i64*]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to0}, i64 0, metadata !2856), !dbg !2857 ; [debug line = 29:33] [debug variable = to0]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to1}, i64 0, metadata !2858), !dbg !2859 ; [debug line = 29:57] [debug variable = to1]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from}, i64 0, metadata !2860), !dbg !2861 ; [debug line = 30:33] [debug variable = from]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !2862), !dbg !2863 ; [debug line = 30:48] [debug variable = data_count]
  %from.addr = getelementptr inbounds %"class.std::locale::id.1"* %from, i64 0, i32 0, !dbg !2864 ; [#uses=1 type=i64*] [debug line = 131:9@34:13]
  %to0.addr = getelementptr inbounds %"class.std::locale::id.1"* %to0, i64 0, i32 0, !dbg !2869 ; [#uses=1 type=i64*] [debug line = 146:9@35:5]
  %to1.addr = getelementptr inbounds %"class.std::locale::id.1"* %to1, i64 0, i32 0, !dbg !2872 ; [#uses=1 type=i64*] [debug line = 146:9@36:5]
  br label %1, !dbg !2874                         ; [debug line = 32:22]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.2, %2 ]            ; [#uses=2 type=i32]
  %exitcond = icmp eq i32 %i, %data_count, !dbg !2874 ; [#uses=1 type=i1] [debug line = 32:22]
  br i1 %exitcond, label %3, label %2, !dbg !2874 ; [debug line = 32:22]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([14 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2875 ; [debug line = 32:46]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([14 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2875 ; [#uses=1 type=i32] [debug line = 32:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2876 ; [debug line = 33:1]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from}, i64 0, metadata !2847), !dbg !2877 ; [debug line = 129:56@34:13] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2849) nounwind, !dbg !2878 ; [debug line = 130:22@34:13] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from.addr, i64* %tmp) nounwind, !dbg !2864 ; [debug line = 131:9@34:13]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2879 ; [debug line = 132:9@34:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2879 ; [debug line = 132:9@34:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2879 ; [debug line = 132:9@34:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2879 ; [debug line = 132:9@34:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2879 ; [debug line = 132:9@34:13] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2879 ; [debug line = 132:9@34:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2879 ; [debug line = 132:9@34:13] [debug variable = tmp]
  %tmp.3 = load i64* %tmp, align 8, !dbg !2879    ; [#uses=2 type=i64] [debug line = 132:9@34:13]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2880), !dbg !2865 ; [debug line = 34:13] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to0}, i64 0, metadata !2881), !dbg !2882 ; [debug line = 144:48@35:5] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.4}, metadata !2883) nounwind, !dbg !2884 ; [debug line = 145:22@35:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2885 ; [debug line = 145:31@35:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2885 ; [debug line = 145:31@35:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2885 ; [debug line = 145:31@35:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2885 ; [debug line = 145:31@35:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2885 ; [debug line = 145:31@35:5] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2885 ; [debug line = 145:31@35:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2885 ; [debug line = 145:31@35:5] [debug variable = tmp]
  store i64 %tmp.3, i64* %tmp.4, align 8, !dbg !2885 ; [debug line = 145:31@35:5]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to0.addr, i64* %tmp.4) nounwind, !dbg !2869 ; [debug line = 146:9@35:5]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to1}, i64 0, metadata !2881), !dbg !2886 ; [debug line = 144:48@36:5] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.5}, metadata !2883) nounwind, !dbg !2887 ; [debug line = 145:22@36:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2888 ; [debug line = 145:31@36:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2888 ; [debug line = 145:31@36:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2888 ; [debug line = 145:31@36:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2888 ; [debug line = 145:31@36:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2888 ; [debug line = 145:31@36:5] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2888 ; [debug line = 145:31@36:5] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.3}, i64 0, metadata !2883), !dbg !2888 ; [debug line = 145:31@36:5] [debug variable = tmp]
  store i64 %tmp.3, i64* %tmp.5, align 8, !dbg !2888 ; [debug line = 145:31@36:5]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to1.addr, i64* %tmp.5) nounwind, !dbg !2872 ; [debug line = 146:9@36:5]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([14 x i8]* @.str, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2889 ; [#uses=0 type=i32] [debug line = 37:3]
  %i.2 = add i32 %i, 1, !dbg !2890                ; [#uses=1 type=i32] [debug line = 32:40]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !2891), !dbg !2890 ; [debug line = 32:40] [debug variable = i]
  br label %1, !dbg !2890                         ; [debug line = 32:40]

; <label>:3                                       ; preds = %1
  ret void, !dbg !2892                            ; [debug line = 38:1]
}
...
define internal fastcc void @load(%"class.std::locale::id.1"* %to, i64* %from, i32 %data_count) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to}, i64 0, metadata !2893), !dbg !2894 ; [debug line = 40:30] [debug variable = to]
  call void @llvm.dbg.value(metadata !{i64* %from}, i64 0, metadata !2895), !dbg !2896 ; [debug line = 40:40] [debug variable = from]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !2897), !dbg !2898 ; [debug line = 40:55] [debug variable = data_count]
  %to.addr = getelementptr inbounds %"class.std::locale::id.1"* %to, i64 0, i32 0, !dbg !2899 ; [#uses=1 type=i64*] [debug line = 146:9@44:2]
  br label %1, !dbg !2904                         ; [debug line = 42:22]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.3, %2 ]            ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i, %data_count, !dbg !2904 ; [#uses=1 type=i1] [debug line = 42:22]
  br i1 %exitcond, label %3, label %2, !dbg !2904 ; [debug line = 42:22]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !2905 ; [debug line = 42:46]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !2905 ; [#uses=1 type=i32] [debug line = 42:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2906 ; [debug line = 43:1]
  %tmp = zext i32 %i to i64, !dbg !2900           ; [#uses=1 type=i64] [debug line = 44:2]
  %din.assign = getelementptr inbounds i64* %from, i64 %tmp, !dbg !2900 ; [#uses=1 type=i64*] [debug line = 44:2]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to}, i64 0, metadata !2881), !dbg !2907 ; [debug line = 144:48@44:2] [debug variable = this]
  call void @llvm.dbg.value(metadata !{i64* %din.assign}, i64 0, metadata !2908), !dbg !2909 ; [debug line = 144:74@44:2] [debug variable = din]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.7}, metadata !2883) nounwind, !dbg !2910 ; [debug line = 145:22@44:2] [debug variable = tmp]
  %tmp.8 = load i64* %din.assign, align 8, !dbg !2911 ; [#uses=2 type=i64] [debug line = 145:31@44:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %tmp.8) nounwind
  call void @llvm.dbg.value(metadata !{i64 %tmp.8}, i64 0, metadata !2883), !dbg !2911 ; [debug line = 145:31@44:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.8}, i64 0, metadata !2883), !dbg !2911 ; [debug line = 145:31@44:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.8}, i64 0, metadata !2883), !dbg !2911 ; [debug line = 145:31@44:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.8}, i64 0, metadata !2883), !dbg !2911 ; [debug line = 145:31@44:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.8}, i64 0, metadata !2883), !dbg !2911 ; [debug line = 145:31@44:2] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64 %tmp.8}, i64 0, metadata !2883), !dbg !2911 ; [debug line = 145:31@44:2] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.8}, i64 0, metadata !2883), !dbg !2911 ; [debug line = 145:31@44:2] [debug variable = tmp]
  store i64 %tmp.8, i64* %tmp.7, align 8, !dbg !2911 ; [debug line = 145:31@44:2]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to.addr, i64* %tmp.7) nounwind, !dbg !2899 ; [debug line = 146:9@44:2]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2912 ; [#uses=0 type=i32] [debug line = 45:3]
  %i.3 = add i32 %i, 1, !dbg !2913                ; [#uses=1 type=i32] [debug line = 42:40]
  call void @llvm.dbg.value(metadata !{i32 %i.3}, i64 0, metadata !2914), !dbg !2913 ; [debug line = 42:40] [debug variable = i]
  br label %1, !dbg !2913                         ; [debug line = 42:40]

; <label>:3                                       ; preds = %1
  ret void, !dbg !2915                            ; [debug line = 46:1]
}
...
define internal fastcc void @gather(%"class.std::locale::id.1"* %to, %"class.std::locale::id.1"* %from0, %"class.std::locale::id.1"* %from1, i32 %data_count) nounwind uwtable {
  %tmp.11 = alloca i64, align 8                   ; [#uses=2 type=i64*]
  %tmp.10 = alloca i64, align 8                   ; [#uses=2 type=i64*]
  %tmp = alloca i64, align 8                      ; [#uses=2 type=i64*]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to}, i64 0, metadata !2916), !dbg !2917 ; [debug line = 82:32] [debug variable = to]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from0}, i64 0, metadata !2918), !dbg !2919 ; [debug line = 82:55] [debug variable = from0]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from1}, i64 0, metadata !2920), !dbg !2921 ; [debug line = 83:32] [debug variable = from1]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !2922), !dbg !2923 ; [debug line = 83:48] [debug variable = data_count]
  %from0.addr = getelementptr inbounds %"class.std::locale::id.1"* %from0, i64 0, i32 0, !dbg !2924 ; [#uses=1 type=i64*] [debug line = 131:9@88:17]
  %from1.addr = getelementptr inbounds %"class.std::locale::id.1"* %from1, i64 0, i32 0, !dbg !2930 ; [#uses=1 type=i64*] [debug line = 131:9@88:33]
  %to.addr = getelementptr inbounds %"class.std::locale::id.1"* %to, i64 0, i32 0, !dbg !2932 ; [#uses=1 type=i64*] [debug line = 146:9@88:33]
  br label %1, !dbg !2933                         ; [debug line = 85:22]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.4, %2 ]            ; [#uses=2 type=i32]
  %exitcond = icmp eq i32 %i, %data_count, !dbg !2933 ; [#uses=1 type=i1] [debug line = 85:22]
  br i1 %exitcond, label %4, label %2, !dbg !2933 ; [debug line = 85:22]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !2934 ; [debug line = 85:42]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !2934 ; [#uses=1 type=i32] [debug line = 85:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2935 ; [debug line = 86:1]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from0}, i64 0, metadata !2847), !dbg !2936 ; [debug line = 129:56@88:17] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2849) nounwind, !dbg !2937 ; [debug line = 130:22@88:17] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from0.addr, i64* %tmp) nounwind, !dbg !2924 ; [debug line = 131:9@88:17]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2938 ; [debug line = 132:9@88:17] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2938 ; [debug line = 132:9@88:17] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2938 ; [debug line = 132:9@88:17] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2938 ; [debug line = 132:9@88:17] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2938 ; [debug line = 132:9@88:17] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2938 ; [debug line = 132:9@88:17] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !2938 ; [debug line = 132:9@88:17] [debug variable = tmp]
  %3 = load i64* %tmp, align 8, !dbg !2938        ; [#uses=1 type=i64] [debug line = 132:9@88:17]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from1}, i64 0, metadata !2847), !dbg !2939 ; [debug line = 129:56@88:33] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.10}, metadata !2849) nounwind, !dbg !2940 ; [debug line = 130:22@88:33] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from1.addr, i64* %tmp.10) nounwind, !dbg !2930 ; [debug line = 131:9@88:33]
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2849), !dbg !2941 ; [debug line = 132:9@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2849), !dbg !2941 ; [debug line = 132:9@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2849), !dbg !2941 ; [debug line = 132:9@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2849), !dbg !2941 ; [debug line = 132:9@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2849), !dbg !2941 ; [debug line = 132:9@88:33] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2849), !dbg !2941 ; [debug line = 132:9@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp.10}, i64 0, metadata !2849), !dbg !2941 ; [debug line = 132:9@88:33] [debug variable = tmp]
  %tmp.10.load = load i64* %tmp.10, align 8, !dbg !2941 ; [#uses=1 type=i64] [debug line = 132:9@88:33]
  %tmp.12 = sub i64 %3, %tmp.10.load, !dbg !2931  ; [#uses=1 type=i64] [debug line = 88:33]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to}, i64 0, metadata !2881), !dbg !2942 ; [debug line = 144:48@88:33] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.11}, metadata !2883) nounwind, !dbg !2943 ; [debug line = 145:22@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.12}, i64 0, metadata !2883), !dbg !2944 ; [debug line = 145:31@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.12}, i64 0, metadata !2883), !dbg !2944 ; [debug line = 145:31@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.12}, i64 0, metadata !2883), !dbg !2944 ; [debug line = 145:31@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.12}, i64 0, metadata !2883), !dbg !2944 ; [debug line = 145:31@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.12}, i64 0, metadata !2883), !dbg !2944 ; [debug line = 145:31@88:33] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64 %tmp.12}, i64 0, metadata !2883), !dbg !2944 ; [debug line = 145:31@88:33] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.12}, i64 0, metadata !2883), !dbg !2944 ; [debug line = 145:31@88:33] [debug variable = tmp]
  store i64 %tmp.12, i64* %tmp.11, align 8, !dbg !2944 ; [debug line = 145:31@88:33]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to.addr, i64* %tmp.11) nounwind, !dbg !2932 ; [debug line = 146:9@88:33]
  %i.4 = add i32 %i, 1, !dbg !2945                ; [#uses=1 type=i32] [debug line = 89:7]
  call void @llvm.dbg.value(metadata !{i32 %i.4}, i64 0, metadata !2946), !dbg !2945 ; [debug line = 89:7] [debug variable = i]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2947 ; [#uses=0 type=i32] [debug line = 91:3]
  br label %1, !dbg !2947                         ; [debug line = 91:3]

; <label>:4                                       ; preds = %1
  ret void, !dbg !2948                            ; [debug line = 92:1]
}
...
define void @dataflow_stalls_kernel(i64* %output_ddr0, i64* %input_ddr0, i32 %data_count) nounwind uwtable {
  ...
  %data_stage3 = alloca %"class.std::locale::id.1", align 8 ; [#uses=2 type=%"class.std::locale::id.1"*]
  ...
  call void @llvm.dbg.value(metadata !{i64* %output_ddr0}, i64 0, metadata !2949), !dbg !2950 ; [debug line = 96:35] [debug variable = output_ddr0]
  call void @llvm.dbg.value(metadata !{i64* %input_ddr0}, i64 0, metadata !2951), !dbg !2952 ; [debug line = 96:54] [debug variable = input_ddr0]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !2953), !dbg !2954 ; [debug line = 97:38] [debug variable = data_count]
  call void (...)* @_ssdm_op_SpecInterface(i64* %output_ddr0, i8* getelementptr inbounds ([6 x i8]* @.str7, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 65536, i8* getelementptr inbounds ([6 x i8]* @.str8, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str9, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2955 ; [debug line = 98:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %input_ddr0, i8* getelementptr inbounds ([6 x i8]* @.str7, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 65536, i8* getelementptr inbounds ([6 x i8]* @.str10, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str9, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2957 ; [debug line = 99:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %output_ddr0, i8* getelementptr inbounds ([10 x i8]* @.str11, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2958 ; [debug line = 101:1]
  call void (...)* @_ssdm_op_SpecInterface(i64* %input_ddr0, i8* getelementptr inbounds ([10 x i8]* @.str11, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2959 ; [debug line = 102:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %data_count, i8* getelementptr inbounds ([10 x i8]* @.str11, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2960 ; [debug line = 103:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str11, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2961 ; [debug line = 104:1]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id.1"* %data_stage0}, metadata !2962), !dbg !2963 ; [debug line = 106:20] [debug variable = data_stage0]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage0}, i64 0, metadata !2964), !dbg !2965 ; [debug line = 86:43@106:46] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage0}, i64 0, metadata !2967), !dbg !2968 ; [debug line = 86:43@87:5@106:46] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id.1"* %data_stage1}, metadata !2970), !dbg !2971 ; [debug line = 107:21] [debug variable = data_stage1]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage1}, i64 0, metadata !2964), !dbg !2972 ; [debug line = 86:43@107:47] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage1}, i64 0, metadata !2967), !dbg !2974 ; [debug line = 86:43@87:5@107:47] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id.1"* %data_stage2}, metadata !2976), !dbg !2977 ; [debug line = 108:21] [debug variable = data_stage2]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage2}, i64 0, metadata !2964), !dbg !2978 ; [debug line = 86:43@108:47] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage2}, i64 0, metadata !2967), !dbg !2980 ; [debug line = 86:43@87:5@108:47] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id.1"* %data_stage3}, metadata !2982), !dbg !2983 ; [debug line = 109:21] [debug variable = data_stage3]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage3}, i64 0, metadata !2964), !dbg !2984 ; [debug line = 86:43@109:47] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage3}, i64 0, metadata !2967), !dbg !2986 ; [debug line = 86:43@87:5@109:47] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id.1"* %data_stage4}, metadata !2988), !dbg !2989 ; [debug line = 110:21] [debug variable = data_stage4]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage4}, i64 0, metadata !2964), !dbg !2990 ; [debug line = 86:43@110:47] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage4}, i64 0, metadata !2967), !dbg !2992 ; [debug line = 86:43@87:5@110:47] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%"class.std::locale::id.1"* %data_stage5}, metadata !2994), !dbg !2995 ; [debug line = 111:21] [debug variable = data_stage5]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage5}, i64 0, metadata !2964), !dbg !2996 ; [debug line = 86:43@111:47] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %data_stage5}, i64 0, metadata !2967), !dbg !2998 ; [debug line = 86:43@87:5@111:47] [debug variable = this]
  call void (...)* @_ssdm_SpecStream(%"class.std::locale::id.1"* %data_stage0, i32 0, i32 10, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3000 ; [debug line = 113:1]
  call void (...)* @_ssdm_SpecStream(%"class.std::locale::id.1"* %data_stage5, i32 0, i32 10, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3001 ; [debug line = 114:1]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3002 ; [debug line = 120:1]
  call fastcc void @load(%"class.std::locale::id.1"* %data_stage0, i64* %input_ddr0, i32 %data_count), !dbg !3003 ; [debug line = 121:2]
  call fastcc void @scatter(%"class.std::locale::id.1"* %data_stage1, %"class.std::locale::id.1"* %data_stage2, %"class.std::locale::id.1"* %data_stage0, i32 %data_count), !dbg !3004 ; [debug line = 122:3]
  call fastcc void @compute1(%"class.std::locale::id.1"* %data_stage3, %"class.std::locale::id.1"* %data_stage1, i32 %data_count), !dbg !3005 ; [debug line = 123:3]
  call fastcc void @compute2(%"class.std::locale::id.1"* %data_stage4, %"class.std::locale::id.1"* %data_stage2, i32 %data_count), !dbg !3006 ; [debug line = 124:3]
  call fastcc void @gather(%"class.std::locale::id.1"* %data_stage5, %"class.std::locale::id.1"* %data_stage3, %"class.std::locale::id.1"* %data_stage4, i32 %data_count), !dbg !3007 ; [debug line = 125:3]
  call fastcc void @store(i64* %output_ddr0, %"class.std::locale::id.1"* %data_stage5, i32 %data_count), !dbg !3008 ; [debug line = 126:3]
  ret void, !dbg !3009                            ; [debug line = 127:1]
}

; [#uses=1]
define internal fastcc void @compute2(%"class.std::locale::id.1"* %to, %"class.std::locale::id.1"* %from, i32 %data_count) nounwind uwtable {
  %tmp.15 = alloca i64, align 8                   ; [#uses=2 type=i64*]
  %tmp = alloca i64, align 8                      ; [#uses=2 type=i64*]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to}, i64 0, metadata !3010), !dbg !3011 ; [debug line = 69:34] [debug variable = to]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from}, i64 0, metadata !3012), !dbg !3013 ; [debug line = 69:57] [debug variable = from]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !3014), !dbg !3015 ; [debug line = 70:24] [debug variable = data_count]
  %from.addr = getelementptr inbounds %"class.std::locale::id.1"* %from, i64 0, i32 0, !dbg !3016 ; [#uses=1 type=i64*] [debug line = 131:9@75:18]
  %to.addr = getelementptr inbounds %"class.std::locale::id.1"* %to, i64 0, i32 0, !dbg !3022 ; [#uses=1 type=i64*] [debug line = 146:9@76:7]
  br label %1, !dbg !3024                         ; [debug line = 72:22]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.5, %2 ]            ; [#uses=2 type=i32]
  %exitcond = icmp eq i32 %i, %data_count, !dbg !3024 ; [#uses=1 type=i1] [debug line = 72:22]
  br i1 %exitcond, label %3, label %2, !dbg !3024 ; [debug line = 72:22]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !3025 ; [debug line = 72:42]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !3025 ; [#uses=1 type=i32] [debug line = 72:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3026 ; [debug line = 73:1]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from}, i64 0, metadata !2847), !dbg !3027 ; [debug line = 129:56@75:18] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2849) nounwind, !dbg !3028 ; [debug line = 130:22@75:18] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from.addr, i64* %tmp) nounwind, !dbg !3016 ; [debug line = 131:9@75:18]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3029 ; [debug line = 132:9@75:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3029 ; [debug line = 132:9@75:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3029 ; [debug line = 132:9@75:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3029 ; [debug line = 132:9@75:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3029 ; [debug line = 132:9@75:18] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3029 ; [debug line = 132:9@75:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3029 ; [debug line = 132:9@75:18] [debug variable = tmp]
  %tmp.14 = load i64* %tmp, align 8, !dbg !3029   ; [#uses=2 type=i64] [debug line = 132:9@75:18]
  call void @llvm.dbg.value(metadata !{i64 %tmp.14}, i64 0, metadata !3030), !dbg !3017 ; [debug line = 75:18] [debug variable = tmp]
  %tmp.16 = mul i64 %tmp.14, %tmp.14, !dbg !3023  ; [#uses=1 type=i64] [debug line = 76:7]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to}, i64 0, metadata !2881), !dbg !3031 ; [debug line = 144:48@76:7] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.15}, metadata !2883) nounwind, !dbg !3032 ; [debug line = 145:22@76:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.16}, i64 0, metadata !2883), !dbg !3033 ; [debug line = 145:31@76:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.16}, i64 0, metadata !2883), !dbg !3033 ; [debug line = 145:31@76:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.16}, i64 0, metadata !2883), !dbg !3033 ; [debug line = 145:31@76:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.16}, i64 0, metadata !2883), !dbg !3033 ; [debug line = 145:31@76:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.16}, i64 0, metadata !2883), !dbg !3033 ; [debug line = 145:31@76:7] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64 %tmp.16}, i64 0, metadata !2883), !dbg !3033 ; [debug line = 145:31@76:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.16}, i64 0, metadata !2883), !dbg !3033 ; [debug line = 145:31@76:7] [debug variable = tmp]
  store i64 %tmp.16, i64* %tmp.15, align 8, !dbg !3033 ; [debug line = 145:31@76:7]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to.addr, i64* %tmp.15) nounwind, !dbg !3022 ; [debug line = 146:9@76:7]
  %i.5 = add i32 %i, 1, !dbg !3034                ; [#uses=1 type=i32] [debug line = 77:7]
  call void @llvm.dbg.value(metadata !{i32 %i.5}, i64 0, metadata !3035), !dbg !3034 ; [debug line = 77:7] [debug variable = i]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str5, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3036 ; [#uses=0 type=i32] [debug line = 79:3]
  br label %1, !dbg !3036                         ; [debug line = 79:3]

; <label>:3                                       ; preds = %1
  ret void, !dbg !3037                            ; [debug line = 80:1]
}

; [#uses=1]
define internal fastcc void @compute1(%"class.std::locale::id.1"* %to, %"class.std::locale::id.1"* %from, i32 %data_count) nounwind uwtable {
  %tmp.19 = alloca i64, align 8                   ; [#uses=2 type=i64*]
  %tmp = alloca i64, align 8                      ; [#uses=2 type=i64*]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to}, i64 0, metadata !3038), !dbg !3039 ; [debug line = 56:34] [debug variable = to]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from}, i64 0, metadata !3040), !dbg !3041 ; [debug line = 56:57] [debug variable = from]
  call void @llvm.dbg.value(metadata !{i32 %data_count}, i64 0, metadata !3042), !dbg !3043 ; [debug line = 57:24] [debug variable = data_count]
  %from.addr = getelementptr inbounds %"class.std::locale::id.1"* %from, i64 0, i32 0, !dbg !3044 ; [#uses=1 type=i64*] [debug line = 131:9@62:18]
  %to.addr = getelementptr inbounds %"class.std::locale::id.1"* %to, i64 0, i32 0, !dbg !3050 ; [#uses=1 type=i64*] [debug line = 146:9@63:7]
  br label %1, !dbg !3052                         ; [debug line = 59:22]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.6, %2 ]            ; [#uses=2 type=i32]
  %exitcond = icmp eq i32 %i, %data_count, !dbg !3052 ; [#uses=1 type=i1] [debug line = 59:22]
  br i1 %exitcond, label %3, label %2, !dbg !3052 ; [debug line = 59:22]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !3053 ; [debug line = 59:42]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !3053 ; [#uses=1 type=i32] [debug line = 59:42]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3054 ; [debug line = 60:1]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %from}, i64 0, metadata !2847), !dbg !3055 ; [debug line = 129:56@62:18] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp}, metadata !2849) nounwind, !dbg !3056 ; [debug line = 130:22@62:18] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i64P.i64P(i64* %from.addr, i64* %tmp) nounwind, !dbg !3044 ; [debug line = 131:9@62:18]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3057 ; [debug line = 132:9@62:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3057 ; [debug line = 132:9@62:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3057 ; [debug line = 132:9@62:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3057 ; [debug line = 132:9@62:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3057 ; [debug line = 132:9@62:18] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3057 ; [debug line = 132:9@62:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64* %tmp}, i64 0, metadata !2849), !dbg !3057 ; [debug line = 132:9@62:18] [debug variable = tmp]
  %tmp.18 = load i64* %tmp, align 8, !dbg !3057   ; [#uses=1 type=i64] [debug line = 132:9@62:18]
  call void @llvm.dbg.value(metadata !{i64 %tmp.18}, i64 0, metadata !3058), !dbg !3045 ; [debug line = 62:18] [debug variable = tmp]
  %tmp.20 = shl i64 %tmp.18, 1, !dbg !3051        ; [#uses=1 type=i64] [debug line = 63:7]
  call void @llvm.dbg.value(metadata !{%"class.std::locale::id.1"* %to}, i64 0, metadata !2881), !dbg !3059 ; [debug line = 144:48@63:7] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i64* %tmp.19}, metadata !2883) nounwind, !dbg !3060 ; [debug line = 145:22@63:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.20}, i64 0, metadata !2883), !dbg !3061 ; [debug line = 145:31@63:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.20}, i64 0, metadata !2883), !dbg !3061 ; [debug line = 145:31@63:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.20}, i64 0, metadata !2883), !dbg !3061 ; [debug line = 145:31@63:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.20}, i64 0, metadata !2883), !dbg !3061 ; [debug line = 145:31@63:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.20}, i64 0, metadata !2883), !dbg !3061 ; [debug line = 145:31@63:7] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i64 %tmp.20}, i64 0, metadata !2883), !dbg !3061 ; [debug line = 145:31@63:7] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i64 %tmp.20}, i64 0, metadata !2883), !dbg !3061 ; [debug line = 145:31@63:7] [debug variable = tmp]
  store i64 %tmp.20, i64* %tmp.19, align 8, !dbg !3061 ; [debug line = 145:31@63:7]
  call void @_ssdm_op_IfWrite.Stream.i64P.i64P(i64* %to.addr, i64* %tmp.19) nounwind, !dbg !3050 ; [debug line = 146:9@63:7]
  %i.6 = add i32 %i, 1, !dbg !3062                ; [#uses=1 type=i32] [debug line = 64:7]
  call void @llvm.dbg.value(metadata !{i32 %i.6}, i64 0, metadata !3063), !dbg !3062 ; [debug line = 64:7] [debug variable = i]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str4, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3064 ; [#uses=0 type=i32] [debug line = 66:3]
  br label %1, !dbg !3064                         ; [debug line = 66:3]

; <label>:3                                       ; preds = %1
  ret void, !dbg !3065                            ; [debug line = 67:1]
}
...
!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!2792, !2799, !2805, !2807, !2809, !2810, !2812, !2815, !2815, !2821, !2826, !2826, !2826}
!hls.encrypted.func = !{}
...
!2792 = metadata !{void (%"class.std::locale::id.1"*, %"class.std::locale::id.1"*, %"class.std::locale::id.1"*, i32)* @scatter, metadata !2793, metadata !2794, metadata !2795, metadata !2796, metadata !2797, metadata !2798}
...
!2799 = metadata !{void (%"class.std::locale::id.1"*, i64*, i32)* @load, metadata !2800, metadata !2801, metadata !2802, metadata !2803, metadata !2804, metadata !2798}
...
!2805 = metadata !{void (i64*, %"class.std::locale::id.1"*, i32)* @store, metadata !2800, metadata !2801, metadata !2806, metadata !2803, metadata !2804, metadata !2798}
!2806 = metadata !{metadata !"kernel_arg_type", metadata !"Data*", metadata !"hls::stream<Data>*", metadata !"uint32_t"}
!2807 = metadata !{void (%"class.std::locale::id.1"*, %"class.std::locale::id.1"*, i32)* @compute1, metadata !2800, metadata !2801, metadata !2808, metadata !2803, metadata !2804, metadata !2798}
!2808 = metadata !{metadata !"kernel_arg_type", metadata !"hls::stream<Data>*", metadata !"hls::stream<Data>*", metadata !"uint32_t"}
!2809 = metadata !{void (%"class.std::locale::id.1"*, %"class.std::locale::id.1"*, i32)* @compute2, metadata !2800, metadata !2801, metadata !2808, metadata !2803, metadata !2804, metadata !2798}
!2810 = metadata !{void (%"class.std::locale::id.1"*, %"class.std::locale::id.1"*, %"class.std::locale::id.1"*, i32)* @gather, metadata !2793, metadata !2794, metadata !2795, metadata !2796, metadata !2811, metadata !2798}
...
!2815 = metadata !{null, metadata !2816, metadata !2817, metadata !2818, metadata !2819, metadata !2820, metadata !2798}
...
!2821 = metadata !{null, metadata !2822, metadata !2817, metadata !2823, metadata !2824, metadata !2825, metadata !2798}
!2822 = metadata !{metadata !"kernel_arg_addr_space", i32 0}
!2823 = metadata !{metadata !"kernel_arg_type", metadata !"const ulong &"}
!2824 = metadata !{metadata !"kernel_arg_type_qual", metadata !""}
!2825 = metadata !{metadata !"kernel_arg_name", metadata !"din"}
!2826 = metadata !{null, metadata !2827, metadata !2828, metadata !2829, metadata !2830, metadata !2831, metadata !2798}
!2827 = metadata !{metadata !"kernel_arg_addr_space"}
!2828 = metadata !{metadata !"kernel_arg_access_qual"}
!2829 = metadata !{metadata !"kernel_arg_type"}
!2830 = metadata !{metadata !"kernel_arg_type_qual"}
!2831 = metadata !{metadata !"kernel_arg_name"}
!2832 = metadata !{i32 786689, metadata !1021, metadata !"to", metadata !958, i32 16777264, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2833 = metadata !{i32 48, i32 18, metadata !1021, null}
!2834 = metadata !{i32 786689, metadata !1021, metadata !"from", metadata !958, i32 33554480, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2835 = metadata !{i32 48, i32 41, metadata !1021, null}
!2836 = metadata !{i32 786689, metadata !1021, metadata !"data_count", metadata !958, i32 50331696, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2837 = metadata !{i32 48, i32 56, metadata !1021, null}
!2838 = metadata !{i32 131, i32 9, metadata !2839, metadata !2840}
!2839 = metadata !{i32 786443, metadata !1035, i32 129, i32 63, metadata !964, i32 24} ; [ DW_TAG_lexical_block ]
!2840 = metadata !{i32 52, i32 10, metadata !2841, null}
!2841 = metadata !{i32 786443, metadata !2842, i32 50, i32 45, metadata !958, i32 8} ; [ DW_TAG_lexical_block ]
!2842 = metadata !{i32 786443, metadata !2843, i32 50, i32 3, metadata !958, i32 7} ; [ DW_TAG_lexical_block ]
!2843 = metadata !{i32 786443, metadata !1021, i32 48, i32 68, metadata !958, i32 6} ; [ DW_TAG_lexical_block ]
!2844 = metadata !{i32 50, i32 22, metadata !2842, null}
!2845 = metadata !{i32 50, i32 46, metadata !2841, null}
!2846 = metadata !{i32 51, i32 1, metadata !2841, null}
!2847 = metadata !{i32 786689, metadata !1035, metadata !"this", metadata !964, i32 16777345, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2848 = metadata !{i32 129, i32 56, metadata !1035, metadata !2840}
!2849 = metadata !{i32 786688, metadata !2839, metadata !"tmp", metadata !964, i32 130, metadata !140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2850 = metadata !{i32 130, i32 22, metadata !2839, metadata !2840}
!2851 = metadata !{i32 132, i32 9, metadata !2839, metadata !2840}
!2852 = metadata !{i32 53, i32 3, metadata !2841, null}
!2853 = metadata !{i32 50, i32 40, metadata !2842, null}
!2854 = metadata !{i32 786688, metadata !2842, metadata !"i", metadata !958, i32 50, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2855 = metadata !{i32 54, i32 1, metadata !2843, null}
!2856 = metadata !{i32 786689, metadata !957, metadata !"to0", metadata !958, i32 16777245, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2857 = metadata !{i32 29, i32 33, metadata !957, null}
!2858 = metadata !{i32 786689, metadata !957, metadata !"to1", metadata !958, i32 33554461, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2859 = metadata !{i32 29, i32 57, metadata !957, null}
!2860 = metadata !{i32 786689, metadata !957, metadata !"from", metadata !958, i32 50331678, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2861 = metadata !{i32 30, i32 33, metadata !957, null}
!2862 = metadata !{i32 786689, metadata !957, metadata !"data_count", metadata !958, i32 67108894, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2863 = metadata !{i32 30, i32 48, metadata !957, null}
!2864 = metadata !{i32 131, i32 9, metadata !2839, metadata !2865}
!2865 = metadata !{i32 34, i32 13, metadata !2866, null}
!2866 = metadata !{i32 786443, metadata !2867, i32 32, i32 45, metadata !958, i32 2} ; [ DW_TAG_lexical_block ]
!2867 = metadata !{i32 786443, metadata !2868, i32 32, i32 3, metadata !958, i32 1} ; [ DW_TAG_lexical_block ]
!2868 = metadata !{i32 786443, metadata !957, i32 30, i32 60, metadata !958, i32 0} ; [ DW_TAG_lexical_block ]
!2869 = metadata !{i32 146, i32 9, metadata !2870, metadata !2871}
!2870 = metadata !{i32 786443, metadata !1034, i32 144, i32 79, metadata !964, i32 23} ; [ DW_TAG_lexical_block ]
!2871 = metadata !{i32 35, i32 5, metadata !2866, null}
!2872 = metadata !{i32 146, i32 9, metadata !2870, metadata !2873}
!2873 = metadata !{i32 36, i32 5, metadata !2866, null}
!2874 = metadata !{i32 32, i32 22, metadata !2867, null}
!2875 = metadata !{i32 32, i32 46, metadata !2866, null}
!2876 = metadata !{i32 33, i32 1, metadata !2866, null}
!2877 = metadata !{i32 129, i32 56, metadata !1035, metadata !2865}
!2878 = metadata !{i32 130, i32 22, metadata !2839, metadata !2865}
!2879 = metadata !{i32 132, i32 9, metadata !2839, metadata !2865}
!2880 = metadata !{i32 786688, metadata !2866, metadata !"tmp", metadata !958, i32 34, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2881 = metadata !{i32 786689, metadata !1034, metadata !"this", metadata !964, i32 16777360, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2882 = metadata !{i32 144, i32 48, metadata !1034, metadata !2871}
!2883 = metadata !{i32 786688, metadata !2870, metadata !"tmp", metadata !964, i32 145, metadata !140, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2884 = metadata !{i32 145, i32 22, metadata !2870, metadata !2871}
!2885 = metadata !{i32 145, i32 31, metadata !2870, metadata !2871}
!2886 = metadata !{i32 144, i32 48, metadata !1034, metadata !2873}
!2887 = metadata !{i32 145, i32 22, metadata !2870, metadata !2873}
!2888 = metadata !{i32 145, i32 31, metadata !2870, metadata !2873}
!2889 = metadata !{i32 37, i32 3, metadata !2866, null}
!2890 = metadata !{i32 32, i32 40, metadata !2867, null}
!2891 = metadata !{i32 786688, metadata !2867, metadata !"i", metadata !958, i32 32, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2892 = metadata !{i32 38, i32 1, metadata !2868, null}
!2893 = metadata !{i32 786689, metadata !1015, metadata !"to", metadata !958, i32 16777256, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2894 = metadata !{i32 40, i32 30, metadata !1015, null}
!2895 = metadata !{i32 786689, metadata !1015, metadata !"from", metadata !958, i32 33554472, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2896 = metadata !{i32 40, i32 40, metadata !1015, null}
!2897 = metadata !{i32 786689, metadata !1015, metadata !"data_count", metadata !958, i32 50331688, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2898 = metadata !{i32 40, i32 55, metadata !1015, null}
!2899 = metadata !{i32 146, i32 9, metadata !2870, metadata !2900}
!2900 = metadata !{i32 44, i32 2, metadata !2901, null}
!2901 = metadata !{i32 786443, metadata !2902, i32 42, i32 45, metadata !958, i32 5} ; [ DW_TAG_lexical_block ]
!2902 = metadata !{i32 786443, metadata !2903, i32 42, i32 3, metadata !958, i32 4} ; [ DW_TAG_lexical_block ]
!2903 = metadata !{i32 786443, metadata !1015, i32 40, i32 67, metadata !958, i32 3} ; [ DW_TAG_lexical_block ]
!2904 = metadata !{i32 42, i32 22, metadata !2902, null}
!2905 = metadata !{i32 42, i32 46, metadata !2901, null}
!2906 = metadata !{i32 43, i32 1, metadata !2901, null}
!2907 = metadata !{i32 144, i32 48, metadata !1034, metadata !2900}
!2908 = metadata !{i32 786689, metadata !1034, metadata !"din", metadata !964, i32 33554576, metadata !990, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2909 = metadata !{i32 144, i32 74, metadata !1034, metadata !2900}
!2910 = metadata !{i32 145, i32 22, metadata !2870, metadata !2900}
!2911 = metadata !{i32 145, i32 31, metadata !2870, metadata !2900}
!2912 = metadata !{i32 45, i32 3, metadata !2901, null}
!2913 = metadata !{i32 42, i32 40, metadata !2902, null}
!2914 = metadata !{i32 786688, metadata !2902, metadata !"i", metadata !958, i32 42, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2915 = metadata !{i32 46, i32 1, metadata !2903, null}
!2916 = metadata !{i32 786689, metadata !1028, metadata !"to", metadata !958, i32 16777298, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2917 = metadata !{i32 82, i32 32, metadata !1028, null}
!2918 = metadata !{i32 786689, metadata !1028, metadata !"from0", metadata !958, i32 33554514, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2919 = metadata !{i32 82, i32 55, metadata !1028, null}
!2920 = metadata !{i32 786689, metadata !1028, metadata !"from1", metadata !958, i32 50331731, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2921 = metadata !{i32 83, i32 32, metadata !1028, null}
!2922 = metadata !{i32 786689, metadata !1028, metadata !"data_count", metadata !958, i32 67108947, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2923 = metadata !{i32 83, i32 48, metadata !1028, null}
!2924 = metadata !{i32 131, i32 9, metadata !2839, metadata !2925}
!2925 = metadata !{i32 88, i32 17, metadata !2926, null}
!2926 = metadata !{i32 786443, metadata !2927, i32 87, i32 62, metadata !958, i32 20} ; [ DW_TAG_lexical_block ]
!2927 = metadata !{i32 786443, metadata !2928, i32 85, i32 41, metadata !958, i32 19} ; [ DW_TAG_lexical_block ]
!2928 = metadata !{i32 786443, metadata !2929, i32 85, i32 3, metadata !958, i32 18} ; [ DW_TAG_lexical_block ]
!2929 = metadata !{i32 786443, metadata !1028, i32 83, i32 60, metadata !958, i32 17} ; [ DW_TAG_lexical_block ]
!2930 = metadata !{i32 131, i32 9, metadata !2839, metadata !2931}
!2931 = metadata !{i32 88, i32 33, metadata !2926, null}
!2932 = metadata !{i32 146, i32 9, metadata !2870, metadata !2931}
!2933 = metadata !{i32 85, i32 22, metadata !2928, null}
!2934 = metadata !{i32 85, i32 42, metadata !2927, null}
!2935 = metadata !{i32 86, i32 1, metadata !2927, null}
!2936 = metadata !{i32 129, i32 56, metadata !1035, metadata !2925}
!2937 = metadata !{i32 130, i32 22, metadata !2839, metadata !2925}
!2938 = metadata !{i32 132, i32 9, metadata !2839, metadata !2925}
!2939 = metadata !{i32 129, i32 56, metadata !1035, metadata !2931}
!2940 = metadata !{i32 130, i32 22, metadata !2839, metadata !2931}
!2941 = metadata !{i32 132, i32 9, metadata !2839, metadata !2931}
!2942 = metadata !{i32 144, i32 48, metadata !1034, metadata !2931}
!2943 = metadata !{i32 145, i32 22, metadata !2870, metadata !2931}
!2944 = metadata !{i32 145, i32 31, metadata !2870, metadata !2931}
!2945 = metadata !{i32 89, i32 7, metadata !2926, null}
!2946 = metadata !{i32 786688, metadata !2928, metadata !"i", metadata !958, i32 85, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2947 = metadata !{i32 91, i32 3, metadata !2927, null}
!2948 = metadata !{i32 92, i32 1, metadata !2929, null}
!2949 = metadata !{i32 786689, metadata !1029, metadata !"output_ddr0", metadata !958, i32 16777312, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2950 = metadata !{i32 96, i32 35, metadata !1029, null}
!2951 = metadata !{i32 786689, metadata !1029, metadata !"input_ddr0", metadata !958, i32 33554528, metadata !1018, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2952 = metadata !{i32 96, i32 54, metadata !1029, null}
!2953 = metadata !{i32 786689, metadata !1029, metadata !"data_count", metadata !958, i32 50331745, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2954 = metadata !{i32 97, i32 38, metadata !1029, null}
!2955 = metadata !{i32 98, i32 1, metadata !2956, null}
!2956 = metadata !{i32 786443, metadata !1029, i32 97, i32 50, metadata !958, i32 21} ; [ DW_TAG_lexical_block ]
!2957 = metadata !{i32 99, i32 1, metadata !2956, null}
!2958 = metadata !{i32 101, i32 1, metadata !2956, null}
!2959 = metadata !{i32 102, i32 1, metadata !2956, null}
!2960 = metadata !{i32 103, i32 1, metadata !2956, null}
!2961 = metadata !{i32 104, i32 1, metadata !2956, null}
!2962 = metadata !{i32 786688, metadata !2956, metadata !"data_stage0", metadata !958, i32 106, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2963 = metadata !{i32 106, i32 20, metadata !2956, null}
!2964 = metadata !{i32 786689, metadata !1032, metadata !"this", metadata !964, i32 16777302, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2965 = metadata !{i32 86, i32 43, metadata !1032, metadata !2966}
!2966 = metadata !{i32 106, i32 46, metadata !2956, null}
!2967 = metadata !{i32 786689, metadata !1033, metadata !"this", metadata !964, i32 16777302, metadata !961, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2968 = metadata !{i32 86, i32 43, metadata !1033, metadata !2969}
!2969 = metadata !{i32 87, i32 5, metadata !1032, metadata !2966}
!2970 = metadata !{i32 786688, metadata !2956, metadata !"data_stage1", metadata !958, i32 107, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2971 = metadata !{i32 107, i32 21, metadata !2956, null}
!2972 = metadata !{i32 86, i32 43, metadata !1032, metadata !2973}
!2973 = metadata !{i32 107, i32 47, metadata !2956, null}
!2974 = metadata !{i32 86, i32 43, metadata !1033, metadata !2975}
!2975 = metadata !{i32 87, i32 5, metadata !1032, metadata !2973}
!2976 = metadata !{i32 786688, metadata !2956, metadata !"data_stage2", metadata !958, i32 108, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2977 = metadata !{i32 108, i32 21, metadata !2956, null}
!2978 = metadata !{i32 86, i32 43, metadata !1032, metadata !2979}
!2979 = metadata !{i32 108, i32 47, metadata !2956, null}
!2980 = metadata !{i32 86, i32 43, metadata !1033, metadata !2981}
!2981 = metadata !{i32 87, i32 5, metadata !1032, metadata !2979}
!2982 = metadata !{i32 786688, metadata !2956, metadata !"data_stage3", metadata !958, i32 109, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2983 = metadata !{i32 109, i32 21, metadata !2956, null}
!2984 = metadata !{i32 86, i32 43, metadata !1032, metadata !2985}
!2985 = metadata !{i32 109, i32 47, metadata !2956, null}
!2986 = metadata !{i32 86, i32 43, metadata !1033, metadata !2987}
!2987 = metadata !{i32 87, i32 5, metadata !1032, metadata !2985}
!2988 = metadata !{i32 786688, metadata !2956, metadata !"data_stage4", metadata !958, i32 110, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2989 = metadata !{i32 110, i32 21, metadata !2956, null}
!2990 = metadata !{i32 86, i32 43, metadata !1032, metadata !2991}
!2991 = metadata !{i32 110, i32 47, metadata !2956, null}
!2992 = metadata !{i32 86, i32 43, metadata !1033, metadata !2993}
!2993 = metadata !{i32 87, i32 5, metadata !1032, metadata !2991}
!2994 = metadata !{i32 786688, metadata !2956, metadata !"data_stage5", metadata !958, i32 111, metadata !962, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2995 = metadata !{i32 111, i32 21, metadata !2956, null}
!2996 = metadata !{i32 86, i32 43, metadata !1032, metadata !2997}
!2997 = metadata !{i32 111, i32 47, metadata !2956, null}
!2998 = metadata !{i32 86, i32 43, metadata !1033, metadata !2999}
!2999 = metadata !{i32 87, i32 5, metadata !1032, metadata !2997}
!3000 = metadata !{i32 113, i32 1, metadata !2956, null}
!3001 = metadata !{i32 114, i32 1, metadata !2956, null}
!3002 = metadata !{i32 120, i32 1, metadata !2956, null}
!3003 = metadata !{i32 121, i32 2, metadata !2956, null}
!3004 = metadata !{i32 122, i32 3, metadata !2956, null}
!3005 = metadata !{i32 123, i32 3, metadata !2956, null}
!3006 = metadata !{i32 124, i32 3, metadata !2956, null}
!3007 = metadata !{i32 125, i32 3, metadata !2956, null}
!3008 = metadata !{i32 126, i32 3, metadata !2956, null}
!3009 = metadata !{i32 127, i32 1, metadata !2956, null}
!3010 = metadata !{i32 786689, metadata !1027, metadata !"to", metadata !958, i32 16777285, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3011 = metadata !{i32 69, i32 34, metadata !1027, null}
!3012 = metadata !{i32 786689, metadata !1027, metadata !"from", metadata !958, i32 33554501, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3013 = metadata !{i32 69, i32 57, metadata !1027, null}
!3014 = metadata !{i32 786689, metadata !1027, metadata !"data_count", metadata !958, i32 50331718, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3015 = metadata !{i32 70, i32 24, metadata !1027, null}
!3016 = metadata !{i32 131, i32 9, metadata !2839, metadata !3017}
!3017 = metadata !{i32 75, i32 18, metadata !3018, null}
!3018 = metadata !{i32 786443, metadata !3019, i32 74, i32 41, metadata !958, i32 16} ; [ DW_TAG_lexical_block ]
!3019 = metadata !{i32 786443, metadata !3020, i32 72, i32 41, metadata !958, i32 15} ; [ DW_TAG_lexical_block ]
!3020 = metadata !{i32 786443, metadata !3021, i32 72, i32 3, metadata !958, i32 14} ; [ DW_TAG_lexical_block ]
!3021 = metadata !{i32 786443, metadata !1027, i32 70, i32 36, metadata !958, i32 13} ; [ DW_TAG_lexical_block ]
!3022 = metadata !{i32 146, i32 9, metadata !2870, metadata !3023}
!3023 = metadata !{i32 76, i32 7, metadata !3018, null}
!3024 = metadata !{i32 72, i32 22, metadata !3020, null}
!3025 = metadata !{i32 72, i32 42, metadata !3019, null}
!3026 = metadata !{i32 73, i32 1, metadata !3019, null}
!3027 = metadata !{i32 129, i32 56, metadata !1035, metadata !3017}
!3028 = metadata !{i32 130, i32 22, metadata !2839, metadata !3017}
!3029 = metadata !{i32 132, i32 9, metadata !2839, metadata !3017}
!3030 = metadata !{i32 786688, metadata !3018, metadata !"tmp", metadata !958, i32 75, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3031 = metadata !{i32 144, i32 48, metadata !1034, metadata !3023}
!3032 = metadata !{i32 145, i32 22, metadata !2870, metadata !3023}
!3033 = metadata !{i32 145, i32 31, metadata !2870, metadata !3023}
!3034 = metadata !{i32 77, i32 7, metadata !3018, null}
!3035 = metadata !{i32 786688, metadata !3020, metadata !"i", metadata !958, i32 72, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3036 = metadata !{i32 79, i32 3, metadata !3019, null}
!3037 = metadata !{i32 80, i32 1, metadata !3021, null}
!3038 = metadata !{i32 786689, metadata !1024, metadata !"to", metadata !958, i32 16777272, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3039 = metadata !{i32 56, i32 34, metadata !1024, null}
!3040 = metadata !{i32 786689, metadata !1024, metadata !"from", metadata !958, i32 33554488, metadata !961, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3041 = metadata !{i32 56, i32 57, metadata !1024, null}
!3042 = metadata !{i32 786689, metadata !1024, metadata !"data_count", metadata !958, i32 50331705, metadata !1014, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3043 = metadata !{i32 57, i32 24, metadata !1024, null}
!3044 = metadata !{i32 131, i32 9, metadata !2839, metadata !3045}
!3045 = metadata !{i32 62, i32 18, metadata !3046, null}
!3046 = metadata !{i32 786443, metadata !3047, i32 61, i32 41, metadata !958, i32 12} ; [ DW_TAG_lexical_block ]
!3047 = metadata !{i32 786443, metadata !3048, i32 59, i32 41, metadata !958, i32 11} ; [ DW_TAG_lexical_block ]
!3048 = metadata !{i32 786443, metadata !3049, i32 59, i32 3, metadata !958, i32 10} ; [ DW_TAG_lexical_block ]
!3049 = metadata !{i32 786443, metadata !1024, i32 57, i32 36, metadata !958, i32 9} ; [ DW_TAG_lexical_block ]
!3050 = metadata !{i32 146, i32 9, metadata !2870, metadata !3051}
!3051 = metadata !{i32 63, i32 7, metadata !3046, null}
!3052 = metadata !{i32 59, i32 22, metadata !3048, null}
!3053 = metadata !{i32 59, i32 42, metadata !3047, null}
!3054 = metadata !{i32 60, i32 1, metadata !3047, null}
!3055 = metadata !{i32 129, i32 56, metadata !1035, metadata !3045}
!3056 = metadata !{i32 130, i32 22, metadata !2839, metadata !3045}
!3057 = metadata !{i32 132, i32 9, metadata !2839, metadata !3045}
!3058 = metadata !{i32 786688, metadata !3046, metadata !"tmp", metadata !958, i32 62, metadata !1019, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3059 = metadata !{i32 144, i32 48, metadata !1034, metadata !3051}
!3060 = metadata !{i32 145, i32 22, metadata !2870, metadata !3051}
!3061 = metadata !{i32 145, i32 31, metadata !2870, metadata !3051}
!3062 = metadata !{i32 64, i32 7, metadata !3046, null}
!3063 = metadata !{i32 786688, metadata !3048, metadata !"i", metadata !958, i32 59, metadata !1014, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3064 = metadata !{i32 66, i32 3, metadata !3047, null}
!3065 = metadata !{i32 67, i32 1, metadata !3049, null}
