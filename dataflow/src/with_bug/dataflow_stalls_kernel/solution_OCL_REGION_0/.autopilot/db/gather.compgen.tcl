...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_from0_V \
    op interface \
    ports { from0_V_dout { I 64 vector } from0_V_empty_n { I 1 bit } from0_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_from1_V \
    op interface \
    ports { from1_V_dout { I 64 vector } from1_V_empty_n { I 1 bit } from1_V_read { O 1 bit } } \
} "
}
