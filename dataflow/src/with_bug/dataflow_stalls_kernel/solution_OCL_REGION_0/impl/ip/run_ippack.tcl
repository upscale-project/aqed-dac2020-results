...
set Library     "hls"
set IPName      "dataflow_stalls_kernel"
set Version     "1.0"
set DisplayName "Dataflow_stalls_kernel"
set Revision    "2004140735"
set Description "An IP generated by Vivado HLS"
set Device      "virtex7"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "dataflow_stalls_kernel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 output_ddr0_1 W 0x0 "Data signal of output_ddr0" {{0 32 output_ddr0 W 0 "Bit 31 to 0 Data signal of output_ddr0"}}} {0x14 output_ddr0_2 W 0x0 "Data signal of output_ddr0" {{0 32 output_ddr0 W 0 "Bit 63 to 32 Data signal of output_ddr0"}}} {0x1c input_ddr0_1 W 0x0 "Data signal of input_ddr0" {{0 32 input_ddr0 W 0 "Bit 31 to 0 Data signal of input_ddr0"}}} {0x20 input_ddr0_2 W 0x0 "Data signal of input_ddr0" {{0 32 input_ddr0 W 0 "Bit 63 to 32 Data signal of input_ddr0"}}} {0x28 data_count W 0x0 "Data signal of data_count" {{0 32 data_count W 0 "Bit 31 to 0 Data signal of data_count"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmemo m_axi_gmemi"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmemo {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmemo"
        data_width "64"
        param_prefix "C_M_AXI_GMEMO"
    ...
    m_axi_gmemi {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmemi"
        data_width "64"
        param_prefix "C_M_AXI_GMEMI"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 64 WSTRB 8 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 64 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
set enable_xo_gen 1
set kernel_files {/rsgs/pool0/esingh/aqed4saranyu/results/dataflow/dataflow-stalls_ab/src/dataflow_stalls_kernel.cpp}
if {$enable_xo_gen} {
