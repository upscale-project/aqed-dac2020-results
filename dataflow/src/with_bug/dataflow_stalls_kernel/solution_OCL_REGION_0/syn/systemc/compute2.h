...
struct compute2 : public sc_module {
    ...
    sc_signal< sc_lv<1> > exitcond_i_reg_124;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter7_exitcond_i_reg_124;
    sc_signal< sc_logic > from_V_blk_n;
    sc_signal< sc_logic > ap_CS_fsm_pp0_stage0;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< sc_logic > data_count_blk_n;
    sc_signal< sc_lv<32> > i_i_reg_93;
    sc_signal< sc_lv<32> > data_count_read_reg_119;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<1> > exitcond_i_fu_104_p2;
    ...
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_exitcond_i_reg_124;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter2_exitcond_i_reg_124;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter3_exitcond_i_reg_124;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter4_exitcond_i_reg_124;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter5_exitcond_i_reg_124;
    sc_signal< sc_lv<1> > ap_reg_pp0_iter6_exitcond_i_reg_124;
    sc_signal< sc_lv<32> > i_fu_109_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<64> > tmp_reg_133;
    sc_signal< sc_lv<64> > grp_fu_115_p2;
    sc_signal< sc_lv<64> > tmp_3_reg_139;
    ...
    void thread_exitcond_i_fu_104_p2();
