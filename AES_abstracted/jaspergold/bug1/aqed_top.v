...
(* CORE_GENERATION_INFO="aqed_top,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=50.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.254000,HLS_SYN_LAT=145,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=722,HLS_SYN_LUT=2515,HLS_VERSION=2018_3}" *)
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        o2_qed_check_V_reg_253 <= 1'b0;
        o2_qed_done_V_reg_248 <= 1'b0;
    end else
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_125_state_dup_idx_V_ap_vld == 1'b1))) begin
        state_dup_idx_V <= grp_aqed_in_fu_125_state_dup_idx_V;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_125_state_dup_in_V_ap_vld == 1'b1))) begin
        state_dup_in_V <= grp_aqed_in_fu_125_state_dup_in_V;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_125_state_dup_issued_V_o_ap_vld == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_125_state_dup_val_V_0_ap_vld == 1'b1))) begin
        state_dup_val_V_0 <= grp_aqed_in_fu_125_state_dup_val_V_0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_125_state_dup_val_V_1_ap_vld == 1'b1))) begin
        state_dup_val_V_1 <= grp_aqed_in_fu_125_state_dup_val_V_1;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_125_state_orig_in_V_ap_vld == 1'b1))) begin
        state_orig_in_V <= grp_aqed_in_fu_125_state_orig_in_V;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_125_state_orig_issued_V_o_ap_vld == 1'b1))) begin
...
/*
 assume_consistent_key : assume property
    (@(posedge ap_clk) (ap_rst == 0 |=>
          ((grp_workload_fu_113.local_key_0_U.workload_local_key_0_rom_U.ram[0] ==
                  grp_workload_fu_113.local_key_1_U.workload_local_key_0_rom_U.ram[0])
 //           && ($stable(grp_workload_fu_113.local_key_0_U.workload_local_key_0_rom_U.ram[0]))
 //           && ($stable(grp_workload_fu_113.local_key_1_U.workload_local_key_0_rom_U.ram[0]))
            && (grp_workload_fu_113.local_key_0_U.workload_local_key_0_rom_U.ram[1] ==
                  grp_workload_fu_113.local_key_1_U.workload_local_key_0_rom_U.ram[1])
 //           && ($stable(grp_workload_fu_113.local_key_0_U.workload_local_key_0_rom_U.ram[1]))
 //           && ($stable(grp_workload_fu_113.local_key_1_U.workload_local_key_0_rom_U.ram[1])))));


  assume_consistent_key2 : assume property
    (@(posedge ap_clk) ((grp_workload_fu_113.local_key_0_U.workload_local_key_0_rom_U.ram[16] ==
                             grp_workload_fu_113.local_key_1_U.workload_local_key_0_rom_U.ram[16])
                       && (grp_workload_fu_113.local_key_0_U.workload_local_key_0_rom_U.ram[17] ==
                             grp_workload_fu_113.local_key_1_U.workload_local_key_0_rom_U.ram[17])));
*/
...
generate
  ...
  assume_consistent_sbox : assume property
    (@(posedge ap_clk) (ap_rst == 0 |=>
                       ((grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_349.sbox_U.aes256_encrypt_ecb_sbox_rom_U.ram[i] ==
                         grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_361.sbox_U.aes256_encrypt_ecb_sbox_rom_U.ram[i])
                       && $stable(grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_349.sbox_U.aes256_encrypt_ecb_sbox_rom_U.ram[i])
                       && $stable(grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_361.sbox_U.aes256_encrypt_ecb_sbox_rom_U.ram[i]))));
   end
endgenerate

/*
  assume_consistent_key4 : assume property
    (@(posedge ap_clk) ((grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_349.ctx_body_key_U.aes256_encrypt_ecb_ctx_body_key_ram_U.ram[0] ==
                             grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_361.ctx_body_key_U.aes256_encrypt_ecb_ctx_body_key_ram_U.ram[0])
                       && (grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_349.ctx_body_key_U.aes256_encrypt_ecb_ctx_body_key_ram_U.ram[1] ==
                             grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_361.ctx_body_key_U.aes256_encrypt_ecb_ctx_body_key_ram_U.ram[1])));

  assume_consistent_key5 : assume property
    (@(posedge ap_clk) ((grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_349.ctx_body_enckey_U.aes256_encrypt_ecb_ctx_body_enckey_ram_U.ram[0] ==
                         grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_361.ctx_body_enckey_U.aes256_encrypt_ecb_ctx_body_enckey_ram_U.ram[0]
                     && (grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_349.ctx_body_enckey_U.aes256_encrypt_ecb_ctx_body_enckey_ram_U.ram[1] ==
                         grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_361.ctx_body_enckey_U.aes256_encrypt_ecb_ctx_body_enckey_ram_U.ram[1]))
));
*/
