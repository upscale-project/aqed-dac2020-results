...
wire   [63:0] p_0128_sum_cast_fu_185_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        state_orig_out_V_0 = 8'd0;
        state_orig_out_V_1 = 8'd0;
    end else
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        bmc_in_address1 = p_0128_sum_cast_fu_185_p1;
    end else begin
        bmc_in_address1 = 'bx;
    end
end
...
assign p_0128_sum_cast_fu_185_p1 = p_0128_sum_fu_179_p2;

assign p_0128_sum_fu_179_p2 = (r_V_fu_166_p3 | 3'd1);
