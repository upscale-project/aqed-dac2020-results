...
wire   [63:0] p_0368_sum_cast_fu_134_p1;
wire   [63:0] op2_2_fu_147_p1;
wire   [63:0] p_0265_sum_cast_fu_158_p1;
wire    ap_CS_fsm_state3;
wire   [0:0] val_assign_11_demorg_fu_184_p2;
wire   [15:0] tmp_1_fu_451_p2;
wire   [0:0] issue_dup_V_fu_385_p2;
wire   [2:0] r_V_fu_115_p3;
wire   [2:0] p_0368_sum_fu_128_p2;
wire   [2:0] r_V_2_fu_139_p3;
wire   [2:0] p_0265_sum_fu_152_p2;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        bmc_in_address1 = p_0265_sum_cast_fu_158_p1;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        bmc_in_address1 = p_0368_sum_cast_fu_134_p1;
    end else begin
        bmc_in_address1 = 'bx;
    end
end
...
assign op2_2_fu_147_p1 = r_V_2_fu_139_p3;

assign op2_fu_123_p1 = r_V_fu_115_p3;

assign orig_V_not_fu_163_p2 = (orig_V ^ 1'd1);

assign p_0265_sum_cast_fu_158_p1 = p_0265_sum_fu_152_p2;

assign p_0265_sum_fu_152_p2 = (r_V_2_fu_139_p3 | 3'd1);

assign p_0368_sum_cast_fu_134_p1 = p_0368_sum_fu_128_p2;

assign p_0368_sum_fu_128_p2 = (r_V_fu_115_p3 | 3'd1);

assign r_V_2_fu_139_p3 = {{orig_idx_V}, {1'd0}};

assign r_V_fu_115_p3 = {{dup_idx_V}, {1'd0}};
