...
(* CORE_GENERATION_INFO="aqed_top,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=100.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.254000,HLS_SYN_LAT=86,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=440,HLS_SYN_LUT=1789,HLS_VERSION=2018_2}" *)
...
wire    grp_aqed_in_fu_123_ap_start;
wire    grp_aqed_in_fu_123_ap_done;
wire    grp_aqed_in_fu_123_ap_idle;
wire    grp_aqed_in_fu_123_ap_ready;
wire   [3:0] grp_aqed_in_fu_123_bmc_in_address0;
wire    grp_aqed_in_fu_123_bmc_in_ce0;
wire   [3:0] grp_aqed_in_fu_123_bmc_in_address1;
wire    grp_aqed_in_fu_123_bmc_in_ce1;
wire   [0:0] grp_aqed_in_fu_123_state_orig_issued_V_o;
wire    grp_aqed_in_fu_123_state_orig_issued_V_o_ap_vld;
wire   [0:0] grp_aqed_in_fu_123_state_dup_issued_V_o;
wire    grp_aqed_in_fu_123_state_dup_issued_V_o_ap_vld;
wire   [15:0] grp_aqed_in_fu_123_state_orig_in_V;
wire    grp_aqed_in_fu_123_state_orig_in_V_ap_vld;
wire   [1:0] grp_aqed_in_fu_123_state_orig_idx_V;
wire    grp_aqed_in_fu_123_state_orig_idx_V_ap_vld;
wire   [15:0] grp_aqed_in_fu_123_state_dup_in_V;
wire    grp_aqed_in_fu_123_state_dup_in_V_ap_vld;
wire   [1:0] grp_aqed_in_fu_123_state_dup_idx_V;
wire    grp_aqed_in_fu_123_state_dup_idx_V_ap_vld;
wire   [7:0] grp_aqed_in_fu_123_state_dup_val_V_0;
wire    grp_aqed_in_fu_123_state_dup_val_V_0_ap_vld;
wire   [7:0] grp_aqed_in_fu_123_state_dup_val_V_1;
wire    grp_aqed_in_fu_123_state_dup_val_V_1_ap_vld;
...
reg    grp_aqed_in_fu_123_ap_start_reg;
...
#0 grp_aqed_in_fu_123_ap_start_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_aqed_in_fu_123_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
            grp_aqed_in_fu_123_ap_start_reg <= 1'b1;
        end else if ((grp_aqed_in_fu_123_ap_ready == 1'b1)) begin
            grp_aqed_in_fu_123_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        o2_qed_check_V_reg_255 <= 1'b0;
        o2_qed_done_V_reg_250 <= 1'b0;
...
always @ (posedge ap_clk) begin
   if (ap_rst == 1'b1) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_123_state_dup_idx_V_ap_vld == 1'b1))) begin
        state_dup_idx_V <= grp_aqed_in_fu_123_state_dup_idx_V;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_123_state_dup_in_V_ap_vld == 1'b1))) begin
        state_dup_in_V <= grp_aqed_in_fu_123_state_dup_in_V;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_123_state_dup_issued_V_o_ap_vld == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_123_state_dup_val_V_0_ap_vld == 1'b1))) begin
        state_dup_val_V_0 <= grp_aqed_in_fu_123_state_dup_val_V_0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_123_state_dup_val_V_1_ap_vld == 1'b1))) begin
        state_dup_val_V_1 <= grp_aqed_in_fu_123_state_dup_val_V_1;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state6) & (grp_aqed_out_fu_161_state_orig_done_V_ap_vld == 1'b1))) begin
        state_orig_done_V <= grp_aqed_out_fu_161_state_orig_done_V;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_123_state_orig_idx_V_ap_vld == 1'b1))) begin
        state_orig_idx_V <= grp_aqed_in_fu_123_state_orig_idx_V;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_123_state_orig_in_V_ap_vld == 1'b1))) begin
        state_orig_in_V <= grp_aqed_in_fu_123_state_orig_in_V;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    if (((1'b1 == ap_CS_fsm_state2) & (grp_aqed_in_fu_123_state_orig_issued_V_o_ap_vld == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((grp_aqed_in_fu_123_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign agg_result = {{{{{{state_dup_val_V_1}, {state_dup_val_V_0}}, {state_orig_done_V}}, {state_orig_issued_V}}, {o2_qed_check_V_reg_255}}, {o2_qed_done_V_reg_250}};
...
assign grp_aqed_in_fu_123_ap_start = grp_aqed_in_fu_123_ap_start_reg;
...
assign grp_workload_fu_113_ap_start = grp_workload_fu_113_ap_start_reg;
   ...
   assert_qed_match : assert property (
       @(posedge ap_clk)
         (o2_qed_done_V_reg_250) |-> (o2_qed_check_V_reg_255));
  ...
  assume_orig_idx_max : assume property
    (@(posedge ap_clk) (orig_idx_V <= 2'b11));

  assume_dup_idx_max : assume property
    (@(posedge ap_clk) (dup_idx_V <= 2'b11));

  assume_consistent_key : assume property
    (@(posedge ap_clk) (ap_rst == 0 |=>
          ( $stable(grp_workload_fu_113.local_key_0_U.workload_local_keeOg_rom_U.ram[0] &&
            ($stable(grp_workload_fu_113.local_key_0_U.workload_local_keeOg_rom_U.ram[1]))))));

  assume_consistent_key2 : assume property
    (@(posedge ap_clk) ((grp_workload_fu_113.local_key_0_U.workload_local_keeOg_rom_U.ram[16] &&
                        (grp_workload_fu_113.local_key_0_U.workload_local_keeOg_rom_U.ram[17]))));

generate
  for (genvar i=0; i < 256; i++) begin
  assume_consistent_sbox : assume property
    (@(posedge ap_clk) (ap_rst == 0 |=>
                       $stable(grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_196.sbox_U.aes256_encrypt_ecbkb_rom_U.ram[i])));
   end
endgenerate

ssume_consistent_key4 : assume property
    (@(posedge ap_clk) ($stable(grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_196.ctx_body_key_U.aes256_encrypt_eccud_ram_U.ram[0] &&
             $stable(grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_196.ctx_body_key_U.aes256_encrypt_eccud_ram_U.ram[1]))));




ssume_consistent_key5 : assume property
    (@(posedge ap_clk) ($stable(grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_196.ctx_body_enckey_U.aes256_encrypt_ecdEe_ram_U.ram[0]) && $stable(grp_workload_fu_113.grp_aes256_encrypt_ecb_fu_196.ctx_body_enckey_U.aes256_encrypt_ecdEe_ram_U.ram[1])));
