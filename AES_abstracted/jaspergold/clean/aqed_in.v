...
wire   [2:0] r_V_fu_259_p3;
reg   [2:0] r_V_reg_597;
wire   [2:0] r_V_1_fu_272_p3;
reg   [2:0] r_V_1_reg_607;
...
wire   [63:0] p_0265_sum_cast_fu_290_p1;
wire   [63:0] p_0234_sum_cast_fu_300_p1;
...
wire   [2:0] p_0265_sum_fu_285_p2;
wire   [2:0] p_0234_sum_fu_295_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        r_V_1_reg_607[2 : 1] <= r_V_1_fu_272_p3[2 : 1];
        r_V_reg_597[2 : 1] <= r_V_fu_259_p3[2 : 1];
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        state_orig_val_V_0 = 8'd0;
        state_orig_val_V_1 = 8'd0;
    end else
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        bmc_in_address0 = p_0265_sum_cast_fu_290_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        bmc_in_address1 = p_0234_sum_cast_fu_300_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
...
assign brmerge_fu_384_p2 = (p_0467_not_fu_378_p2 | or_cond_fu_366_p2);
...
assign op2_1_fu_280_p1 = r_V_1_fu_272_p3;

assign op2_fu_267_p1 = r_V_fu_259_p3;
...
assign p_0234_sum_cast_fu_300_p1 = p_0234_sum_fu_295_p2;

assign p_0234_sum_fu_295_p2 = (r_V_1_reg_607 | 3'd1);

assign p_0265_sum_cast_fu_290_p1 = p_0265_sum_fu_285_p2;

assign p_0265_sum_fu_285_p2 = (r_V_reg_597 | 3'd1);

assign p_0467_not_fu_378_p2 = (state_orig_issued_V_i | or_cond1_not_fu_372_p2);

assign r_V_1_fu_272_p3 = {{dup_idx_V}, {1'd0}};

assign r_V_fu_259_p3 = {{orig_idx_V}, {1'd0}};

assign sel_tmp10_fu_481_p2 = (tmp4_fu_475_p2 | tmp3_fu_469_p2);

assign sel_tmp11_fu_487_p2 = (sel_tmp10_fu_481_p2 & p_0467_not_fu_378_p2);

assign sel_tmp1_fu_414_p2 = (tmp_fu_402_p2 & tmp1_fu_408_p2);
...
assign sel_tmp6_fu_449_p2 = (tmp2_fu_444_p2 & sel_tmp4_fu_432_p2);
...
assign tmp1_fu_408_p2 = (tmp_7_fu_345_p2 & sel_tmp7_fu_396_p2);

assign tmp2_fu_444_p2 = (tmp_1_reg_622 & grp_fu_242_p2);

assign tmp3_fu_469_p2 = (state_dup_issued_V_i | sel_tmp_fu_390_p2);

assign tmp4_fu_475_p2 = (tmp_5_fu_314_p2 | sel_tmp5_fu_438_p2);
