...
// Converted from:  memcpy(buf[j], data + i*BUF_SIZE + j*BUF_SIZE/UNROLL_FACTOR, BUF_SIZE/UNROLL_FACTOR);
	}
...
// Converted from:  memcpy(data + i*BUF_SIZE + j*BUF_SIZE/UNROLL_FACTOR, buf[j], BUF_SIZE/UNROLL_FACTOR);
	}
    }
    return;
}
