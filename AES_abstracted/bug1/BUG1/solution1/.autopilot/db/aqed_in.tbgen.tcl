...
set C_modelArgList {
	...
	{ bmc_in_offset int 4 regular  }
	{ orig_V int 1 regular  }
	{ dup_V int 1 regular  }
	{ orig_idx int 8 regular  }
	{ dup_idx int 8 regular  }
	...
	{ state_orig_idx_V int 2 regular {pointer 1} {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bmc_in", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "bmc_in_offset", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "orig_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "dup_V", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "orig_idx", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "dup_idx", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "state_orig_idx_V", "interface" : "wire", "bitwidth" : 2, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":1,"cElement": [{"cName": "state.orig_idx.V","cData": "uint2","bit_use": { "low": 0,"up": 1},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "extern" : 0} , 
...
set portList { 
	...
	{ bmc_in_offset sc_in sc_lv 4 signal 1 } 
	{ orig_V sc_in sc_lv 1 signal 2 } 
	{ dup_V sc_in sc_lv 1 signal 3 } 
	{ orig_idx sc_in sc_lv 8 signal 4 } 
	{ dup_idx sc_in sc_lv 8 signal 5 } 
	{ state_orig_issued_V_i sc_in sc_lv 1 signal 6 } 
	{ state_orig_issued_V_o sc_out sc_lv 1 signal 6 } 
	{ state_orig_issued_V_o_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ state_dup_issued_V_i sc_in sc_lv 1 signal 7 } 
	{ state_dup_issued_V_o sc_out sc_lv 1 signal 7 } 
	{ state_dup_issued_V_o_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ state_orig_in_V sc_out sc_lv 16 signal 8 } 
	{ state_orig_in_V_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ state_orig_idx_V sc_out sc_lv 2 signal 9 } 
	{ state_orig_idx_V_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ state_dup_in_V sc_out sc_lv 16 signal 10 } 
	{ state_dup_in_V_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ state_dup_idx_V sc_out sc_lv 2 signal 11 } 
	{ state_dup_idx_V_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ state_dup_val_V_0 sc_out sc_lv 8 signal 12 } 
	{ state_dup_val_V_0_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ state_dup_val_V_1 sc_out sc_lv 8 signal 13 } 
	{ state_dup_val_V_1_ap_vld sc_out sc_logic 1 outvld 13 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bmc_in_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "bmc_in_offset", "role": "default" }} , 
 	...
 	{ "name": "state_orig_idx_V", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "state_orig_idx_V", "role": "default" }} , 
 	{ "name": "state_orig_idx_V_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "state_orig_idx_V", "role": "ap_vld" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "17"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "17"}
]}
...
set Spec2ImplPortList { 
	...
	bmc_in_offset { ap_none {  { bmc_in_offset in_data 0 4 } } }
	...
	state_orig_idx_V { ap_vld {  { state_orig_idx_V out_data 1 2 }  { state_orig_idx_V_ap_vld out_vld 1 1 } } }
