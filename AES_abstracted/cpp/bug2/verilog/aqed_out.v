...
wire   [63:0] p_0159_sum_cast_fu_185_p1;
wire   [63:0] op2_1_fu_244_p1;
wire   [63:0] p_0217_sum_cast_fu_255_p1;
...
wire   [2:0] ret_V_fu_166_p3;
wire   [2:0] p_0159_sum_fu_179_p2;
wire   [0:0] tmp_s_fu_210_p2;
wire   [0:0] or_cond_fu_215_p2;
wire   [0:0] or_cond_not_fu_221_p2;
wire   [2:0] ret_V_1_fu_236_p3;
wire   [2:0] p_0217_sum_fu_249_p2;
...
always @ (posedge ap_clk) begin
    if(ap_rst) begin
	state_orig_out_V_0 <= 0;
	state_orig_out_V_1 <= 0;
    end else if (((state_orig_issued_V_s_load_fu_110_p1 == 1'd1) & (brmerge_reg_357 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        bmc_in_address1 = p_0217_sum_cast_fu_255_p1;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        bmc_in_address1 = p_0159_sum_cast_fu_185_p1;
    end else begin
        bmc_in_address1 = 'bx;
    end
end
...
assign op2_1_fu_244_p1 = ret_V_1_fu_236_p3;

assign op2_fu_174_p1 = ret_V_fu_166_p3;

assign or_cond_fu_215_p2 = (tmp_s_fu_210_p2 & state_dup_issued_V);

assign or_cond_not_fu_221_p2 = (or_cond_fu_215_p2 ^ 1'd1);

assign p_0159_sum_cast_fu_185_p1 = p_0159_sum_fu_179_p2;

assign p_0159_sum_fu_179_p2 = (ret_V_fu_166_p3 | 3'd1);

assign p_0217_sum_cast_fu_255_p1 = p_0217_sum_fu_249_p2;

assign p_0217_sum_fu_249_p2 = (ret_V_1_fu_236_p3 | 3'd1);

assign p_state_qed_done_V_fl_fu_307_p2 = (tmp_3_reg_390 | state_qed_done_V_fla_reg_81);

assign ret_V_1_fu_236_p3 = {{state_dup_idx_V}, {1'd0}};

assign ret_V_fu_166_p3 = {{state_orig_idx_V}, {1'd0}};
