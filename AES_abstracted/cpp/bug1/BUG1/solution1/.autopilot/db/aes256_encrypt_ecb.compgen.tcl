...
set ID 16
set hasByteEnable 0
set MemName aes256_encrypt_ecb_sbox
...
set ID 17
set hasByteEnable 0
set MemName aes256_encrypt_ecb_ctx_body_key
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 8
set AddrRange 32
...
set ID 18
set hasByteEnable 0
set MemName aes256_encrypt_ecb_ctx_body_enckey
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 8
set AddrRange 32
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename k \
    op interface \
    ports { k_address0 { O 5 vector } k_ce0 { O 1 bit } k_q0 { I 8 vector } } \
} "
} else {
