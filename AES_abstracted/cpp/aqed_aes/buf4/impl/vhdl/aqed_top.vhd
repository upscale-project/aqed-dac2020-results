...
architecture behav of aqed_top is 
    ...
    "aqed_top,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=50.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.254000,HLS_SYN_LAT=129,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=719,HLS_SYN_LUT=2507,HLS_VERSION=2018_2}";
    ...
    signal o2_qed_done_V_reg_248 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal o2_qed_check_V_reg_253 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal grp_aqed_in_fu_125_ap_start : STD_LOGIC;
    signal grp_aqed_in_fu_125_ap_done : STD_LOGIC;
    signal grp_aqed_in_fu_125_ap_idle : STD_LOGIC;
    signal grp_aqed_in_fu_125_ap_ready : STD_LOGIC;
    signal grp_aqed_in_fu_125_bmc_in_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_aqed_in_fu_125_bmc_in_ce0 : STD_LOGIC;
    signal grp_aqed_in_fu_125_bmc_in_address1 : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_aqed_in_fu_125_bmc_in_ce1 : STD_LOGIC;
    signal grp_aqed_in_fu_125_state_orig_issued_V_o : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_aqed_in_fu_125_state_orig_issued_V_o_ap_vld : STD_LOGIC;
    signal grp_aqed_in_fu_125_state_dup_issued_V_o : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_aqed_in_fu_125_state_dup_issued_V_o_ap_vld : STD_LOGIC;
    signal grp_aqed_in_fu_125_state_orig_in_V : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_aqed_in_fu_125_state_orig_in_V_ap_vld : STD_LOGIC;
    signal grp_aqed_in_fu_125_state_dup_in_V : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_aqed_in_fu_125_state_dup_in_V_ap_vld : STD_LOGIC;
    signal grp_aqed_in_fu_125_state_dup_idx_V : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_aqed_in_fu_125_state_dup_idx_V_ap_vld : STD_LOGIC;
    signal grp_aqed_in_fu_125_state_dup_val_V_0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_aqed_in_fu_125_state_dup_val_V_0_ap_vld : STD_LOGIC;
    signal grp_aqed_in_fu_125_state_dup_val_V_1 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_aqed_in_fu_125_state_dup_val_V_1_ap_vld : STD_LOGIC;
    ...
    signal grp_aqed_in_fu_125_ap_start_reg : STD_LOGIC := '0';
...
begin
    ...
    grp_aqed_in_fu_125 : component aqed_in
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_aqed_in_fu_125_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_aqed_in_fu_125_ap_ready = ap_const_logic_1)) then 
                    grp_aqed_in_fu_125_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_aqed_in_fu_125_state_dup_idx_V_ap_vld = ap_const_logic_1))) then
                state_dup_idx_V <= grp_aqed_in_fu_125_state_dup_idx_V;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_aqed_in_fu_125_state_dup_in_V_ap_vld = ap_const_logic_1))) then
                state_dup_in_V <= grp_aqed_in_fu_125_state_dup_in_V;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_aqed_in_fu_125_state_dup_issued_V_o_ap_vld = ap_const_logic_1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_aqed_in_fu_125_state_dup_val_V_0_ap_vld = ap_const_logic_1))) then
                state_dup_val_V_0 <= grp_aqed_in_fu_125_state_dup_val_V_0;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_aqed_in_fu_125_state_dup_val_V_1_ap_vld = ap_const_logic_1))) then
                state_dup_val_V_1 <= grp_aqed_in_fu_125_state_dup_val_V_1;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_aqed_in_fu_125_state_orig_in_V_ap_vld = ap_const_logic_1))) then
                state_orig_in_V <= grp_aqed_in_fu_125_state_orig_in_V;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_aqed_in_fu_125_state_orig_issued_V_o_ap_vld = ap_const_logic_1))) then
                state_orig_issued_V <= grp_aqed_in_fu_125_state_orig_issued_V_o;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state6, grp_aqed_out_fu_161_ap_done, grp_workload_fu_113_ap_done, grp_aqed_in_fu_125_ap_done, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((grp_aqed_in_fu_125_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    agg_result <= (((((state_dup_val_V_1 & state_dup_val_V_0) & state_orig_done_V) & state_orig_issued_V) & o2_qed_check_V_reg_253) & o2_qed_done_V_reg_248);
    ...
    bmc_in_address0_assign_proc : process(ap_CS_fsm_state6, grp_workload_fu_113_data_address0, grp_aqed_in_fu_125_bmc_in_address0, grp_aqed_out_fu_161_bmc_in_address0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
    ...
    bmc_in_address1_assign_proc : process(ap_CS_fsm_state6, grp_aqed_in_fu_125_bmc_in_address1, grp_aqed_out_fu_161_bmc_in_address1, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            bmc_in_address1 <= grp_aqed_out_fu_161_bmc_in_address1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    bmc_in_ce0_assign_proc : process(ap_CS_fsm_state6, grp_workload_fu_113_data_ce0, grp_aqed_in_fu_125_bmc_in_ce0, grp_aqed_out_fu_161_bmc_in_ce0, ap_CS_fsm_state4, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            bmc_in_ce0 <= grp_aqed_out_fu_161_bmc_in_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    bmc_in_ce1_assign_proc : process(ap_CS_fsm_state6, grp_aqed_in_fu_125_bmc_in_ce1, grp_aqed_out_fu_161_bmc_in_ce1, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            bmc_in_ce1 <= grp_aqed_out_fu_161_bmc_in_ce1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    grp_aqed_in_fu_125_ap_start <= grp_aqed_in_fu_125_ap_start_reg;
