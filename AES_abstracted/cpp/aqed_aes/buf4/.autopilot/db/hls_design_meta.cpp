...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("orig_idx_V", 2, hls_in, 3, "ap_none", "in_data", 1),
	Port_Property("dup_idx_V", 2, hls_in, 4, "ap_none", "in_data", 1),
	Port_Property("num_V", 3, hls_in, 5, "ap_none", "in_data", 1),
};
