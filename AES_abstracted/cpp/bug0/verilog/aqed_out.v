...
wire   [63:0] p_0217_sum_cast_fu_215_p1;
...
wire   [2:0] ret_V_fu_196_p3;
wire   [2:0] p_0217_sum_fu_209_p2;
...
always @ (posedge ap_clk) begin
    ...
    end else   if (((state_orig_issued_V_s_load_fu_98_p1 == 1'd1) & (brmerge_reg_317 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
     if(ap_rst) begin
	state_qed_done_V <= 0;
    end else   if (((p_state_qed_done_V_fl_fu_267_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        bmc_in_address1 = p_0217_sum_cast_fu_215_p1;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
