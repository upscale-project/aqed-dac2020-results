...
(* CORE_GENERATION_INFO="aqed_top,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=50.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.348000,HLS_SYN_LAT=125,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=670,HLS_SYN_LUT=2249,HLS_VERSION=2018_3}" *)
...
always @ (posedge ap_clk) begin
     if(ap_rst) begin
	o2_qed_check_V_reg_249 <= 0;
	o2_qed_done_V_reg_244 <= 0;    
