...
entity aes256_encrypt_ecbkb_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes256_encrypt_ecbkb_rom is 
...
entity aes256_encrypt_ecbkb is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes256_encrypt_ecbkb is
    component aes256_encrypt_ecbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes256_encrypt_ecbkb_rom_U :  component aes256_encrypt_ecbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
