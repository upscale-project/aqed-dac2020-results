...
entity aes256_encrypt_ecb_sbox_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes256_encrypt_ecb_sbox_rom is 
...
entity aes256_encrypt_ecb_sbox is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes256_encrypt_ecb_sbox is
    component aes256_encrypt_ecb_sbox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes256_encrypt_ecb_sbox_rom_U :  component aes256_encrypt_ecb_sbox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
